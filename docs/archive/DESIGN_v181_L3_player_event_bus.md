...
> 关联：docs/archive/DESIGN_effect_system_v2.md（L1 战斗内效果总线 N8 已落地）+
> docs/archive/HANDOFF_battle2_effect_v2.md §9（L2 战斗级观察者 on_event 已落地）。
> 状态：✅ P0 字段级任务书已出（2026-09-09，真实代码侦察修订）——
> **docs/archive/REFACTOR_v181_L3_P0_task.md**（ctx schema 逐字段/订阅注册表/回填顺序对照表/P1-P4 任务书）。
