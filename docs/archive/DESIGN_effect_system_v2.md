...
> 本文档是效果系统 v2 的主方案（对标 docs/archive/REFACTOR_v181P4_FULL_PLAN.md 之于 battle2）。
>
> 关联文档：
> - `docs/archive/REFACTOR_v181P4_FULL_PLAN.md` — battle2 引擎主方案（本效果系统是它的 Part 3 展开）
> - `docs/archive/REFACTOR_v181P4_effect_time_system.md` — 效果时效收口（buffs 到期/盾 expire/消费规则）
> - `docs/archive/REFACTOR_v181P4_class_mech_decouple.md` — 职业机制与引擎解耦（C 类机制留给上层）
...
N7.3  一次性 on_hit 消费
N7.4  DOT interval
N7.5  187 名词分诊 → EFFECT_ACTIONS 补全（产出 docs/archive/EFFECT_TRIAGE_v181P4.md）
