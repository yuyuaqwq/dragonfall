...
> `_archive_unused/architecture_audit_20260907/`，主汇总结论 docs/archive/ARCHITECTURE_AUDIT_20260907.md）。
...
> ✅ **P2-E 已完成（commit 095abd4 合并 wt_p2e：Phase1 死表清理 43 顶层 def 删 + Phase2 双源归一 + P3a MECH_CFG 机制单表成型/非 battle 消费点迁移；P3b battle.py 全量读点迁移 / P3c 测试·docs 收尾由 wt_p3c 分支批次跟进——本行标注为 095abd4 即 P1a-P3a 主体完成态）**。执行细节见 docs/archive/REFACTOR_P2E_task.md 与 docs/archive/REFACTOR_P2E_mech_cfg.md（附录已完成批次回写）。
