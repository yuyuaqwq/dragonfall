...
| 文档 | 内容 |
|---|---|
| `docs/archive/REFACTOR_v181P4_FULL_PLAN.md` | 主方案 v2（Part 1-8 全） |
| `docs/archive/REFACTOR_v181P4_class_mech_decouple.md` | **职业机制与引擎解耦方案**（2026-09-08 鱼鱼拍板，见 §2） |
| `docs/archive/ENGINE_ARCHITECTURE_v181P4.md` | 旧架构分析 |
...
**当前主线 = N7 效果系统收口**（方案：`docs/archive/REFACTOR_v181P4_effect_time_system.md`）：
