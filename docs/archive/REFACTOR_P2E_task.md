...
> 供后续子 agent 直接执行。只读侦察结论/方案权威 = `docs/archive/REFACTOR_P2E_mech_cfg.md`（391 行）；本任务书是它的**可派工批次化落地版**。
...
---
*（end of task book — 依据 docs/archive/REFACTOR_P2E_mech_cfg.md，侦察基线 master c61f48b / wt_p2e 方案 commit 7083dbe；执行前复核行号）*
