...
> `docs/archive/DESIGN_v181_L3_player_event_bus.md` 细化到字段/行号级，可直接派 P1/P2 实施。
...
- 本文件 docs/archive/REFACTOR_v181_L3_P0_task.md（新建）
- docs/archive/DESIGN_v181_L3_player_event_bus.md：状态行 ⬜→P0 完成；§3 排期表 P0 标 ✅ + 指向本文件；
