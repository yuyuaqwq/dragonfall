...
> 前置：`docs/archive/REFACTOR_v181_P15_bar_passives.md`（被动实装 + 缺口 5 项）。
...
| `docs/archive/REFACTOR_v181_P15_bar_passives.md` | 「条容器 = core/battle_bars（buffs[bar]）」描述同步改（文档别留旧口径） |
