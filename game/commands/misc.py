...
📚 『帮助 <分类>』看该分类全部指令：角色 冒险 战斗 技能 副业 物品 副本 社交 世界 其他

🧑🤝🧑 角色系统        🌍 冒险系统
注册 角色 属性 加点    地图 移动 探索 休息
洗点 转职 转职重置 战力 排行    住宿 时间 许愿 交互 见闻录

⚔️ 战斗系统          ✨ 技能系统
攻击 技能 防御 逃跑    技能 技能列表 技能详情
使用 讨伐 荣誉        技能学习 技能升级 流派

🔨 副业系统          🎒 物品系统
副业 采集 挖掘 垂钓    背包 商店 购买 市场
烹饪 炼金 锻造 强化    摆摊 拍卖 竞拍 仓库
附魔

👥 社交系统          📜 世界系统
组队 副本 公会 宠物    任务 接取 每日 方碑 传送
坐骑 快捷            地契 编年史 成就 图鉴 称号
副本内: 副本地图 调查 撤退
