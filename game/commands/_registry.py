...
COMMAND_REGEX = {
    ...
    "craft": r'^(?:\[At:\d+\]\s*)?(?:锻造列表|锻造|打造列表|打造)(?:[\s\S]*)$',
    ...
    "item_detail": r'^(?:\[At:\d+\]\s*)?(?:物品详情|查看)(?:[\s\S]*)$',
    "leaderboard": r'^(?:\[At:\d+\]\s*)?(?:排行|排行榜)(?:\s*|$)',
    ...
    "mining": r'^(?:\[At:\d+\]\s*)?(?:挖掘|采矿)(?:\s*|$)',
    "mount_cmd": r'^(?:\[At:\d+\]\s*)?(?:坐骑|骑乘|下马)(?:\s*|$)',
    "move": r'^(?:\[At:\d+\]\s*)?(?:移动|前往)(?:\s*|$)',
    ...
    "recipe_list": r'^(?:\[At:\d+\]\s*)?(?:配方列表|配方)(?:\s*|$)',
