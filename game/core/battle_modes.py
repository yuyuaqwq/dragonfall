...
def _battle_cfg(name: str) -> dict:
    ...
    try:
        from ..data.battle_config import (  # noqa: F401
            DUAL_FORM_CFG, FOCUS_CFG, VENT_CFG,
        )
        cfg_map = {"dual_form": DUAL_FORM_CFG, "focus": FOCUS_CFG, "vent": VENT_CFG}
    ...
    try:
        ...
        cfg_map = {"dual_form": bc.DUAL_FORM_CFG, "focus": bc.FOCUS_CFG, "vent": bc.VENT_CFG}
        return cfg_map.get(name, {}) or {}
    except Exception:
        return {}
