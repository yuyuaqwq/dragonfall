...
SKILL_UP = {
    ...
    '不破壁垒': {'max': 3},
    '乱舞': {'p': 8, 'max': 5},
    '冰环': {'p': 12, 'c': 0.05, 'max': 4},
    '冰锥连射': {'p': 12, 'c': 0.05, 'max': 4},
    '冻结': {'p': 12, 'c': 0.05, 'max': 4},
    '净化术': {'max': 3},
    '剧毒风暴': {'p': 12, 'max': 5},
    ...
    '暴风雪': {'p': 12, 'c': 0.05, 'max': 4},
    '极寒领域': {'max': 3},
    '死神之箭': {'p': 10, 'c': 0.08, 'max': 3},
    '毒刃': {'p': 12, 'c': 0.05, 'max': 4},
    '毒爆': {'p': 10, 'c': 0.08, 'max': 4},
    '流星火雨': {'p': 12, 'c': 0.05, 'max': 4},
    '淬毒刺杀': {'p': 12, 'max': 5},
    '火环': {'p': 12, 'c': 0.05, 'max': 4},
    '烈焰裁决': {'max': 3},
    '烈焰风暴': {'p': 8, 'max': 5},
    '熔岩喷发': {'p': 12, 'max': 5},
    ...
    '绝对冰封': {'p': 12, 'max': 5},
    '绝对零度': {'p': 10, 'c': 0.08, 'max': 3},
    '致命连射': {'p': 8, 'max': 5},
    '超载引爆': {'p': 10, 'c': 0.08, 'max': 4},
    '连环拳': {'p': 8, 'max': 5},
    '连珠火球': {'p': 12, 'c': 0.05, 'max': 4},
