...
from .skills import PLAYER_SKILLS, BRANCH_SKILLS, REMOVED_SKILLS  # noqa: F401
...
from .fishing import FISHING_SPOTS, FISH_POOL, FISH_WEIGHTS  # noqa: F401
from .enhance import ENHANCE_TABLE, MAX_ENHANCE, ENHANCE_FAIL_DROP, ENHANCE_SMITH_MAPS  # noqa: F401
from .sets import (  # noqa: F401
    SET_THEMES, SET_CHANCE, SET_RENAME, SETS, CLASS_SET_STAGES,
    CLASS_SET_THEMES, SET_RENAME_CLASS, ITEM_RENAME, _OLD_PART_SUFFIX,
)
...
SET_RENAME.update(SET_RENAME_CLASS)

ITEM_RENAME.update({
    "旧影面巾": "轻影面巾", "旧影皮衣": "轻影皮衣", "旧影护腿": "轻影护腿", "旧影轻靴": "轻影轻靴",
    "旧影图纸": "轻影图纸", "生锈匕首": "粗制匕首",
    "苦行头带": "行者头带", "苦行僧袍": "行者僧袍", "苦行护腿": "行者护腿", "苦行布靴": "行者布靴",
    "苦行图纸": "行者图纸", "旧拳套": "粗布拳套",
    "旧猎弓": "粗制猎弓", "旧权杖": "粗制权杖",
})
