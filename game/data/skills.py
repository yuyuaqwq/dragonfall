        ...
        "branches": {
            1: {
             ...
             'exprs': ['atk*0.4 + 102 + player_lv*5.0 + skill_lv*12'],
                        ...
                        'mech_val': 2.0,
                        'name': '盾击·誓',
                        'desc': '重盾悍然撞出，誓约之力灌注其上——造成 40% 物理攻击 + 102 固定物理伤害（成长），40% 概率眩晕 2 刻（守护姿态中伤害 +20%）'
                    },
                    "守护姿态": {
                        'lv': 38,
                        'mp': 0,
            ...
            2: {
             ...
             'exprs': ['atk*0.55 + 219 + player_lv*7.0 + skill_lv*16'],
                        ...
                        'mech_val': 2.0,
                        'name': '破城锤',
                        'desc': '巨盾如破城之锤轰然砸出——造成 55% 物理攻击 + 219 固定物理伤害（成长），破防并 40% 概率眩晕 2 刻'
                    },
                    "誓约之盾": {
                        'lv': 85,
                        'mp': 12,
        ...
        "branches": {
            ...
            3: {
             ...
             'exprs': ['matk*3.5 + 125 + player_lv*8.0 + skill_lv*18'],
                        ...
                        'name': '万象天雷',
                        'desc': '引九霄万象天雷灌顶而下，天地失色——造成 350% 魔法攻击 + 125 固定魔法伤害（成长），雷印满 3 层时连击 +2'
                    },
                },
                "奥术学者": {
                    "星界风暴": {
            ...
            1: {
                "咏叹者": {
                    ...
                    "咏叹调": {
                        ...
                        'power': 1.02,
                        'kind': '魔法',
             'exprs': ['matk*0.55 + 50 + player_lv*7.0 + skill_lv*16'],
                        ...
                        'name': '咏叹调',
                        'desc': '高亢咏叹冲霄而起，化作璀璨音刃——造成 55% 魔法攻击 + 50 固定魔法伤害（成长）；当前旋律为增益系时 ×1.3'
                    },
                    "凯旋之歌": {
                        'lv': 54,
                        'mp': 14,
                ...
                "挽歌者": {
                    "哀歌": {
                        ...
                        'power': 1.02,
                        'kind': '魔法',
             'exprs': ['matk*0.490 + 71 + player_lv*5.9 + skill_lv*13.7'],
                        ...
                        'mech2': 'atk_down',
                        'name': '哀歌',
                        'desc': '低沉的哀歌如暮色笼罩，音刃割裂战意——造成 49% 魔法攻击 + 71 固定魔法伤害（成长），目标攻击 −20%，持续 8 刻'
                    },
                    "镇魂歌": {
                        'lv': 38,
                        'mp': 12,
                    ...
                    "悲鸣": {
                        ...
                        'power': 1.14,
                        'kind': '魔法',
             'exprs': ['matk*0.6 + 70 + player_lv*7.0 + skill_lv*15'],
                        ...
                        'mech2': 'atk_down',
                        'name': '悲鸣',
                        'desc': '凄厉悲鸣撕裂空气，音刃啃噬敌人的斗志——造成 60% 魔法攻击 + 70 固定魔法伤害（成长），目标攻击 −25%，持续 8 刻'
                    },
                    "挽歌": {
                        'lv': 54,
                        'mp': 14,
                    ...
                    "破碎和音": {
                        ...
                        'power': 1.14,
                        'kind': '魔法',
             'exprs': ['matk*0.5 + 90 + player_lv*7.0 + skill_lv*15'],
                        ...
                        'mech2': 'def_down',
                        'name': '破碎和音',
                        'desc': '刺耳和音轰然炸裂，震碎敌人的防线——造成 50% 魔法攻击 + 90 固定魔法伤害（成长），目标防御 −30%，持续 8 刻'
                    },
                },
            },
            2: {
                "咏叹者": {
                    "破晓长歌": {
                        ...
                        'power': 1.8,
                        'kind': '魔法',
             'exprs': ['matk*1.138 + 94 + player_lv*6.6 + skill_lv*13.3'],
             
             
                        'cast': 0.7,
                        'cd': 20,
                        'name': '破晓长歌',
                        'desc': '破晓长歌震碎长夜，音浪化作贯日一击——造成 114% 魔法攻击 + 94 固定魔法伤害（成长）的单体音刃终结（重技）'
                    },
                    "英雄叙事诗": {
                        'lv': 68,
                        'mp': 18,
                ...
                "挽歌者": {
                    ...
                    "亡者挽歌": {
                        ...
                        'power': 1.31,
                        'kind': '魔法',
             'exprs': ['matk*0.7 + 93 + player_lv*7.0 + skill_lv*14'],
                        ...
                        'mech2': 'silence',
                        'name': '亡者挽歌',
                        'desc': '为亡者而歌的旋律缠上生者，音刃斩断言语——造成 70% 魔法攻击 + 93 固定魔法伤害（成长），沉默 2.5 刻'
                    },
                    "镇魂安魂": {
                        'lv': 80,
                        'mp': 0,
                    ...
                    "哀悼之音": {
                        ...
                        'power': 1.31,
                        'kind': '魔法',
             'exprs': ['matk*0.65 + 101 + player_lv*7.0 + skill_lv*16'],
                        ...
                        'mech2': 'all_down',
                        'name': '哀悼之音',
                        'desc': '哀悼之音如泣如诉，令万物为之衰朽——造成 65% 魔法攻击 + 101 固定魔法伤害（成长），目标全属性 −20%，持续 8 刻'
                    },
                    "挽歌·沉": {
                        'lv': 88,
                        'mp': 22,
            ...
            3: {
                "咏叹者": {
                    ...
                    "天籁": {
                        ...
                        'power': 2.04,
                        'kind': '魔法',
             'exprs': ['matk*1.45 + 96 + player_lv*8.0 + skill_lv*14'],
                        ...
                        'name': '天籁',
                        'desc': '天籁之音自云端垂落，化作灭世音刃——造成 145% 魔法攻击 + 96 固定魔法伤害（成长）的音刃顶点终结；强度层 ≥4 时 ×1.3'
                    },
                    "永恒赞歌": {
                        'lv': 98,
                        'mp': 50,
                ...
                "挽歌者": {
                    ...
                    "死寂": {
                        ...
                        'power': 2.04,
                        'kind': '魔法',
             'exprs': ['matk*1.4 + 117 + player_lv*7.0 + skill_lv*14'],
                        ...
                        'mech2': 'silence',
                        'name': '死寂',
                        'desc': '万籁凝成死寂一瞬，音刃落下带走所有声音——造成 140% 魔法攻击 + 117 固定魔法伤害（成长）的音刃终结，沉默 3.0 刻'
                    },
                    "挽歌·极": {
                        'lv': 95,
                        'mp': 0,
                    ...
                    "万籁俱寂": {
                        ...
                        'power': 1.12,
                        'kind': '魔法',
             'exprs': ['matk*0.45 + 96 + player_lv*7.0 + skill_lv*14'],
                        ...
                        'aoe': 'all',
                        'name': '万籁俱寂',
                        'desc': '天地骤然失声，寂静之刃横扫整片战场——全体音刃 造成 45% 魔法攻击 + 96 固定魔法伤害（成长），全体沉默 2.0 刻'
                    },
                    "终末安魂": {
                        'lv': 98,
                        'mp': 55,
