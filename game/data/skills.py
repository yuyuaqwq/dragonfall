...
PLAYER_SKILLS = {
    ...
    "sk_cui_du_jian_shi": {
                ...
                "mech": "poison",
                "mech_val": 3,
                "desc": "淬毒箭矢！80% 伤害＋3 层中毒(毒体系铺垫，v130.2 连射档化 -20)",
                "name": "淬毒箭矢",
            },
    ...
    "sk_shou_lie_zhong_zhang": {
                ...
                "desc": "狩猎终章！480% 致命一击，消耗全部精力(100 精力大终结，EQ≈4.8)。",
                "name": "狩猎终章",
            },
    "sk_xu_li_ju_ji": {
                "lv": 26,
    ...
    "sk_shen_fa_sheng_cai": {
                ...
                "res_cost": {"faith": 10},
                "cd": 6,
                "desc": "神罚·圣裁！300% 全体圣光惩罚，消耗全部信仰(基础满点神迹·EQ≈4.8)",
                "name": "神罚·圣裁",
            },
    ...
    "sk_lian_zhao_san_lian": {
                ...
                "multi": 3,
                "res_gain": 3,
                "desc": "连招·三连！150%×3(连招核心，三连完成时气力技＋30%)",
                "name": "连招三连",
            },
    "sk_po_xiao_zhi_quan": {
                "lv": 30,
            ...
            1: {
                "元素法师": {
                    "元素冲击":                     {
                        ...
                        "mp": 15,
                        "res_gain": {"element": 1},
                        "desc": "当前系 190% 单体，挂元素印记。目标已有印记时伤害＋20%(反应前奏，v130.2 进档解锁充能条·施法 +1)",
                        "name": "元素冲击"
                    }
,
                    "万象亲和":                     {
...
,
                    "双系连珠":                     {
                        ...
                        "mp": 20,
                        "res_cost": {"element": 3},
                        "desc": "当前系 130%×2，挂 2 层印记。目标印记≥3 层时伤害＋25%（v130.2 消耗 3 充能）",
                        "cd": 2,
                        "name": "双系连珠"
                    }
,
                    "元素引爆":                     {
                        ...
                        "mp": 25,
                        "res_cost": {"element": 2},
                        "desc": "当前系 240%，引爆印记。目标印记≥2 层时伤害＋30%（v130.2 消耗 2 充能）",
                        "cd": 3,
                        "name": "元素引爆"
                    }
,
...
,
                ...
                "奥秘法师": {
                    ...
                    "奥术飞弹": {"lv": 40, "mp": 15, "power": 1.0, "kind": "魔法",
                                 ...
                                 "res_gain": {"element": 1},
                                 "desc": "奥术飞弹！100% 魔法伤害，命中叠 1 层奥术印记(v130.2 进档充能条·施法 +1)",
                                 "name": "奥术飞弹"},
                    "奥术爆破": {"lv": 45, "mp": 20, "power": 1.5, "kind": "魔法",
                                 ...
                                 "cd": 2,
                                 "res_cost": {"element": 1},
                                 "desc": "奥术 150%×2，奥术充能＋2。充能≥4 层时伤害＋25%（v130.2 低耗高频 -1 充能）",
                                 "name": "奥术爆破"},
...
,
                    "元素跃迁":                     {
                        ...
                        "cd": 3,
                        "res_gain": {"element": 1},
                        "desc": "切换当前元素系(火→冰→雷)，下次元素技能伤害＋20%（v130.2 走位回充能 +1）",
                        "name": "元素跃迁"
                    }
,
                    "元素壁垒":                     {
                        ...
                        "cd": 3,
                        "res_cost": {"element": 2},
                        "desc": "防御强化(元素法师的护盾，不脆；v130.2 高耗铸盾 消耗 2 充能)",
                        "name": "元素壁垒"
                    }
,
...
,
                ...
                "奥秘术士": {
                    ...
                    "法术反制": {"lv": 62, "mp": 15, "power": 0.6, "kind": "魔法",
                                 ...
                                 "res_gain": {"element": 1},
                                 "desc": "60% 反制，沉默敌人 + 奥术充能＋2。充能≥2 层时伤害＋20%（v130.2 反制命中回充能 +1）",
                                 "name": "法术反制"},
                    "法力护盾": {"lv": 68, "mp": 30, "power": 0, "kind": "增益",
                                 "effect": "def_up", "cd": 3,
                                 "res_cost": {"element": 1},
                                 "desc": "防御强化(法力护盾，v130.2 守线低耗高频 -1 充能兑生存)",
                                 "name": "法力护盾"},
                },
            },
            3: {
                "元素贤者": {
                    "万象风暴":                     {
                        ...
                        "aoe": "all",
                        "res_gain": {"element": 1},
                        "desc": "当前系 180%×3 全体。目标有印记时伤害＋30%（v130.2 连环低耗回充能 +1）",
                        "cd": 3,
                        "name": "万象风暴"
                    }
,
                    "万象天雷":                     {
                        ...
                        "aoe": "all",
                        "res_cost": {"element": 3},
                        "desc": "终极技，雷系 450% 全体 + 全队魔攻强化（v130.2 消耗 3 充能·终盘压制）",
                        "name": "万象天雷"
                    }
,
                    "元素裁决":                     {
                        ...
                        "aoe": "all",
                        "res_cost": {"element": 5},
                        "desc": "三转奥义，当前系 400% 全体核弹（v130.2 满充能全耗 5，EQ 过冲属 90 级预期）",
                        "name": "元素裁决"
                    }
,
                },
                "奥秘贤者": {
                    ...
                    "奥术领域": {"lv": 90, "mp": 100, "power": 4.0, "kind": "魔法",
                                ...
                                "res_cost": {"element": 3},
                                "desc": "三转奥义，奥术 400% 全体 + 全队护盾（v130.2 消耗 3 充能·中耗终盘压制场）",
                                "name": "奥术领域"},
                    "大奥术": {"lv": 92, "mp": 30, "power": 2.0, "kind": "魔法",
                               ...
                               "cd": 3,
                               "res_gain": {"element": 1},
                               "desc": "奥术 200%×2 全体，奥术充能＋2。充能≥6 层时伤害＋30%（v130.2 中高伤回灌充能 +1）",
                               "name": "大奥术"},
                    "奥术主宰": {"lv": 98, "mp": 120, "power": 4.5, "kind": "魔法",
                                 "cond": {"type": "player_mech_stacks", "mech": "arcane", "stacks": 5, "mult": 1.5, "label": "奥术主宰"},
                                 "cd": 5,
                                 "res_cost": {"element": 5},
                                 "desc": "终极技，奥术 450% 单体。充能≥5 层时伤害＋50%（v130.2 满充能全耗 5·EQ 9.0 属终盘预期）",
                                 "name": "奥术主宰"},
                },
            },
        },
            ...
            1: {
                "龙血战士": {
                    "龙息": {"lv": 40, "mp": 20, "power": 0.9, "kind": "真伤",
                             ...
                             "desc": "龙息！90% 真伤(无视全部防御)，附带灼烧 1 层（v130.2 命中燃烧目标 龙力+1·灼伤回响）",
                             "name": "龙息"},
                    "龙鳞": {"lv": 46, "mp": 15, "power": 0, "kind": "增益",
                             "effect": "def_up", "cd": 3,
                             "res_cost": {"dragon_might": 2},
                             "desc": "龙鳞！防御＋45% 2 回合（v130.2 消耗 2 龙力·护盾兑龙力）",
                             "name": "龙鳞"},
                    "龙威": {"lv": 54, "mp": 20, "power": 0, "kind": "增益",
                             "effect": "mon_atk_down", "cd": 4,
                             "res_cost": {"dragon_might": 2},
                             "desc": "龙威！敌方攻击－30% 3 回合（v130.2 消耗 2 龙力·T1 燃耗口）",
                             "name": "龙威"},
                },
            },
            2: {
                "龙裔斗士": {
                    ...
                    "龙爪": {"lv": 64, "mp": 18, "power": 1.6, "kind": "物理",
                             ...
                             "desc": "龙爪！160% 物理伤害，附带灼烧 1 层（v130.2 命中燃烧目标 龙力+2）",
                             "name": "龙爪"},
            ...
            3: {
                "龙魂战将": {
                    ...
                    "龙焰吐息": {"lv": 75, "mp": 35, "power": 2.6, "kind": "真伤",
                                 ...
                                 "res_gain": {"dragon_might": 1},
                                 "desc": "龙焰吐息！260% 真伤(无视全部防御)，附带灼烧 2 层，消耗 5 点龙力(EQ≈4.94)，命中燃烧目标返还 1 龙力",
                                 "name": "龙焰吐息"},
                    # v130.2 新增：满龙力大终结（EQ ≈ 8.96，50 级规格超基准属预期）
                    "龙脉终曲": {"lv": 80, "mp": 40, "power": 3.2, "kind": "真伤",
                                 "cd": 5,
                                 "res_cost": {"dragon_might": 10},
                                 "desc": "龙脉终曲！320% 真伤，消耗 10 点龙力(满龙力终极·EQ≈8.96)",
                                 "name": "龙脉终曲"},
                },
            },
        },
            ...
            2: {
                "时律术士": {
                    "时间静止": {"lv": 62, "mp": 20, "power": 0, "kind": "增益",
                                 "effect": "sleep", "cd": 3,
                                 "res_gain": {"time_sand": 1},
                                 "desc": "时间静止！使目标陷入停滞 2 回合（v130.2 静止越久沙越多·节拍 +1）",
                                 "name": "时间静止"},
                },
            },
            3: {
                "时间领主": {
                    ...
                    "时间坍缩": {"lv": 92, "mp": 100, "power": 1.5, "kind": "魔法",
                                 ...
                                 "res_gain": {"time_sand": 1},
                                 "desc": "时间坍缩！150% 全场魔法伤害，全场减速+50% 概率冻结(时停大炮·EQ≈4.8)，消耗 5 沙，命中 ≥3 目标返还 1 沙",
                                 "name": "时间坍缩"},
                    # v130.2 新增：-2 沙保命口（解除减速/刷新技能 cd）
                    "时光回溯": {"lv": 95, "mp": 20, "power": 0, "kind": "增益",
                                 "effect": "cleanse", "cd": 4, "reach": 1,
                                 "res_cost": {"time_sand": 2},
                                 "desc": "时光回溯！解除自身减速并刷新自身技能冷却（v130.2 用沙换生存·节拍取舍口）",
                                 "name": "时光回溯"},
                },
            },
        },
            ...
            1: {
                "星语者": {
                    "星陨": {"lv": 40, "mp": 15, "power": 1.65, "kind": "物理",
                             ...
                             "desc": "星陨！165% 物理伤害，叠 1 层猎杀标记（v130.2 命中攒印 +1）",
                             "name": "星陨"},
                    ...
                    "命运之轮": {"lv": 55, "mp": 30, "power": 1.6, "kind": "魔法",
                                 ...
                                 "desc": "命运之轮！160% 魔法伤害连击 3 次（v130.2 消耗 1 印·攒→用→攒教学档）",
                                 "name": "命运之轮"},
                },
            },
            2: {
                "星相师": {
                    ...
                    "星轨连射": {"lv": 64, "mp": 15, "power": 1.2, "kind": "物理",
                                 ...
                                 "res_gain": {"hunt_mark": 1},
                                 "desc": "星轨连射！120%×2 物理伤害，叠 1 层猎杀标记（v130.2 命中攒印 +1）",
                                 "name": "星轨连射"},
                },
            },
            3: {
                "命运编织者": {
                    "星祭": {"lv": 75, "mp": 35, "power": 2.0, "kind": "物理",
                             ...
                             "desc": "星祭！200% 物理伤害，叠 2 层猎杀标记，消耗 3 点猎印（v130.2 T2 中终结档）",
                             "name": "星祭"},
                    # v130.2 新增：大终结前奏（+2 印 + 满印暴击抬升）
                    "星辉祈愿": {"lv": 78, "mp": 25, "power": 0, "kind": "增益",
                                 "effect": "crit_up", "cd": 5,
                                 "res_gain": {"hunt_mark": 2},
                                 "desc": "星辉祈愿！施放 猎印 +2；满印(5/5)时下一个终结技暴击率＋15%",
                                 "name": "星辉祈愿"},
                    # v130.2 新增：5 印大终结·EQ 4.8（引爆 3 层标记 ×1.5）
                    "流星陨落": {"lv": 80, "mp": 40, "power": 3.2, "kind": "物理",
                                 "pierce": True, "reach": 3, "cd": 6,
                                 "res_cost": {"hunt_mark": 5},
                                 "desc": "流星陨落！320% 致命一击，命中引爆 3 层标记伤害×1.5（EQ≈4.8），消耗 5 点猎印",
                                 "name": "流星陨落"},
                },
            },
        },
            ...
            1: {
                "暗影祭司": {
                    "召唤骷髅": {"lv": 40, "mp": 20, "power": 0, "kind": "增益",
                                 ...
                                 "res_cost": {"canticle": 2},
                                 "desc": "召唤骷髅！召唤骷髅兵加入战斗(上限 3，自动攻击＋挡刀)，消耗 2 点悼咏（v130.2 一档神迹·铺场）",
                                 "name": "召唤骷髅"},
                    ...
                    "死亡汲取": {"lv": 44, "mp": 15, "power": 1.2, "kind": "魔法",
                                 ...
                                 "res_gain": {"canticle": 1},
                                 "desc": "死亡汲取！120% 暗蚀伤害，吸血回复等于伤害一半（v130.2 暗蚀攒悼咏 +1）",
                                 "name": "死亡汲取"},
                },
            },
            2: {
            ...
            3: {
                "黯灵主教": {
                    ...
                    "安魂曲": {"lv": 80, "mp": 40, "power": 3.0, "kind": "魔法",
                               ...
                               "desc": "安魂曲！300% 全体暗蚀，结算以伤害值一半回复自身，消耗 10 点悼咏（满档挽歌·EQ≈4.8）",
                               "name": "安魂曲"},
                },
            },
        },
            ...
            1: {
                "暗杀": {
                    "幽影袭": {"lv": 40, "mp": 15, "power": 1.3, "kind": "物理",
                               ...
                               "desc": "幽影袭！130% 物理伤害，满血目标必暴击（v130.2 暴击命中 +1 影步）",
                               "name": "幽影袭"},
                    "暗影步": {"lv": 52, "mp": 20, "power": 0, "kind": "增益",
                               "effect": "stealth", "cd": 4,
                               "res_cost": {"shadow_step": 1},
                               "desc": "暗影步！花 1 步潜入暗影(潜行)，下次攻击必定暴击（v130.2 潜行联动·先付 1 步再让攒点机器转起来）",
                               "name": "暗影步"},
                },
            },
            2: {
                "暮刃大师": {
                    "幽影连刺": {"lv": 62, "mp": 25, "power": 1.2, "kind": "物理",
                                 ...
                                 "res_gain": {"shadow_step": 1},
                                 "desc": "幽影连刺！120%×2 物理伤害，满血目标必暴击（v130.2 2 段暴击积步·全暴击 +2）",
                                 "name": "幽影连刺"},
                },
            },
            3: {
                "暮影收割者": {
                    "幽影刃": {"lv": 75, "mp": 35, "power": 2.0, "kind": "物理",
                               ...
                               "name": "幽影刃"},
                    # v130.2 新增：影步 5 步大终结（EQ = 3.2 × 1.5 = 4.8）
                    "终结·破影一击": {"lv": 80, "mp": 45, "power": 3.2, "kind": "物理",
                                 "mech": "shadow", "mech_val": 1, "cd": 6, "reach": 1,
                                 "res_cost": {"shadow_step": 5},
                                 "desc": "终结·破影一击！320% 致命一击，潜行状态下伤害×1.5(EQ≈4.8)，消耗 5 点影步",
                                 "name": "终结·破影一击"},
                },
            },
        },
            ...
            2: {
                "大地武僧": {
                    ...
                    "势蓄连打": {"lv": 62, "mp": 18, "power": 1.2, "kind": "物理",
                                 ...
                                 "res_gain": {"zen": 1},
                                 "desc": "势蓄连打！120%×2 物理伤害，拳连招(连击深化)（v130.2 禅意 +1）",
                                 "name": "势蓄连打"},
                    # v130.2 新增：2 禅意轻倾泻（慢热期小口释放）
                    "律动连打": {"lv": 66, "mp": 14, "power": 1.8, "kind": "物理",
                                 "combo": "拳", "cd": 2,
                                 "res_cost": {"zen": 2},
                                 "desc": "律动连打！180% 物理伤害（v130.2 每 zen 物理威力 +12%·消耗 2 点禅意）",
                                 "name": "律动连打"},
                },
            },
            3: {
                "撼岳者": {
                    "气爆": {"lv": 75, "mp": 35, "power": 1.8, "kind": "物理",
                             ...
                             "name": "气爆"},
                    # v130.2 新增：满 10 禅意大终结（EQ≈6.0 单体天花板）
                    "撼岳·终焉": {"lv": 80, "mp": 30, "power": 2.5, "kind": "物理",
                                  "combo": "拳", "cd": 6,
                                  "res_cost": {"zen": 10},
                                  "desc": "撼岳·终焉！250% 致命一击，每 zen 物理威力 +12%（EQ≈6.0），敌带破势 ×1.1，消耗 10 点禅意",
                                  "name": "撼岳·终焉"},
                    # v130.2 新增：T3 续势攒点（破势目标 +3）
                    "裂岳绝式": {"lv": 82, "mp": 16, "power": 1.3, "kind": "物理",
                                 "combo": "拳", "cd": 2,
                                 "res_gain": {"zen": 2},
                                 "desc": "裂岳绝式！130% 物理伤害（v130.2 禅意 +2，破势目标 +3）",
                                 "name": "裂岳绝式"},
                },
            },
        },
