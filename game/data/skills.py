...
,
                ...
                "奥秘贤者": {
                    ...
                    "奥术主宰": {"lv": 98, "mp": 120, "power": 4.5, "kind": "魔法",
                                 ...
                                 "cd": 5,
                                 "res_cost": {"element": 5},
                                 "desc": "终极技，奥术 450% 单体。充能≥5 层时伤害＋50%（消耗 5 充能）",
                                 "name": "奥术主宰"},
                },
            },
        },
            ...
            1: {
                "龙血战士": {
                    "龙息": {"lv": 40, "mp": 20, "power": 0.9, "kind": "真伤",
                             ...
                             "desc": "龙息！90% 真伤(无视全部防御)，附带灼烧 1 层（命中燃烧目标 龙力+1）",
                             "name": "龙息"},
            ...
            2: {
                "龙裔斗士": {
                    ...
                    "龙爪": {"lv": 64, "mp": 18, "power": 1.6, "kind": "物理",
                             ...
                             "desc": "龙爪！160% 物理伤害，附带灼烧 1 层（命中燃烧目标 龙力+2）",
                             "name": "龙爪"},
            ...
            3: {
                "命运编织者": {
                    ...
                    "流星陨落": {"lv": 80, "mp": 40, "power": 3.2, "kind": "物理",
                                 ...
                                 "desc": "流星陨落！320% 致命一击，命中引爆 3 层标记伤害×1.5，消耗 5 点猎印",
                                 "name": "流星陨落"},
                },
            },
        },
            ...
            3: {
                "暮影收割者": {
                    ...
                    "终结·破影一击": {"lv": 80, "mp": 45, "power": 3.2, "kind": "物理",
                                 ...
                                 "desc": "终结·破影一击！320% 致命一击，潜行状态下伤害×1.5，消耗 5 点影步",
                                 "name": "终结·破影一击"},
                },
            },
        },
            ...
            3: {
                "撼岳者": {
                    ...
                    "撼岳·终焉": {"lv": 80, "mp": 30, "power": 2.5, "kind": "物理",
                                  "combo": "拳", "cd": 6,
                                  "res_cost": {"zen": 10},
                                  "desc": "撼岳·终焉！250% 致命一击，每 zen 物理威力 +12%，敌带破势 ×1.1，消耗 10 点禅意",
                                  "name": "撼岳·终焉"},
                    # v130.2 新增：T3 续势攒点（破势目标 +3）
                    "裂岳绝式": {"lv": 82, "mp": 16, "power": 1.3, "kind": "物理",
                                 "combo": "拳", "cd": 2,
                                 "res_gain": {"zen": 2},
                                 "desc": "裂岳绝式！130% 物理伤害（禅意 +2，破势目标 +3）",
                                 "name": "裂岳绝式"},
                },
            },
        },
