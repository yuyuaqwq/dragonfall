        ...
        "branches": {
            ...
            2: {
             ...
             'exprs': ['atk*0.95 + 850 + player_lv*12 + skill_lv*22'],
                        ...
                        'kind_override': '真伤',
                        'name': '龙息之怒',
                        'desc': '剑锋燃起赤金龙焰，灼浪吞没敌手——造成 95% 攻击 + 850 固定真实伤害（成长），附加 2 层灼烧'
                    },
                    "血祭": {
                        'lv': 68,
                        'mp': 0,
             ...
             'exprs': ['atk*0.25 + 222 + player_lv*3 + skill_lv*8'],
                        ...
                        'mech_val': 1,
                        'name': '怒涛连斩',
                        'desc': '刀势如怒涛般一浪高过一浪——造成 25% 攻击 + 222 固定物理伤害 ×3 段（成长），每段命中积攒 1 点战意'
                    },
                    "断筋": {
                        'lv': 80,
                        'mp': 14,
            ...
            3: {
             ...
             'exprs': ['atk*1.6 + 1600 + player_lv*18 + skill_lv*30'],
                        ...
                        'kind_override': '真伤',
                        'name': '战争化身',
                        'desc': '怒意与战意交融，化身战场之神——造成 160% 攻击 + 1600 固定真实伤害（成长），附加 3 层灼烧（狂暴限定）'
                    },
                    "燎原之怒": {
                        'lv': 93,
                        'mp': 35,
             ...
             'exprs': ['atk*0.22 + 240 + player_lv*3 + skill_lv*7'],
                        ...
                        'mech_val': 1,
                        'name': '怒涛·终焉',
                        'desc': '怒涛四叠，终焉一斩终结一切——造成 22% 攻击 + 240 固定物理伤害 ×4 段（成长），每段命中积攒 1 点战意'
                    },
                    "血怒·不灭": {
                        'lv': 97,
                        'mp': 0,
        ...
        "branches": {
            1: {
             ...
             'exprs': ['atk*0.26 + 68 + player_lv*4 + skill_lv*8'],
                        ...
                        'hits': 3,
                        'name': '幻影连刺',
                        'desc': '三道幻影接连刺出，虚实难辨——每段造成 26% 攻击 + 68 固定物理伤害共 3 段（成长），每段命中 +1 段'
                    },
                    "链舞": {
                        'lv': 44,
                        'mp': 16,
             ...
             'exprs': ['atk*0.3 + 139 + player_lv*5 + skill_lv*11'],
                        ...
                        'hits': 2,
                        'name': '双毒刃',
                        'desc': '双匕抹过剧毒连斩而出——每段造成 30% 攻击 + 139 固定物理伤害共 2 段（成长），每段附加 2 层毒'
                    },
                    "蚀骨": {
                        'lv': 44,
                        'mp': 0,
            ...
            2: {
             ...
             'exprs': ['atk*0.22 + 36 + player_lv*4 + skill_lv*7'],
                        ...
                        'hits': 4,
                        'name': '幽影连刺',
                        'desc': '幽影连闪，四道寒芒次第没入敌身——每段造成 22% 攻击 + 36 固定物理伤害共 4 段（成长），每段命中 +1 段'
                    },
                    "影遁": {
                        'lv': 85,
                        'mp': 14,
             ...
             'exprs': ['atk*0.7 + 940 + player_lv*8 + skill_lv*17'],
                        ...
                        'cd': 16,
                        'name': '腐蚀之刃',
                        'desc': '刃锋蚀过之处甲胄崩解成粉——造成 70% 攻击 + 940 固定真实伤害（成长），附加 2 层腐蚀'
                    },
                    "淬毒刺杀": {
                        'lv': 85,
                        'mp': 20,
            ...
            3: {
             ...
             'exprs': ['atk*0.26 + 58 + player_lv*4 + skill_lv*8'],
                        ...
                        'hits': 4,
                        'name': '幻影舞',
                        'desc': '幻影与真身共舞，寒刃漫天——每段造成 26% 攻击 + 58 固定物理伤害共 4 段（成长），影舞态中伤害 ×1.2'
                    },
                    "终结·暗影绞杀": {
                        'lv': 95,
                        'mp': 20,
             ...
             'exprs': ['atk*0.78 + 1750 + player_lv*8.5 + skill_lv*20.5'],
                        ...
                        'kind_override': '真伤',
                        'name': '万毒噬心',
                        'desc': '万毒汇入敌体，噬咬心脉脏腑——造成 78% 攻击 + 1750 固定真实伤害（成长），附加 3 层腐蚀'
                    },
                    "毒刃·共鸣": {
                        'lv': 97,
                        'mp': 0,
