...
PLAYER_SKILLS = {
    ...
    "sk_po_xiao_zhi_quan": {
                ...
                "desc": "将周身气力凝于一拳，如破晓曙光——造成 240% 致命一击，消耗全部气(每点气＋10% 威力，满 10 气威力翻倍)；目标处于破绽被晕当回合伤害×1.15",
                "name": "破晓之拳"
            },
...
,
                    ...
                    "元素湮灭":                     {
                        ...
                        "desc": "湮灭之力倾泻而出，造成 240% 魔法伤害并消耗全部充能(每点＋20%，满 5 充能威力翻倍)，同时回复 20% 伤害值的魔力；元素架设中释放威力×1.4(受乘区封顶)",
                        "name": "元素湮灭"
                    }
,
                },
            ...
            3: {
                "暮影收割者": {
                    "幽影刃": {"lv": 75, "mp": 35, "power": 2.0, "kind": "物理",
                               ...
                               # v139 影舞态内潜行乘区 ×1.25 叠乘
                               "dance_stealth_mult": 1.25,
                               "desc": "凝聚暗影为刃，自潜行中一击破敌——造成 200% 物理伤害，对满血目标必定暴击，消耗 3 点影步（潜行出手时伤害×1.25；影舞态内乘区叠乘）",
                               "name": "幽影刃"},
                    ...
                    "终结·破影一击": {"lv": 80, "mp": 45, "power": 3.2, "kind": "物理",
                                 ...
                                 "dance_stealth_mult": 1.5,
                                 "desc": "破开影幕的终焉一击，伏于暗影中的杀机倾泻而出——造成 320% 致命一击，消耗 4 点影步；潜行伏击出手时伤害×1.5（影舞态内乘区叠乘，EQ 窗口≈7.2）",
                                 "name": "终结·破影一击"},
