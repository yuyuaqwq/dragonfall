...
SUBAREAS = {
    ...
    "white_deer_forest": [
        ...
        },
        {
            ...
            "monsters": [
                ...
                # s77 侦探与怪盗：蒙面小贼·米洛（制服战目标；白鹿城为城镇图不刷怪，
                # 挂白鹿之森深处保证可遭遇，lv 与子区域 lv5 匹配，名与 s77 kill 目标一致）
                [
                    "m_meng_mian_xiao_zei_mi_luo",
                    "蒙面小贼·米洛",
                    "speedster",
                    5,
                    [
    ...
    "white_deer": [
        ...
        },
        {
            ...
            "name": "鹿鸣医馆",
            "icon": "🏘️",
            "desc": "鹿鸣医馆里药香清苦，白袍医师在案前问诊。架上整齐码着药剂瓶，伤病之人总能在这里找到慰藉。",
            "type": "城镇",
            "lv": 5,
            "npcs": [
                "npc_doctor",
        ...
        },
        {
            ...
            "name": "鹿香灶坊",
            "icon": "🏘️",
            "desc": "鹿香灶坊的灶台热气腾腾，香料的味道飘满街角。大师傅翻动着锅铲，指点着学徒的火候。",
            "type": "城镇",
            "lv": 5,
            "npcs": [
                "npc_cook_master",
        ...
        },
        {
            ...
            "name": "鹿角淬火坊",
            "icon": "🏘️",
            "desc": "鹿角淬火坊里摆满磨石与符文，工匠仔细检查着每一件装备。叮叮当当的敲打声里，武器变得更锋利。",
            "type": "城镇",
            "lv": 5,
            "npcs": [
                "npc_enhance_master",
    ...
    "ironharbor": [
        ...
        },
        {
            ...
            "name": "渔火码头",
            "icon": "🏘️",
            "desc": "渔火码头的木栈道延伸到海里，渔船随浪起伏。渔人们吆喝着卸下满舱的鱼获，海鸥在头顶盘旋争食。",
            "type": "城镇",
            "lv": 10,
        ...
        },
        {
            ...
            "name": "海风锻造坊",
            "icon": "🏘️",
            "desc": "海风锻造坊里炉火不熄，铁砧声震得地面发颤。这里的匠人专为冒险者打造利器，每一件都淬过海风。",
            "type": "城镇",
            "lv": 10,
            "npcs": [
                "npc_harbor_watchman",
    ...
    "silver_brook": [
        ...
        },
        {
            ...
            "name": "溪畔集市",
            "icon": "🏘️",
            "desc": "溪畔集市上搭着布棚，银溪的物产摆满摊头。货郎的吆喝声与溪水声混成一片，热闹而亲切。",
            "type": "城镇",
            "lv": 12,
            "npcs": [
                "npc_silver_peddler",
    ...
    "dawn_city": [
        ...
        },
        {
            ...
            "name": "晨曦药剂坊",
            "icon": "🏘️",
            "desc": "晨曦药剂坊里坩埚咕嘟作响，彩色烟雾从瓶瓶罐罐间升起。学徒手忙脚乱地记录着配方，导师在旁摇头。",
            "type": "城镇",
            "lv": 25,
            "npcs": [
                "npc_dawn_squire",
    ...
    "frost_horn": [
        ...
        },
        {
            ...
            "name": "霜烛圣堂",
            "icon": "🏘️",
            "desc": "霜烛圣堂是一间石头小屋，祭坛上点着不灭的烛火。随军牧师为出征的战士祈祷，声音低沉而坚定。",
            "type": "城镇",
            "lv": 60,
            "npcs": [
                "npc_field_priest"
    ...
    "anvil_fort": [
        ...
        },
        {
            ...
            "name": "符印锻室",
            "icon": "🏘️",
            "desc": "符印锻室里刻刀与符文石摆满长桌，工匠们屏息凝神地凿刻。酿酒的矮人偶尔探头，送来一桶麦酒。",
            "type": "城镇",
            "lv": 65,
            "npcs": [
                "npc_anvil_brewer",
    ...
    "ash_temple": [
            ...
            },
            {
                ...
                "name": "熔火厅",
                "icon": "🌡️",
                "desc": "大厅中央的熔岩池翻涌着暗红气泡，恶魔祭司在池边献祭，火焰舔舐着石柱。焦黑的廊柱间，低沉的咏唱声不断回荡。",
                "type": "副本",
                "lv": 89,
                "npcs": [],
                "monsters": [
    ...
    "abyss_gate": [
            ...
            },
            {
                ...
                "name": "黑暗回廊",
                "icon": "🕯️",
                "desc": "回廊的墙壁上刻着扭曲的浮雕，深渊法师的低语声在黑暗中不断回响。暗影中，一尊深渊骑士缓缓拔出锈蚀的长剑。",
                "type": "副本",
                "lv": 94,
                "npcs": [],
                "monsters": [
            ...
            },
            {
                ...
                "name": "深渊长廊",
                "icon": "🌀",
                "desc": "长廊向地心延伸，两侧是深不见底的裂隙，深渊的风从脚下呜咽而过。猎犬的嘶鸣在黑暗中此起彼伏，仿佛有无数双眼睛在注视。",
                "type": "副本",
                "lv": 96,
                "npcs": [],
                "monsters": [
            ...
            },
            {
                ...
                "name": "蚀影祭坛",
                "icon": "🔮",
                "desc": "祭坛上漂浮着暗紫色的光球，符文在石柱间流转，祭司们的低吟汇成咏唱。守坛的深渊骑士立在祭坛四角，甲胄下透出幽幽暗光。",
                "type": "副本",
                "lv": 98,
                "npcs": [],
                "monsters": [
            ...
            },
            {
                ...
                "name": "无光深渊",
                "icon": "🕳️",
                "desc": "光在这里彻底死去，只有深渊的气息在流动，脚下每一步都踩在虚无的边缘。黑暗仿佛有重量，压得人几乎无法呼吸。",
                "type": "副本",
                "lv": 99,
                "npcs": [],
                "monsters": [
    ...
    "cold_ridge": [
        {
            ...
            "name": "雪栅营地口",
            "icon": "🏘️",
            "desc": "雪栅营地口的木栅上挂着冰霜与兽皮旗，篝火在风中跳动。猎人从雪原归来，靴子上挂着冰碴。",
            "type": "城镇",
            "lv": 68,
            "npcs": [
                "npc_cold_hunter",
        ...
        },
        {
            ...
            "name": "暖帐旅店",
            "icon": "🏘️",
            "desc": "暖帐旅店里炉火烧得正旺，牧民围坐喝着热汤。帐角的兽皮堆得老高，是这一季的收获。",
            "type": "城镇",
            "lv": 68,
            "npcs": [
                "npc_cold_herder",
        ...
        },
        {
            ...
            "name": "火塘补给站",
            "icon": "🏘️",
            "desc": "火塘补给站的货架上堆满干粮与箭矢，守火人往炉里添着柴。这里的热气与食物，是雪原上最实在的慰藉。",
            "type": "城镇",
            "lv": 68,
            "npcs": [
                "npc_cold_firekeeper",
    ...
    "frost_throne": [
            ...
            },
            {
                ...
                "name": "永冻大厅",
                "icon": "🏔️",
                "desc": "大厅的墙壁覆着千年寒冰，冰柱从穹顶垂落，寒气在空气中凝成白雾。冰霜法师的身影在冰柱间游走，低吟声回荡在空旷的大厅里。",
                "type": "副本",
                "lv": 81,
                "npcs": [],
                "monsters": [
    ...
    "dragon_tomb": [
            ...
            },
            {
                ...
                "name": "龙语回廊",
                "icon": "📜",
                "desc": "石壁上刻满龙语符文，火光映着壁画里巨龙翱翔的轮廓，字迹在幽暗中微微发亮。低沉的龙吟从回廊深处传来，仿佛在低语着什么禁忌。",
                "type": "副本",
                "lv": 92,
                "npcs": [],
                "monsters": [
            ...
            },
            {
                ...
                "name": "龙鳞熔池",
                "icon": "🌋",
                "desc": "熔岩从地缝涌出，龙鳞在火光中翻卷成堆，灼热的气浪扭曲了视野。守护熔池的龙兽在岩壁间低伏，竖瞳紧盯着每一个闯入者。",
                "type": "副本",
                "lv": 96,
                "npcs": [],
                "monsters": [
            ...
            },
            {
                ...
                "name": "万龙冢",
                "icon": "🐲",
                "desc": "无数巨龙的骸骨盘成环形墓场，骨翼如帆、龙首如塔，古老龙威压得人喘不过气。冢中央的祭坛上，龙魂如烛火般飘摇。",
                "type": "副本",
                "lv": 98,
                "npcs": [],
                "monsters": [
    ...
    "dragon_kin": [
        ...
        },
        {
            ...
            "name": "龙翼旅店",
            "icon": "🏘️",
            "desc": "龙翼旅店由龙翼骨搭成骨架，铁匠在炉边打铁。炉火与肉香让这个聚落有了家的温度。",
            "type": "城镇",
            "lv": 82,
            "npcs": [
                "npc_dragonkin_smith",
    ...
    "storm_throne": [
            ...
            },
            {
                ...
                "name": "风暴祭坛",
                "icon": "🌩️",
                "desc": "祭坛的雷柱直通天穹，狂风卷着碎石盘旋。雷暴守卫在祭坛四周列阵，天空仿佛随时会塌下来。",
                "type": "副本",
                "lv": 96,
                "npcs": [],
                "monsters": [
            ...
            },
            {
                ...
                "name": "雷云殿",
                "icon": "☁️",
                "desc": "大殿悬浮在雷云之上，云海在脚下翻涌，闪电不断劈在殿顶。风暴祭司的祷歌与雷鸣交织，空气里满是焦灼的味道。",
                "type": "副本",
                "lv": 98,
                "npcs": [],
                "monsters": [
    ...
    "shell_town": [
        ...
        },
        {
            ...
            "name": "潮歌码头",
            "icon": "🏘️",
            "desc": "潮歌码头拴着几艘渔船，渔网挂在桩上滴着水。织网人坐在栈桥边，哼着潮水的调子。",
            "type": "城镇",
            "lv": 40,
            "npcs": [
                "npc_shell_netter",
        ...
        },
        {
            ...
            "name": "海螺旅店",
            "icon": "🏘️",
            "desc": "海螺旅店的墙上嵌着各色贝壳，海风从窗缝里钻进来。店主端上一碗热鱼汤，驱散海上的寒气。",
            "type": "城镇",
            "lv": 40,
            "npcs": [
                "npc_shell_gatherer",
    ...
    "nameless_harbor": [
        ...
        },
        {
            ...
            "name": "远帆码头",
            "icon": "🏘️",
            "desc": "远帆码头的船都吃水很深，船长梅利安站在船头，眺望着无尽海的方向。这里出发的船，不问归期。",
            "type": "城镇",
            "lv": 55,
            "npcs": [
                "npc_captain_maelian",
    ...
    "pearl_city": [
        ...
        },
        {
            ...
            "name": "明珠商行",
            "icon": "🏘️",
            "desc": "明珠商行的货架上摆满珍珠与海货，采珠人把今日的收获倒上柜台，掌柜眯眼估价。",
            "type": "城镇",
            "lv": 62,
            "npcs": [
                "npc_pearl_diver",
    ...
    "deep_tunnel": [
        ...
        },
        {
            ...
            "name": "暖灶营地",
            "icon": "🏘️",
            "desc": "暖灶营地的帐篷靠着岩壁搭着，炉灶上煮着浓汤。车夫卸下货物，矿工们围坐取暖。",
            "type": "城镇",
            "lv": 65,
            "npcs": [
                "npc_tunnel_carter",
    ...
    "under_market": [
        {
            ...
            "name": "菌灯集市",
            "icon": "🏘️",
            "desc": "菌灯集市的广场被菌灯照亮，商贩们支起布棚，叫卖着地表见不到的货物。这里的货币与秘密一样多。",
            "type": "城镇",
            "lv": 70,
            "npcs": [
                "npc_under_trader",
        ...
        },
        {
            ...
            "name": "暗槌拍卖区",
            "icon": "🏘️",
            "desc": "暗槌拍卖区的台子上摆着地底挖出的奇物，守卫抱着臂站在角落。落槌声在岩壁间回响。",
            "type": "城镇",
            "lv": 70,
            "npcs": [
                "npc_under_guard",
        ...
        },
        {
            ...
            "name": "低语旅店",
            "icon": "🏘️",
            "desc": "低语旅店的房间嵌在岩壁里，低语者在前台登记。这里的床铺安静，适合不想被找到的人。",
            "type": "城镇",
            "lv": 70,
            "npcs": [
                "npc_under_whisper",
    ...
    "gray_dwarf": [
            ...
            },
            {
                ...
                "name": "机械工坊",
                "icon": "⚙️",
                "desc": "齿轮与管道密布四壁，蒸汽从阀门嘶嘶喷出，机械臂在头顶缓缓摆动。灰矮人技师在工坊间穿梭，眼里只有机械和轰鸣。",
                "type": "副本",
                "lv": 80,
                "npcs": [],
                "monsters": [
            ...
            },
            {
                ...
                "name": "锻造大厅",
                "icon": "🔨",
                "desc": "大厅中央的铁砧被锤得火星四溅，灰矮人战士围在熔炉旁，铁水顺着沟槽流向模具。战鼓般的锤声一下一下敲在心头。",
                "type": "副本",
                "lv": 82,
                "npcs": [],
                "monsters": [
    ...
    "under_dragon": [
            ...
            },
            {
                ...
                "name": "熔岩通道",
                "icon": "🌋",
                "desc": "熔岩在通道两侧缓缓流淌，热浪扭曲着空气，龙爪印烙印在岩壁上。幼龙在岩浆边嬉闹，古龙裔的影子在火光中忽长忽短。",
                "type": "副本",
                "lv": 90,
                "npcs": [],
                "monsters": [
    ...
    "ember_camp": [
        {
            ...
            "name": "熔光营地口",
            "icon": "🏘️",
            "desc": "熔光营地口的黑铁哨栏泛着红光，向导与商贩在门口搭话。岩浆渠在营地边缓缓流过，把黑夜映成橘红色。",
            "type": "城镇",
            "lv": 85,
            "npcs": [
                "npc_under_guide",
        ...
        },
        {
            ...
            "name": "炬火补给站",
            "icon": "🏘️",
            "desc": "炬火补给站的货架摆满干粮、绳索与火把，侦察兵清点着装备。这里的光亮与物资，是地底旅途的底气。",
            "type": "城镇",
            "lv": 85,
            "npcs": [
                "npc_ember_scout",
    ...
    "abyss_throne": [
            ...
            },
            {
                ...
                "name": "黑曜回廊",
                "icon": "🪨",
                "desc": "回廊由整块黑曜石砌成，石壁上雕着献祭的壁画，暗红的纹路像凝固的血。术士的低语在壁间回响，守卫的脚步声整齐而沉重。",
                "type": "副本",
                "lv": 92,
                "npcs": [],
                "monsters": [
            ...
            },
            {
                ...
                "name": "血祭广场",
                "icon": "🩸",
                "desc": "广场中央的祭坛浸满暗红，献祭的纹路向四周蔓延。深渊守卫与术士环伺四周，眼中没有一丝活物的光。",
                "type": "副本",
                "lv": 96,
                "npcs": [],
                "monsters": [
    ...
    "eye_of_storm": [
            ...
            },
            {
                ...
                "name": "风廊",
                "icon": "🌬️",
                "desc": "狭长的走廊悬在云海之上，风从两侧灌入，脚下的云桥时隐时现。天空战士的身影在风墙后忽隐忽现，箭矢破空声不绝于耳。",
                "type": "副本",
                "lv": 94,
                "npcs": [],
                "monsters": [
            ...
            },
            {
                ...
                "name": "雷云广场",
                "icon": "⛈️",
                "desc": "广场的云层被雷光照得透亮，风暴守卫的雷枪在雷光中闪烁。元素军团在云层间列阵，天空仿佛裂开了一道道口子。",
                "type": "副本",
                "lv": 98,
                "npcs": [],
                "monsters": [
            ...
            },
            {
                ...
                "name": "天穹之巅",
                "icon": "🌈",
                "desc": "云海在脚下铺到天边，穹顶之上星光闪烁，风声在这里归于寂静。风暴之眼就在前方——天空尽头，最后一道门。",
                "type": "副本",
                "lv": 99,
                "npcs": [],
                "monsters": [
    ...
    "cloud_sanctum": [
            ...
            },
            {
                ...
                "name": "流云阶",
                "icon": "🌤️",
                "desc": "云阶一级级通向云端，光柱从穹顶落下，脚下是流动的云。云殿守卫的身影在光雾中浮现，手中的长枪泛着冷光。",
                "type": "副本",
                "lv": 96,
                "npcs": [],
                "monsters": [
            ...
            },
            {
                ...
                "name": "天光庭院",
                "icon": "🌅",
                "desc": "庭院开在云海之上，阳光从云隙洒下，光之祭司的咏唱在庭间回荡。云殿守卫列队而立，天光在他们甲胄上流动。",
                "type": "副本",
                "lv": 98,
                "npcs": [],
                "monsters": [
            ...
            },
            {
                ...
                "name": "星穹圣殿",
                "icon": "🌌",
                "desc": "穹顶是流动的星河，星辉如雨洒落，圣歌在云间回荡。光与云在这里交汇，仿佛整片天空都在注视着你。",
                "type": "副本",
                "lv": 99,
                "npcs": [],
                "monsters": [
