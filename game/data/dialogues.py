...
DIALOGUES = {
    ...
    "npc_warrior_tutor": {
        ...
        "nodes": {
            ...
            "evolve_t2": {"text": "Lv.60！向更高处走：狂战统领还是圣殿骑士？", "options": [{"text": "转职为狂战统领（⚔️ 进攻）", "next": "evolved", "action": {"evolve_class": {"tier": 2, "path": 1}}}, {"text": "转职为圣殿骑士（🛡️ 防御）", "next": "evolved", "action": {"evolve_class": {"tier": 2, "path": 2}}}]},
            "evolve_t3": {"text": "Lv.90，战士的终点：战争领主，或圣辉骑士。", "options": [{"text": "转职为战争领主（⚔️ 进攻）", "next": "evolved", "action": {"evolve_class": {"tier": 3, "path": 1}}}, {"text": "转职为圣辉骑士（🛡️ 防御）", "next": "evolved", "action": {"evolve_class": {"tier": 3, "path": 2}}}]},
    ...
    "npc_assassin_tutor": {
        ...
        "nodes": {
            ...
            "evolve_t2": {"text": "Lv.60！幻影刺客还是淬毒师？", "options": [{"text": "转职为幻影刺客（⚔️ 进攻）", "next": "evolved", "action": {"evolve_class": {"tier": 2, "path": 1}}}, {"text": "转职为淬毒师（🛡️ 防御）", "next": "evolved", "action": {"evolve_class": {"tier": 2, "path": 2}}}]},
            "evolve_t3": {"text": "Lv.90，刺客的终路：幽影刺客，或蚀骨者。", "options": [{"text": "转职为幽影刺客（⚔️ 进攻）", "next": "evolved", "action": {"evolve_class": {"tier": 3, "path": 1}}}, {"text": "转职为蚀骨者（🛡️ 防御）", "next": "evolved", "action": {"evolve_class": {"tier": 3, "path": 2}}}]},
