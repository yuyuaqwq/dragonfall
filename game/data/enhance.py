...
ENHANCE_TABLE = {
    ...
    1: {"rate": 0.95, "cost": 120,  "mult": 1.06},
    2: {"rate": 0.88, "cost": 250,  "mult": 1.14},
    3: {"rate": 0.78, "cost": 450,  "mult": 1.24},
    4: {"rate": 0.65, "cost": 800,  "mult": 1.36},
    5: {"rate": 0.52, "cost": 1300, "mult": 1.50},
    6: {"rate": 0.42, "cost": 2000, "mult": 1.62},
    7: {"rate": 0.32, "cost": 3200, "mult": 1.76},
    8: {"rate": 0.25, "cost": 5000, "mult": 1.92},
    ...
    # v136 数值重构：+9 2.62→2.10（-20%），给原石/怪异炼成腾乘区空间（docs/EQUIP_V136_PLAN.md）
    9: {"mult": 2.10},
}
