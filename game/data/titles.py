...
TITLES = [
    ...
    {"id": "fish10",      "name": "垂钓大师",   "desc": "钓鱼 10 次"},
    ...
    {"id": "pro_mining3", "name": "挖矿工",     "desc": "采矿达到 Lv.3"},
    {"id": "pro_mining6", "name": "矿脉猎手",   "desc": "采矿达到 Lv.6"},
    {"id": "pro_mining10", "name": "群山之王",   "desc": "采矿达到 Lv.10（攻击 +8）", "bonus": {"atk": 8}},
    {"id": "pro_fishing3", "name": "垂钓新手",   "desc": "钓鱼达到 Lv.3"},
    {"id": "pro_fishing6", "name": "捕鱼能手",   "desc": "钓鱼达到 Lv.6"},
    {"id": "pro_fishing10", "name": "深海渔神",   "desc": "钓鱼达到 Lv.10（暴击 +2%）", "bonus": {"crit": 0.02}},
    ...
    {"id": "pro_craft3", "name": "铁匠学徒",   "desc": "打造达到 Lv.3"},
    {"id": "pro_craft6", "name": "锻造师",     "desc": "打造达到 Lv.6"},
    {"id": "pro_craft10", "name": "神锻宗师",   "desc": "打造达到 Lv.10（防御 +8）", "bonus": {"def": 8}},
