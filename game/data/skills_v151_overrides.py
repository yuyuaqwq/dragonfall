# -*- coding: utf-8 -*-
"""v151 职业体系重构：6 基础职业新技能表（最终合并版 v4 · 统一 3-key 分支）

来源：workspace/skills_v151_*.py（6 个独立落地文件，主 agent 归一化合并 + 分支重排）
合并策略：
  PLAYER_SKILLS：同名技能用旧 key 覆盖新定义（玩家存档兼容），纯新增用新 key 追加；
                与分支重名的旧基础技能删除（v151 语义：分支专属）
  BRANCH_SKILLS：整体替换为新分支表，统一 3-key 结构（key1=T1 30级 / key2=T2 60级 / key3=T3 90级），
                每 key 含 A线名 + B线名，技能 key 统一中文名（引擎按名查）
本模块由脚本生成，勿手改；修改请重新运行生成脚本。
"""
    ...
    "cls_zhan_shi": {
        ...
        "skills": {
            ...
            "sk_p_tie_bi_zhi_xin": {'lv': 25,
             ...
             'name': '铁壁之心'},
            "sk_p_gang_tie_bi_lei": {'lv': 30,
             'mp': 0,
             'power': 0,
             'kind': '被动',
             'passive': {'stat': 'def', 'cond': 'hp_high_70', 'mult': 0.1},
             'desc': '气血充盈时防线如铁铸——生命高于 70% 时防御＋10%',
             'name': '钢铁壁垒'},
            "sk_p_po_jia_ben_neng": {'lv': 38,
             'mp': 0,
             'power': 0,
             'kind': '被动',
    ...
    "cls_fa_shi": {
        ...
        "skills": {
            ...
            "sk_fa_shu_fan_zhi": {'lv': 16,
             ...
             'name': '法术禁制'},
            "sk_p_lie_yan_qin_he": {'lv': 12,
             'mp': 0,
             'power': 0,
             'kind': '被动',
             'passive': {'proc': 'fire_bonus', 'mult': 0.1},
             'desc': '与火元素心意相通，施放火系技能时伤害＋10%(被动)',
             'name': '烈焰亲和'},
            "sk_p_han_shuang_qin_he": {'lv': 25,
             'mp': 0,
             'power': 0,
             'kind': '被动',
    ...
    "cls_mu_shi": {
        ...
        "skills": {
            ...
            "sk_p_bi_hu_zhi_guang": {'lv': 12,
             ...
             'name': '庇护之光'},
            "sk_p_shen_sheng_jian_ren": {'lv': 25,
             'mp': 0,
             'power': 0,
             'kind': '被动',
    ...
    "cls_ci_ke": {
        ...
        "skills": {
            ...
            "sk_p_ji_ying": {'lv': 25,
             ...
             'name': '疾影术'},
            "sk_p_ying_ren_jing_tong": {'lv': 30,
             'mp': 0,
             'power': 0,
             'kind': '被动',
             'passive': {'stat': 'crit_dmg', 'add': 0.1},
             'desc': '刃与影浑然一体，出刀必中要害——暴击伤害＋10%（一转觉醒·影刃精通，被动）',
             'name': '影刃精通'},
            "sk_p_ju_du_qin_he": {'lv': 38,
             'mp': 0,
             'power': 0,
             'kind': '被动',
    ...
    "cls_wu_seng": {
        ...
        "skills": {
            ...
            "sk_po_xiao_zhi_quan": {'lv': 30,
             ...
             'name': '破晓之拳'},
            "sk_p_lian_zhao_jing_tong": {'lv': 12,
             'mp': 0,
             'power': 0,
             'kind': '被动',
