    ...
    "cls_zhan_shi": {
        ...
        "skills": {
            ...
            "sk_zhan_shi_zhan_hou": {'lv': 3,
             ...
             'mech_val': 2,
             'team': 'atk_all',
             'desc': '胸腔炸开一声战吼，战意点燃血液——攻击＋30% 持续 3 刻；组队时战意传染全队(全队攻击＋30%)，自身积攒 2 点战意',
             'name': '战吼'},
            ...
            "sk_zhan_shi_dun_ji": {'lv': 18,
             ...
             'mech': 'stun',
             'mech_chance': 0.35,
             'desc': '重盾悍然撞出——造成 130% 物理伤害，35% 概率震晕目标 1 刻(CD 3)',
             'name': '盾击'},
    ...
    "cls_you_xia": {
        ...
        "skills": {
            ...
            "sk_you_xia_ying_yan": {'lv': 12,
             ...
             'cd': 3,
             'res_cost': {'energy': 15},
             'desc': '瞳中映出鹰隼的金芒，猎物的一切破绽无所遁形——暴击率＋20%，持续 3 刻（鹰眼锁定·增益）',
             'name': '鹰眼锁定'},
            ...
            "sk_you_xia_shan_bi": {'lv': 24,
             ...
             'cd': 4,
             'res_cost': {'energy': 30},
             'desc': '身随风向斜踏一步，身形如烟——闪避率＋30%，持续 3 刻（闪避步·补生存）',
             'name': '闪避步'},
    ...
    "cls_mu_shi": {
        ...
        "skills": {
            ...
            "sk_m_xin_yang_qi_dao": {'lv': 16,
             ...
             'effect': 'matk_up',
             'team': 'matk_all',
             'desc': '向神明祈祷换取力量加身——全队魔攻＋50% 持续 3 刻',
             'name': '信仰祈祷'},
    ...
    "cls_ci_ke": {
        ...
        "skills": {
            ...
            "sk_ci_ke_yan_wu_dan": {'lv': 18,
             ...
             'effect': 'dodge_up',
             'cd': 4,
             'desc': '掷出烟雾弹，身形隐入迷障脱战——闪避率大幅提升，持续 3 刻（生存）',
             'name': '烟雾弹'},
            "sk_ci_ke_ji_ying": {'lv': 22,
             ...
             'effect': 'spd_up',
             'cd': 3,
             'desc': '足尖点地，身影拖出残像掠向目标——速度＋40%，持续 3 刻（机动）',
             'name': '疾影'},
            "sk_cui_du": {'lv': 8,
             'mp': 5,
             'power': 0.8,
    ...
    "cls_wu_seng": {
        ...
        "skills": {
            ...
            "sk_qs_zhen_di_ji": {'lv': 22,
             ...
             'mech': 'stun',
             'mech_chance': 0.3,
             'desc': '重腿砸地，震波轰然扩散——造成 110% 物理伤害，30% 概率震晕目标 1 刻',
             'name': '震地击'},
            "sk_qs_tong_qiang": {'lv': 8,
             ...
             'effect': 'def_up',
             'cd': 3,
             'desc': '周身气劲凝为壁垒，坚不可摧——防御＋45% 持续 2 刻(补生存)',
             'name': '铜墙'},
        ...
        "branches": {
            1: {'狂战士': {'怒斩': {'lv': 32,
                     ...
                     '狂战怒吼': {'lv': 55,
                              ...
                              'mech_val': 3,
                              'team': 'atk_all',
                              'desc': '胸腔炸开一声战吼，战意点燃血液——攻击＋30% 持续 3 刻；组队时战意传染全队(全队攻击＋30%)，自身积攒 3 点战意',
                              'name': '狂战怒吼'}},
             '盾卫士': {'盾击·卫': {'lv': 32,
                              'mp': 5,
                              'power': 1.3,
                              ...
                              'desc': '重盾裹挟守护之力悍然砸出——造成 130% 盾击伤害，35% 概率震晕目标 1 刻；守护姿态生效时伤害＋20%',
                              'name': '盾击·卫'},
                     '守护姿态': {'lv': 38,
                              'mp': 0,
                              'power': 0,
                              ...
                              'desc': '沉稳如山的守护架势——受到伤害降低 10%；受击自动反击 40% 物理(不耗怒气、不吃 CD、每受击至多 1 次)，刻末保底回怒 1(战意版待引擎接线)',
                              'name': '守护姿态'},
                     '坚盾壁垒': {'lv': 45,
                              'mp': 0,
                              'power': 0,
                     ...
                     '嘲讽': {'lv': 55,
                            ...
                            'cd': 3,
                            'team': 'taunt',
                            'desc': '一声挑衅怒喝，将敌意尽数引向自身——强制怪物攻击自己 2 刻(CD 3)',
                            'name': '嘲讽'}}},
            2: {'狂战统领': {'龙息之怒': {'lv': 58,
                               'mp': 30,
                               'power': 1.0,
                      ...
                      '断筋': {'lv': 78,
                             ...
                             'mech': 'spd_down',
                             'mech_val': 2,
                             'desc': '剑刃精准斩断目标筋腱——造成 120% 物理伤害并减速目标 2 刻；附加流血(引擎待接线)',
                             'name': '断筋'},
                      '狂热': {'lv': 84,
                             'mp': 0,
                             'power': 0,
             ...
             '坚盾卫士': {'圣盾': {'lv': 60,
                             ...
                             'team': 'reduce_all',
                             'cd': 4,
                             'desc': '圣光凝成守护之盾——全队减伤 25% 持续 3 刻，花 3 层战意(战意消耗待引擎接线)',
                             'name': '圣盾'},
                      '坚韧': {'lv': 64,
                             'mp': 0,
                             'power': 0,
                      ...
                      '破城锤': {'lv': 70,
                              ...
                              'mech': 'stun',
                              'mech_chance': 0.35,
                              'desc': '如攻城巨锤轰碎防线——造成 140% 破防伤害，35% 概率震晕目标 1 刻(CD 4)',
                              'name': '破城锤'},
                      '誓约之盾': {'lv': 76,
                               'mp': 0,
                               'power': 0,
                      ...
                      '战吼·守': {'lv': 82,
                               ...
                               'mech': 'zhan_yi',
                               'mech_val': 2,
                               'desc': '胸腔炸开一声守护战吼——全队减伤 20% 持续 3 刻，自身积攒 2 点战意(CD 4)',
                               'name': '战吼·守'}}},
            3: {'战争领主': {'战争化身': {'lv': 92,
                               'mp': 40,
                               'power': 2.6,
        ...
        "branches": {
             ...
             '时律法师': {'时滞术': {'lv': 40,
                      ...
                      '时间凝滞': {'lv': 42,
                               ...
                               'stasis': {'enter_turn': 1,
                                          ...
                                          'max_turns': 3,
                                          'erosion_power': 0.6},
                               'desc': '凝固时间的流速，进入时间凝滞——占 1 刻进入并预装资源；凝滞中每刻资源＋1、技能伤害＋40%、受击＋20%；受击 30% 打断；最多维持 3 刻',
                               'name': '时间凝滞'},
                      '时间加速': {'lv': 46,
                               'mp': 0,
                               'power': 0,
                      ...
                      '凝时锁': {'lv': 55,
                              ...
                              'mech_chance': 0.35,
                              'cd': 3,
                              'desc': '以流逝之光凝成无形锁链，锁死敌手的瞬间——造成 140% 魔法伤害，35% 概率眩晕 1 刻',
                              'name': '凝时锁'}}},
            2: {'元素术士': {'元素跃迁': {'lv': 60,
                               'mp': 0,
                               'power': 0,
             ...
             '时律术士': {'时间静止': {'lv': 62,
                               ...
                               'effect': 'sleep',
                               'cd': 3,
                               'desc': '凝固目标的时间——使目标停滞（设计为 2 刻、首领 1 刻真停滞；引擎 sleep 为受击解除型，见清单）',
                               'name': '时间静止'},
                      '时之守护': {'lv': 64,
                               'mp': 15,
                               'power': 0,
            ...
            3: {'元素贤者': {'元素裁决': {'lv': 92,
             ...
             '时律贤者': {'时停领域': {'lv': 90,
                               ...
                               'mech_chance': 1.0,
                               'cd': 6,
                               'desc': '张开时间静止领域——造成 300% 魔法伤害并必定眩晕目标（首领 1 刻）',
                               'name': '时停领域'},
                      '时间坍缩': {'lv': 92,
                               'mp': 100,
                               'power': 1.5,
    ...
    "cls_you_xia": {
        ...
        "branches": {
             ...
             '风行者': {'疾风射击': {'lv': 32,
                     ...
                     '星轨锁定': {'lv': 50,
                              ...
                              'star_lock': {'min_marks': 2,
                                            ...
                                            'mark_extra': 1,
                                            'crit_mark_extra': 1},
                              'desc': '以星光锁定命定之敌——锁定指定目标(无视站位直击，3 刻，对锁定目标伤害×1.2)；门槛猎印≥2 才可施放(CD 4)',
                              'name': '星轨锁定'}}},
            2: {'自然行者': {'自然之眼': {'lv': 60,
                               'mp': 0,
                               'power': 0,
                      ...
                      '猎杀狂宴': {'lv': 66,
                               ...
                               'team': 'crit_all',
                               'res_cost': {'energy': 30},
                               'desc': '吹响猎杀盛宴的号角，全队的杀意一同高涨——造成 130% 物理伤害；目标被标记时伤害＋30%，并全队暴击强化 3 刻（猎杀狂宴）',
                               'name': '猎杀狂宴'},
                      '剧毒之心': {'lv': 72,
                               'mp': 0,
                               'power': 0,
                      ...
                      '自然护佑': {'lv': 82,
                               ...
                               'cd': 5,
                               'res_cost': {'energy': 40},
                               'desc': '林风环绕周身，为全队拂开袭来的利刃——全队闪避率＋15%，持续 3 刻（自然护佑·补生存）',
                               'name': '自然护佑'}},
             '疾风射手': {'疾风之心': {'lv': 60,
                               'mp': 0,
                               'power': 0,
                      ...
                      '风之屏障': {'lv': 70,
                               ...
                               'cd': 5,
                               'res_cost': {'energy': 35},
                               'desc': '风织成无形的屏障护住周身——闪避率＋40%，持续 3 刻（风之屏障·补生存）',
                               'name': '风之屏障'},
                      '疾风步': {'lv': 80,
                              'mp': 0,
                              'power': 0,
                              ...
                              'cd': 3,
                              'res_cost': {'energy': 25},
                              'desc': '踏风而行，步履轻如鸿羽——速度＋40%，持续 3 刻（疾风步·补机动）',
                              'name': '疾风步'},
                      '穿甲射击': {'lv': 84,
                               'mp': 18,
                               'power': 1.6,
            ...
            3: {'万木之灵': {'猎杀时刻': {'lv': 92,
                               ...
                               'desc': '万物寂灭，唯余猎杀——全队对标记目标增伤＋30% 持续 3 刻（猎杀时刻·集火号令）',
                               'name': '猎杀时刻'},
                      '致命连射': {'lv': 95,
                               'mp': 25,
                               'power': 0.7,
                      ...
                      '召唤古树守卫': {'lv': 96,
                                 ...
                                 'cd': 6,
                                 'res_cost': {'energy': 40},
                                 'desc': '唤醒沉睡千年的古树化作重装守卫，以庞大身躯为伙伴挡下刀锋——召唤古树守卫并令全队攻击＋30%，持续 3 刻',
                                 'name': '召唤古树守卫'},
                      '死神之箭': {'lv': 98,
                               'mp': 40,
                               'power': 2.8,
             ...
             '疾风猎手': {'风神降临': {'lv': 92,
                               ...
                               'res_cost': {'energy': 40},
                               'vent_energy': 15,
                               'desc': '风神之息灌入四肢百骸，全队身形快如流光——全队速度＋30%，持续 3 刻（风神降临·极速爆发）；施放当刻精力-15(机动泄压)',
                               'name': '风神降临'},
                      '风暴之舞': {'lv': 95,
                               'mp': 20,
                               'power': 0.7,
        ...
        "branches": {
            1: {'吟游诗人': {'即兴弹唱': {'lv': 32,
                      ...
                      '轻快拨弦': {'lv': 38,
                               ...
                               'effect': 'atk_up',
                               'team': 'atk_all',
                               'desc': '轻快拨动琴弦，激昂旋律鼓舞队友——全队攻击＋30% 持续 3 刻',
                               'name': '轻快拨弦'},
                      '战歌': {'lv': 45,
                             'mp': 0,
                             'power': 0,
             ...
             '神谕者': {'圣言术': {'lv': 32,
                     ...
                     '亡灵祭仪': {'lv': 50,
                              ...
                              'desc': '亡灵祭仪常驻——场上每有 1 只亡灵单位，每刻回复少量生命（被动；按亡灵数缩放需引擎支持）',
                              'name': '亡灵祭仪'},
                     '死亡汲取': {'lv': 52,
                              'mp': 15,
                              'power': 1.2,
            ...
            2: {'灵魂歌者': {'鼓舞': {'lv': 60,
                      ...
                      '圣诗合唱': {'lv': 70,
                               ...
                               'effect': 'atk_up',
                               'team': 'atk_all',
                               'desc': '圣诗合唱响彻战场——全队攻击＋30% 持续 3 刻（设计为攻+魔攻+暴击三合一，引擎单 effect 限制，魔攻/暴击加成待引擎多增益支持）',
                               'name': '圣诗合唱'},
                      '轻风咏叹': {'lv': 74,
                               'mp': 0,
                               'power': 0,
                               ...
                               'effect': 'spd_up',
                               'team': 'spd_all',
                               'desc': '轻风咏叹拂过全场——全队速度＋30% 持续 3 刻（CTB 频率放大器）',
                               'name': '轻风咏叹'},
                      '音障': {'lv': 80,
                             'mp': 0,
                             'power': 0,
             ...
             '大主教': {'神圣恩典': {'lv': 60,
                     ...
                     '生命之泉': {'lv': 66,
                              ...
                              'desc': '生命之泉汩汩涌流——持续回血（被动：全队每刻回复 5% 生命）',
                              'name': '生命之泉'},
                     '死亡契约': {'lv': 70,
                              'mp': 0,
                              'power': 0,
                     ...
                     '墓穴低语': {'lv': 74,
                              ...
                              'desc': '墓穴深处的低语化作蚀骨寒风——对主目标施加骨噬诅咒（全队对其伤害＋20%、命中＋10%，3 刻，引擎消费待接线）',
                              'name': '墓穴低语'},
                     '亡魂低语': {'lv': 78,
                              'mp': 20,
                              'power': 1.4,
            ...
            3: {'黎明颂者': {'英雄叙事诗': {'lv': 92,
                                ...
                                'effect': 'atk_up',
                                'team': 'atk_all',
                                'desc': '吟唱英雄史诗，传奇之力加身——全队攻击＋30% 持续 3 刻（设计为攻/魔攻/暴击/速度四合一，引擎单 effect 限制，其余待多增益支持）',
                                'name': '英雄叙事诗'},
                      '奥术咏叹调': {'lv': 94,
                                'mp': 30,
                                'power': 2.2,
    ...
    "cls_ci_ke": {
        ...
        "branches": {
            1: {'影舞者': {'影刃': {'lv': 32,
                     ...
                     '暗影步': {'lv': 50,
                             ...
                             'cond': {'type': 'player_mech_stacks',
                                      ...
                                      'mult': 1.0,
                                      'label': '满段影舞'},
                             'desc': '连段满 10 段时踏入影舞态——冷却-1、受击不清空连段（影舞态，3 刻）',
                             'name': '暗影步'},
                     '影分身': {'lv': 46,
                             'mp': 0,
                             'power': 0,
                             ...
                             'effect': 'dodge_up',
                             'cd': 4,
                             'desc': '幻化出多重残像分身惑敌——闪避率＋30%，持续 3 刻（生存）',
                             'name': '影分身'}},
             '毒刃者': {'毒刃': {'lv': 32,
                            'mp': 8,
                            'power': 0.9,
            ...
            3: {'无影之刃': {'影之国度': {'lv': 92,
                               ...
                               'effect': 'shadow_realm',
                               'cd': 5,
                               'desc': '撕裂现实踏入影之国度，万物皆在暗影掌控之中——影舞态强化：速度＋40%、暴击提升，持续 3 刻（三转奥义）',
                               'name': '影之国度'},
                      '幻影舞': {'lv': 95,
                              'mp': 20,
                              'power': 0.6,
        ...
        "branches": {
            1: {'格斗士': {'疾风拳': {'lv': 32,
             ...
             '磐石行者': {'铁壁拳': {'lv': 32,
                      ...
                      '厚土': {'lv': 46,
                             ...
                             'reduce_all': 0.3,
                             'cd': 4,
                             'desc': '气血盈满时身如大地——减伤＋30% 持续 2 刻(补生存)',
                             'name': '厚土'}}},
            2: {'拳术师': {'气力之心': {'lv': 60,
                              'mp': 0,
                              'power': 0,
                     ...
                     '破绽感知': {'lv': 78,
                              ...
                              'kind': '被动',
                              'passive': {},
                              'desc': '对破绽流转的敏锐感知——敌人破绽每刻自然衰减减半(衰减配置在职业级 enemy_bar，引擎暂未落地技能级覆盖)',
                              'name': '破绽感知'},
                     '震慑拳': {'lv': 84,
                             'mp': 18,
                             'power': 1.7,
            ...
            3: {'破晓者': {'气力通天': {'lv': 92,
                     ...
                     '撼岳·终焉': {'lv': 98,
                               ...
                               'desc': '撼动山岳的终焉之拳——造成 300% 物理伤害(拳连招)；敌人破绽满时必定震慑 1 刻(硬控；淬势撼岳并入破绽线)',
                               'name': '撼岳·终焉'}},
             '磐岩壁垒': {'磐石之躯': {'lv': 92,
                               'mp': 0,
                               'power': 0,
                      ...
                      '大地守护': {'lv': 95,
                               ...
                               'team': 'reduce_all',
                               'cd': 6,
                               'desc': '大地之力加护全队——全队减伤 30% 持续 3 刻(随等级提升至 50%)',
                               'name': '大地守护'},
                      '气力万法': {'lv': 98,
                               'mp': 0,
                               'power': 3.2,
