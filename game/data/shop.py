...
SHOP_SUBAREA_ITEMS = {
    ...
    "white_deer_6": ["i_treat_m", "i_mana_m", "i_treat_light", "i_herb_juice", "i_bandage", "i_salve_s", "i_salve_m", "i_antidote_pill", "i_emergency_salve", "i_flash_powder", "i_ironwall_salve"],
    ...
    "dawn_city_5": ["i_treat_m", "i_treat_l", "i_mana_m", "i_mana_l", "i_str_potion", "i_def_potion", "i_spd_potion", "mat_kong_ping", "i_treat_strong", "i_moon_dew"],
    ...
    "cold_ridge_1": ["i_treat_l", "i_mana_l", "i_treat_holy", "i_scroll_escape", "i_life_elixir", "i_salve_l", "i_holy_potion"],
