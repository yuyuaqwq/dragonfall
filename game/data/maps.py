...
MAP_CONNECTIONS = {
    ...
    "anvil_fort": ["frost_field", "forge_valley", "dwarf_long_gallery", "cold_spine_snow_trail"],
    "ash_temple": ["cinder_mountain", "abyss_gate"],
    "aurora_town": ["permafrost_field", "frost_field"],
    ...
    "dawn_city": ["dawn_cathedral", "gold_plain", "old_king_tomb", "knight_yard", "king_road", "holy_trial", "border_castle", "silver_river", "west_ridge_wilds"],
    "deep_dragon_palace": ["storm_sea"],
    "deep_lake": ["under_market", "gray_dwarf"],
    "deep_tunnel": ["fungus_forest", "dwarf_long_gallery"],
    "deer_fort": ["hill_mine"],
    "dragon_kin": ["dragonborn_valley_trail"],
    "dragon_pass": ["dragon_ridge", "ancient_battlefield", "bone_wild", "storm_cliff", "redridge_plateau", "dragonsfall_valley", "dragonborn_valley_trail", "dragon_ridge_old_road", "sky_ladder_path"],
    ...
    "emerald_valley": ["star_song", "silverwood"],
    "eye_of_storm": ["storm_plateau"],
    "forge_valley": ["anvil_fort", "winter_lake"],
    "frost_fang": ["frost_horn"],
    "frost_field": ["frost_horn", "anvil_fort", "ancient_tree", "permafrost_field", "aurora_town"],
    "frost_horn": ["ancient_tree", "frost_field", "black_forest", "frost_fang", "permafrost_field"],
    "frost_throne": ["winter_lake"],
    "frostwhisper_canyon": ["cinder_mountain"],
    "fungus_forest": ["deep_tunnel", "under_market"],
    "goblin_camp": ["misty_swamp"],
    "gold_plain": ["dawn_city", "white_abbey", "ironshield_hills", "ironshield_town"],
    ...
    "ironshield_hills": ["ironshield_town", "gold_plain"],
    "ironshield_town": ["ironshield_hills", "old_battlefield", "gold_plain"],
    "jade_port": ["coral_reef", "sunken_ship", "mist_tide_passage"],
    ...
    "moon_court": ["starlake", "elven_ruins", "moon_temple", "moon_glade", "ancient_tree", "dragon_ridge_old_road"],
    "moon_gate": ["silverwood", "dusk_ridge_road"],
    "moon_glade": ["moon_court"],
    "moon_temple": ["moon_court"],
    "moonshadow_wood": ["silverwood"],
    "nameless_harbor": ["mist_trench", "whale_domain", "mist_tide_passage", "black_tide_strait"],
    ...
    "pearl_city": ["storm_sea", "black_tide_strait"],
    "permafrost_field": ["aurora_town", "frost_field", "frost_horn"],
    "rainbow_cloud": ["wind_city", "cloud_sanctum"],
    "redridge_plateau": ["dragon_pass"],
    "silver_wind_road": ["white_deer", "ironharbor"],
    "west_ridge_wilds": ["dawn_city", "dusk_ridge_road"],
    ...
    "dragonborn_valley_trail": ["dragon_kin", "dragon_pass"],
    ...
    "shell_town": ["mermaid_bay", "coral_reef"],
    "shipwreck_graveyard": ["whale_domain"],
    "silver_brook": ["silver_valley"],
    "silver_river": ["dawn_city", "white_deer"],
    "silver_valley": ["silver_brook", "white_deer"],
    "silverwood": ["moon_gate", "starlake", "windvale", "moonshadow_wood", "emerald_valley", "star_song"],
    "siren_nest": ["mermaid_bay"],
    "star_song": ["emerald_valley", "silverwood"],
    ...
    "white_deer": ["silver_wind_road", "emerald_forest", "hill_mine", "oak_forest", "silver_river", "windmill_plain", "silver_valley"],
    "wind_city": ["cloud_sea", "rainbow_cloud", "starlight_terrace", "sky_ladder_path"],
