...
FISH_POOL = [
    ...
    {"name": "破旧的靴子", "quality": "white", "type": "垃圾", "price": 1, "spots": None,
     "weight": 20, "size_range": [24, 29], "weight_range": [0.6, 1.0], "desc": "不知道谁扔进水里的，毫无用处"},
    # ---- 绿·优良 ----
    {"name": "金鲤", "quality": "green", "type": "鱼", "price": 12, "spots": None,
     "weight": 40, "size_range": [25, 65], "weight_range": [0.8, 4.5], "desc": "鳞片泛着金光的鲤鱼，酒楼抢着收"},
    {"name": "帝王鲑", "quality": "green", "type": "鱼", "price": 22, "spots": None,
     "weight": 25, "size_range": [55, 110], "weight_range": [3, 12], "desc": "罕见的大鱼，据说吃了能增强体质"},
    {"name": "海藻", "quality": "green", "type": "材料", "price": 15,
     "spots": ["mist_trench", "whale_domain", "storm_sea"],
     "season": "summer",  # v116 夏季限定：暖水海域海藻繁茂，其它季节难觅
     "weight": 20, "size_range": [18, 42], "weight_range": [0.2, 0.7], "desc": "墨绿色的海藻，炼金师会感兴趣"},
    {"name": "鲸须草", "quality": "green", "type": "材料", "price": 20,
     "spots": ["whale_domain", "storm_sea"],
     "season": "summer",  # v116 夏季限定：龙鲸夏季洄游才落下的须草
     "weight": 15, "size_range": [30, 80], "weight_range": [0.5, 2.0], "desc": "龙鲸身上落下的须草，柔韧异常"},
    {"name": "云棉", "quality": "green", "type": "材料", "price": 22,
     "spots": ["rainbow_cloud"],
     "season_boost": "spring",  # v116 春季偏好：春云蓬松，云棉更易凝成
     "weight": 10, "size_range": [20, 35], "weight_range": [0.05, 0.15], "desc": "云朵凝成的棉絮，轻盈温暖"},
    ...
    {"name": "鲛人泪", "quality": "blue", "type": "材料", "price": 120,
     ...
     "weight": 25, "size_range": [2, 5], "weight_range": [0.01, 0.04], "desc": "鲛人落下的泪珠，炼金术的珍品"},
    {"name": "神秘鳞片", "quality": "blue", "type": "材料", "price": 30,
     "spots": ["misty_swamp", "harbor_docks", "frost_horn"],
     "weight": 25, "size_range": [15, 45], "weight_range": [0.2, 1.5], "desc": "不知名生物留下的鳞片，铁匠会感兴趣"},
    ...
    {"name": "夜光鲛", "quality": "blue", "type": "材料", "price": 35,
     ...
     "weight": 15, "size_range": [50, 120], "weight_range": [3, 15], "desc": "深夜出没于沼泽的鲛鱼，鳞片泛着幽幽荧光，炼金师视若珍宝"},
    {"name": "珍珠贝", "quality": "blue", "type": "材料", "price": 35,
     "spots": ["mist_trench", "whale_domain"],
     "weight": 20, "size_range": [15, 32], "weight_range": [0.5, 2.2], "desc": "海沟里的珍珠贝，偶尔藏着珍宝"},
    {"name": "深渊珍珠", "quality": "blue", "type": "材料", "price": 45,
     "spots": ["deep_lake"],
     "weight": 15, "size_range": [2, 4], "weight_range": [0.01, 0.05], "desc": "地底深处孕育的暗色珍珠"},
    {"name": "彩虹露珠", "quality": "blue", "type": "材料", "price": 50,
     "spots": ["rainbow_cloud"],
     "weight": 15, "size_range": [1, 3], "weight_range": [0.005, 0.02], "desc": "凝结在云端的露珠，映着七色光"},
    {"name": "风暴贝", "quality": "blue", "type": "材料", "price": 40,
     "spots": ["storm_sea"],
     "weight": 15, "size_range": [20, 40], "weight_range": [1, 3.5], "desc": "风暴中生长的贝类，壳上有雷纹"},
    # ---- 紫·史诗 ----
    {"name": "陈旧的宝箱", "quality": "purple", "type": "宝物", "price": 0, "spots": None,
     "weight": 30, "size_range": [45, 55], "weight_range": [8, 12], "desc": "水底的宝箱！打开看看有什么好东西"},
    {"name": "深海水晶", "quality": "purple", "type": "材料", "price": 250,
     "spots": ["harbor_docks", "frost_horn"],
     "season": "winter",  # v116 冬季限定：深海寒流凝结的水晶（霜原冰湖正处霜原冰层之下）
     "weight": 35, "size_range": [10, 30], "weight_range": [1.5, 6], "desc": "深海凝结的水晶，锻造珍品"},
    {"name": "龙涎香", "quality": "purple", "type": "材料", "price": 180,
     "spots": ["harbor_docks", "frost_horn"],
     "season": "winter",  # v116 冬季限定：冬季龙鲸北上洄游才分泌
     "weight": 25, "size_range": [12, 40], "weight_range": [0.5, 4], "desc": "龙涎凝成的香料，炼金珍品"},
    ...
    {"name": "鱼王·翡翠巨龙", "quality": "orange", "type": "鱼王", "price": 245,
     "spots": ["harbor_docks"],
     "weight": 60, "size_range": [150, 260], "weight_range": [45, 80], "desc": "传说沉眠在深水中的鱼王！全服为之震动"},
    {"name": "古代鱼骨", "quality": "orange", "type": "材料", "price": 200,
     "spots": ["harbor_docks"],
     "weight": 40, "size_range": [80, 180], "weight_range": [15, 45], "desc": "上古巨兽的遗骨，蕴含神秘力量"},
]
