...
CLASSES = {
    ...
    "cls_zhan_shi": {
        ...
        "icon": "🛡️",
        "role": "坦克",
        "cast_atk": 1.4,       # v152 数据驱动动作时长：重剑普攻慢
        "cast_defend": 0.8,    # 重甲防御稍慢
        "cast_flee": 2.2,      # 重甲逃跑慢
    ...
    "cls_ci_ke": {
        ...
        "icon": "🗡️",
        "role": "输出",
        "cast_atk": 0.7,       # v152 数据驱动动作时长：匕首普攻快
        "cast_defend": 0.5,    # 轻甲防御快
        "cast_flee": 1.6,      # 轻甲逃跑快
