...
CLASSES = {
    ...
    "cls_zhan_shi": {
        ...
        "mech": "普攻、技能、挨打都会攒怒气，满 10 放『背水一战』；怒气溢出转护盾。",  # v130.7 意见#19
        "icon": "🛡️",
        "role": "坦克",
    ...
    "cls_fa_shi": {
        ...
        "mech": "纯蓝施法者，技能只耗魔力不攒资源；转职后解锁充能条，施法攒层放大招。",  # v130.7 意见#19
        "icon": "🔥",
        "role": "输出",
    ...
    "cls_you_xia": {
        ...
        "mech": "每回合自动回 30 精力，技能消耗精力；高暴击高闪避，靠疾风连射打爆发。",  # v130.7 意见#19
        "icon": "🏹",
        "role": "输出",
    ...
    "cls_mu_shi": {
        ...
        "mech": "治疗、挨打、圣光技攒信仰值，满 10 放『神迹』；能打能奶站后排保队友。",  # v130.7 意见#19
        "icon": "✨",
        "role": "治疗",
    ...
    "cls_ci_ke": {
        ...
        "mech": "普攻、技能命中攒连击点，满 5 点爆发终结技；高暴击高闪避，出手见血。",  # v130.7 意见#19
        "icon": "🗡️",
        "role": "输出",
    ...
    "cls_wu_seng": {
        ...
        "mech": "出招攒气，3 气放崩拳、10 气放破岳拳双档发力；气满溢出转护盾。",  # v130.7 意见#19
        "icon": "🥊",
        "role": "辅助",
    ...
    "cls_dragon_oath": {
        ...
        "mech": "行动、挨打、回合末攒龙力，每层+10% 增伤；满力放『龙威』真伤大招。",  # v130.7 意见#19
        "icon": "🐉",
        "role": "坦克",
    ...
    "cls_chronomancer": {
        ...
        "mech": "时之沙每回合自动+1，施法、挨打也攒；耗沙分档放时停，越拖越强。",  # v130.7 意见#19
        "icon": "⏳",
        "role": "输出",
    ...
    "cls_wild_hunter": {
        ...
        "mech": "命中才攒猎印，暴击额外+1；3 印、5 印两档终结，攒满放大招。",  # v130.7 意见#19
        "icon": "🔮",
        "role": "输出",
    ...
    "cls_hymn": {
        ...
        "mech": "治疗、受击、暗蚀攒悼咏，亡灵每回合加速；满点放神迹，溢出转盾保命。",  # v130.7 意见#19
        "icon": "💀",
        "role": "输出",
    ...
    "cls_shadow_blade": {
        ...
        "mech": "暴击命中、闪避成功才攒影步，潜行出手额外+1；挨打清空，刀尖跳舞。",  # v130.7 意见#19
        "icon": "🗡️",
        "role": "输出",
    ...
    "cls_wu_sheng": {
        ...
        "mech": "出招、连击、挨打攒禅意（慢热），每点物伤+4%；满 10 放『撼岳·终焉』。",  # v130.7 意见#19
        "icon": "🥊",
        "role": "输出",
