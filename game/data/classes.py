...
CLASSES = {
    ...
    "cls_zhan_shi": {
        ...
        "icon": "🛡️",
        "role": "坦克",
        "cast_atk": 0.7,       # v154 基准减半（速度50→出招0.7s）：重剑普攻慢
    ...
    "cls_fa_shi": {
        ...
        "icon": "🔥",
        "role": "输出",
        "cast_atk": 1.0,       # v154 基准减半（速度50→出招1.0s）：法师读条慢
        "cast_defend": 0.45,
        "cast_flee": 1.2,
    ...
    "cls_you_xia": {
        ...
        "mech": "每刻回30精力；v139满100凝神屏息，蓄力改电荷制(边攒边打)。",
        "icon": "🏹",
        "role": "输出",
        "cast_atk": 0.4,       # v154 基准减半（速度50→出招0.4s）：游侠快弓
        "cast_defend": 0.25,
        "cast_flee": 0.8,
    ...
    "cls_mu_shi": {
        ...
        "icon": "✨",
        "role": "治疗",
        "cast_atk": 0.6,       # v154 基准减半（速度50→出招0.6s）：牧师中速
        "cast_defend": 0.35,
        "cast_flee": 1.0,
    ...
    "cls_ci_ke": {
        ...
        "icon": "🗡️",
        "role": "输出",
        "cast_atk": 0.35,      # v154 基准减半（速度50→出招0.35s）：匕首普攻快
    ...
    "cls_wu_seng": {
        ...
        "icon": "🥊",
        "role": "辅助",
        "cast_atk": 0.3,       # v154 基准减半（速度50→出招0.3s）：拳师极快
        "cast_defend": 0.25,
        "cast_flee": 0.9,
