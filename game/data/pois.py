...
SUBAREA_POIS = {
    ...
    'misty_swamp:misty_swamp_1': ['herb_patch', 'loot_pile'],
    'misty_swamp:misty_swamp_2': ['herb_patch', 'fishing_spot'],
    'hill_mine:hill_mine_1': ['rune_stone', 'loot_pile'],
    ...
    'ironshield_hills:ironshield_hills_1': ['rune_stone', 'shrine'],
    ...
    'silverwood:silverwood_1': ['fishing_spot', 'loot_pile'],
    'silverwood:silverwood_2': ['fishing_spot', 'loot_pile'],
    'starlake:starlake_1': ['fishing_spot', 'shrine'],
    ...
    'ancient_battlefield:ancient_battlefield_1': ['rune_stone', 'loot_pile'],
    ...
    'mermaid_bay:mermaid_bay_1': ['fishing_spot', 'loot_pile'],
    'mermaid_bay:mermaid_bay_2': ['fishing_spot', 'loot_pile'],
    'mermaid_bay:mermaid_bay_3': ['fishing_spot', 'loot_pile'],
    'mist_trench:mist_trench_1': ['fishing_spot', 'loot_pile'],
    ...
    'starlight_terrace:starlight_terrace_1': ['scenic_view', 'rune_stone'],
