    ...
    "cls_zhan_shi": {
        ...
        "skills": {
            ...
            "sk_xuan_feng_zhan": {
             ...
             'mech_val': 1,
             'name': '旋风斩',
             'desc': '身形旋转如风暴，刀光席卷前方——造成 73% 物理伤害（前排全体），每段命中积攒 1 点战意'
            },
            "sk_chong_feng": {
             'lv': 24,
             'mp': 10,
            ...
            "sk_leng_jing": {
             ...
             'mech_val': 5,
             'name': '**冷静**',
             'desc': '长刀拄地，压下翻涌的怒意——花 5 层战意：回复 20% 生命并清除 1 个减益'
            },
        },
    },
    "cls_fa_shi": {
    ...
    "cls_wu_seng": {
        ...
        "skills": {
            ...
            "sk_zhen_di_ji": {
             ...
             'shaken_gain': 0,
             'name': '震地击',
             'desc': '重拳砸地震裂大地——造成 97% 物理伤害，40% 概率眩晕 2.0 刻'
            },
            "sk_chong_quan": {
             'lv': 24,
             'mp': 10,
             ...
             'shaken_gain': 0,
             'name': '冲拳',
             'desc': '蓄势冲拳破阵而入——造成 77% 物理伤害，位移至前排并推破绽条'
            },
            "sk_ming_xiang": {
             'lv': 28,
             'mp': 6,
    ...
    "cls_shi_ren": {
        ...
        "skills": {
            ...
            "sk_yin_ren": {
             ...
             'cd': 8,
             'name': '音刃',
             'desc': '琴弦急振，声浪凝为利刃破空而去——音波单体输出，97% 魔法伤害'
            },
            "sk_an_shen_qu": {
             'lv': 20,
             'mp': 12,
            ...
            1: {
                "森语者": {
                    ...
                    "藤蔓缠绕": {
                        ...
                        'mech2_val': 1.5,
                        'name': '藤蔓缠绕',
                        'desc': '荆棘藤蔓破土缠身，毒刺没入血肉——造成 102% 魔法伤害，附加毒 2 层并定身 1.5 刻（首领免疫）'
                    },
                    "召唤藤蔓守卫": {
                        'lv': 54,
                        'mp': 20,
            ...
            2: {
                ...
                "死灵祭司": {
                    ...
                    "骸骨洪流": {
                        ...
                        'aoe': 'all',
                        'name': '骸骨洪流',
                        'desc': '万骨奔腾如洪流倾泻——造成 117% 魔攻全体伤害，消耗全部骷髅，每只追加 90% 全体暗蚀'
                    },
                    "灵魂收割": {
                        'lv': 85,
                        'mp': 18,
            ...
            1: {
                "影舞者": {
                    ...
                    "终结·处刑": {
                        ...
                        'mech': 'finisher',
                        'name': '终结·处刑',
                        'desc': '暗影中递出必杀之刃，避无可避——造成 99% 物理伤害，连段越高伤害越高（每段 +10%），连段 ≥4 时必定暴击'
                    },
                },
                "毒刃者": {
                    "毒刃": {
                    ...
                    "毒爆": {
                        ...
                        'name': '毒爆',
                        'desc': '引动体内毒素瞬间爆裂喷涌——造成 70% 魔法伤害，引爆全部毒层（每层 +14%），结算后连段归零'
                    },
                    "淬毒之刃": {
                        'lv': 54,
                        'mp': 14,
                        ...
                        'pierce': True,
                        'name': '淬毒之刃',
                        'desc': '刃锋淬满剧毒，绿芒流转不休——造成 91% 物理伤害，附加 3 层毒持续 8 刻，并施加破防'
                    },
                    "死亡标记": {
                        'lv': 58,
                        'mp': 12,
            ...
            2: {
                "影舞者": {
                    ...
                    "收割": {
                        ...
                        'name': '收割',
                        'desc': '匕刃悄然划向垂死之敌——造成 118% 物理伤害，目标生命低于 40% 时伤害 ×1.45'
                    },
                    "幽影连刺": {
                        'lv': 80,
                        'mp': 18,
                ...
                "毒刃者": {
                    ...
                    "毒雾·淬": {
                        ...
                        'aoe': 'all',
                        'name': '毒雾·淬',
                        'desc': '掷出毒瓶，碧绿毒雾弥漫全场——对全体造成 76% 魔法伤害，附加 2 层毒持续 8 刻'
                    },
                    "剧毒之触": {
                        'lv': 74,
                        'mp': 0,
                    ...
                    "淬毒刺杀": {
                        ...
                        'name': '淬毒刺杀',
                        'desc': '毒刃专挑重甲缝隙直刺心脉——造成 118% 物理伤害，目标防御越高伤害越高（最高 ×1.5）'
                    },
                    "毒雾·障": {
                        'lv': 88,
                        'mp': 16,
            ...
            3: {
                "影舞者": {
                    ...
                    "终结·暗影绞杀": {
                        ...
                        'mech': 'finisher',
                        'name': '终结·暗影绞杀',
                        'desc': '暗影如蛇绞上咽喉，无声取命——造成 138% 物理伤害，连段越高伤害越高（每段 +16%），击杀则连段保留'
                    },
                    "影舞·无间": {
                        'lv': 97,
                        'mp': 0,
                ...
                "毒刃者": {
                    ...
                    "剧毒风暴": {
                        ...
                        'aoe': 'all',
                        'name': '剧毒风暴',
                        'desc': '掀起剧毒风暴席卷全场，草木皆枯——对全体造成 91% 魔法伤害，毒层 ≥6 时伤害 ×1.4'
                    },
                    "万毒噬心": {
                        'lv': 95,
                        'mp': 45,
                    ...
                    "腐世": {
                        ...
                        'aoe': 'all',
                        'name': '腐世',
                        'desc': '腐毒如瘟疫吞没天地万物——对全体造成 91% 魔法伤害，对带毒目标伤害 ×1.3'
                    },
                },
            },
        },
            ...
            1: {
                "格斗士": {
                    "疾风拳": {
                        ...
                        'shaken_gain': 0,
                        'name': '疾风拳',
                        'desc': '疾风骤雨般连打出拳——造成 91% 物理伤害，推破绽条；速度比 ≥1.3 时推条额外 +6'
                    },
                    "旋风踢": {
                        'lv': 38,
                        'mp': 14,
                        ...
                        'aoe': 'front',
                        'name': '旋风踢',
                        'desc': '旋风扫堂踢撼前排——造成 78% 物理伤害，AOE 推破绽条（前排全体）'
                    },
                    "碎颅势": {
                        'lv': 44,
                        'mp': 16,
                        ...
                        'name': '碎颅势',
                        'desc': '拳锋直取天灵要害——造成 114% 物理伤害，对破防目标伤害 ×1.45'
                    },
                    "崩拳": {
                        'lv': 50,
                        'mp': 18,
                        ...
                        'shaken_gain': 0,
                        'name': '崩拳',
                        'desc': '崩山一拳轰然砸落——造成 125% 物理伤害，单次大幅推破绽条'
                    },
                    "气力爆发": {
                        'lv': 54,
                        'mp': 16,
                        ...
                        'name': '气力爆发',
                        'desc': '气劲灌拳轰然炸裂——造成 103% 物理伤害，目标破绽每 50 点使伤害 +80%'
                    },
                    "铁山靠": {
                        'lv': 58,
                        'mp': 10,
                ...
                "磐石行者": {
                    "铁壁拳": {
                        ...
                        'shaken_gain': 0,
                        'name': '铁壁拳',
                        'desc': '铁壁横拳，攻守兼备——造成 91% 物理伤害，推破绽条并获得护盾（推条值 ×1.5% 最大生命）持续 8 刻'
                    },
                    "守御姿态": {
                        'lv': 38,
                        'mp': 0,
                    ...
                    "磐岩释能": {
                        ...
                        'name': '磐岩释能',
                        'desc': '引磐核之力轰然释能——造成 37% 物理伤害并推破绽条，每枚磐核使伤害 +70%'
                    },
                    "厚土": {
                        'lv': 50,
                        'mp': 10,
            ...
            2: {
                "格斗士": {
                    ...
                    "气力裂空": {
                        ...
                        'name': '气力裂空',
                        'desc': '气劲裂空，拳出破晓——造成 144% 物理伤害，对破防目标伤害 ×1.5'
                    },
                    "裂岳连击": {
                        'lv': 80,
                        'mp': 22,
                    ...
                    "震慑拳": {
                        ...
                        'mech2': 'stun',
                        'name': '震慑拳',
                        'desc': '震慑之拳直撼心神——造成 144% 物理伤害，破防触发时额外眩晕 1.5 刻'
                    },
                },
                "磐石行者": {
                    "磐石之心": {
                    ...
                    "磐核爆发": {
                        ...
                        'shaken_gain': 0,
                        'name': '磐核爆发',
                        'desc': '引爆磐核，一击惊天——造成 47% 物理伤害，消耗全部磐核，每枚使伤害 +70%'
                    },
                    "气力守御": {
                        'lv': 80,
                        'mp': 18,
            ...
            3: {
                "格斗士": {
                    "气力通天": {
                        ...
                        'name': '气力通天',
                        'desc': '气贯长天，一拳通神——造成 178% 物理伤害，破绽越高伤害越高'
                    },
                    "无影连打": {
                        'lv': 93,
                        'mp': 24,
                    ...
                    "撼岳·终焉": {
                        ...
                        'shaken_gain': 0,
                        'name': '撼岳·终焉',
                        'desc': '撼岳终焉之拳崩天裂地——造成 241% 物理伤害，推破绽条；破防时目标眩晕 2.0 刻'
                    },
                    "破绽·极": {
                        'lv': 97,
                        'mp': 0,
                    ...
                    "崩山": {
                        ...
                        'name': '崩山',
                        'desc': '一拳崩山，万钧压顶——造成 171% 物理伤害，对破防目标伤害 ×1.9'
                    },
                },
                "磐石行者": {
                    "磐石之躯": {
                    ...
                    "气力万法": {
                        ...
                        'shaken_gain': 0,
                        'name': '气力万法',
                        'desc': '气力汇万法于一拳——造成 61% 物理伤害，消耗全部磐核，每枚使伤害 +70%'
                    },
                    "不动如山": {
                        'lv': 97,
                        'mp': 0,
                    ...
                    "磐岩·镇世": {
                        ...
                        'name': '磐岩·镇世',
                        'desc': '磐岩镇世，拳撼山河——造成 176% 物理伤害，推破绽条；对破防目标伤害 ×1.7'
                    },
                },
            },
        },
