    ...
    "cls_zhan_shi": {
        ...
        "skills": {
            "sk_hui_kan": {
             ...
             'exprs': ['atk*(0.82*(1+12/100*(skill_lv-1))) + player_lv + 12 + skill_lv*2'],
             'exprs': ['atk*(0.82*(1+12/100*(skill_lv-1))) + player_lv + 12 + skill_lv*2'],'formula': [{'stat': 'atk', 'mult': 0.82, 'type': 'phys', 'skill_flat': True}],
             'formula': [{'stat': 'atk', 'mult': 0.82, 'type': 'phys', 'skill_flat': True}],
             'cast': 0.45,
             'mech': 'zhan_yi',
             'mech_val': 1,
             'name': '挥砍',
            ...
            "sk_meng_ji": {
             ...
             'exprs': ['atk*(0.97*(1+12/100*(skill_lv-1))) + player_lv + 12 + skill_lv*2'],
             'exprs': ['atk*(0.97*(1+12/100*(skill_lv-1))) + player_lv + 12 + skill_lv*2'],'formula': [{'stat': 'atk', 'mult': 0.97, 'type': 'phys', 'skill_flat': True}],
            ...
            "sk_po_jia_zhan": {
             ...
             'exprs': ['atk*(0.87*(1+12/100*(skill_lv-1))) + player_lv + 12 + skill_lv*2'],
             'exprs': ['atk*(0.87*(1+12/100*(skill_lv-1))) + player_lv + 12 + skill_lv*2'],'formula': [{'stat': 'atk', 'mult': 0.87, 'type': 'phys', 'skill_flat': True}],
             'formula': [{'stat': 'atk', 'mult': 0.87, 'type': 'phys', 'skill_flat': True}],
             'cast': 0.5,
             'cd': 8,
             'mech': 'zhan_yi',
             'mech_val': 1,
            ...
            "sk_xuan_feng_zhan": {
             ...
             'exprs': ['atk*(0.93*(1+12/100*(skill_lv-1))) + player_lv + 12 + skill_lv*2'],
             'exprs': ['atk*(0.93*(1+12/100*(skill_lv-1))) + player_lv + 12 + skill_lv*2'],'formula': [{'stat': 'atk', 'mult': 0.93, 'type': 'phys', 'skill_flat': True}],
             'formula': [{'stat': 'atk', 'mult': 0.93, 'type': 'phys', 'skill_flat': True}],
             'cast': 0.7,
             'cd': 12,
             'mech': 'zhan_yi',
             'mech_val': 1,
    ...
    "cls_fa_shi": {
        ...
        "skills": {
            "sk_huo_qiu_shu": {
             ...
             'exprs': ['matk*(1.16*(1+12/100*(skill_lv-1))) + player_lv + 12 + skill_lv*2'],
             'exprs': ['matk*(1.16*(1+12/100*(skill_lv-1))) + player_lv + 12 + skill_lv*2'],'formula': [{'stat': 'matk', 'mult': 1.16, 'type': 'magi', 'skill_flat': True}],
             'cast': 0.8,
             'mech': 'fire_mark',
             'mech_val': 1,
             'name': '火球术',
            ...
            "sk_yuan_su_yin_bao": {
             ...
             'exprs': ['matk*(1.16*(1+12/100*(skill_lv-1))) + player_lv + 12 + skill_lv*2'],
             'exprs': ['matk*(1.16*(1+12/100*(skill_lv-1))) + player_lv + 12 + skill_lv*2'],'formula': [{'stat': 'matk', 'mult': 1.16, 'type': 'magi', 'skill_flat': True}],
             'formula': [{'stat': 'matk', 'mult': 1.16, 'type': 'magi', 'skill_flat': True}],
             'cast': 0.8,
             'cd': 8,
             'mech': 'element_burst',
             'mech_val': 1,
            ...
            "sk_zhou_yu_dan_mu": {
             ...
             'exprs': ['matk*(0.47*(1+9/100*(skill_lv-1))) + player_lv + 12 + skill_lv*2'],
             'exprs': ['matk*(0.47*(1+9/100*(skill_lv-1))) + player_lv + 12 + skill_lv*2'],'formula': [{'stat': 'matk', 'mult': 0.47, 'type': 'magi', 'skill_flat': True}],
             'cast': 1.0,
             'cd': 12,
             'hits': 3,
             'mech': 'thunder_mark',
            ...
            "sk_yun_shi_shu": {
             ...
             'exprs': ['matk*(1.08*(1+12/100*(skill_lv-1))) + player_lv + 12 + skill_lv*2'],
             'exprs': ['matk*(1.08*(1+12/100*(skill_lv-1))) + player_lv + 12 + skill_lv*2'],'formula': [{'stat': 'matk', 'mult': 1.08, 'type': 'magi', 'skill_flat': True}],
             'cast': 1.2,
             'cd': 16,
             'aoe': 'all',
             'name': '陨石术',
