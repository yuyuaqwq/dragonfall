...
CONSUMABLES = {
    ...
    "i_bread": {"name": "黑面包", "price": 5, "heal": 0.3, "stamina": 20,
                "desc": "非战斗回复 30% HP＋20 体力"},
    "i_meat_skewer": {"name": "烤肉串", "price": 15, "heal": 0.5, "stamina": 30,
                      "desc": "非战斗回复 50% HP＋30 体力"},
    "i_ale": {"name": "麦酒", "price": 10, "heal": 0.15, "mana": 0.15, "stamina": 15,
              "desc": "回复 15% HP/MP＋15 体力"},
    "i_stew": {"name": "炖菜", "price": 20, "heal": 0.4, "mana": 0.2, "stamina": 40,
               "desc": "非战斗回复 40% HP＋20% MP＋40 体力"},
    "i_elf_fruit": {"name": "精灵果", "price": 30, "heal": 0.3, "mana": 0.3, "stamina": 30,
                    "desc": "非战斗回复 30% HP＋30% MP＋30 体力"},
    ...
    "it_slime_jelly": {"name": "史莱姆果冻", "price": 20, "heal": 0.2, "stamina": 20,
                      "desc": "战斗外回复 20% HP＋20 体力"},
    "it_cook_skewer": {"name": "烤肉串(自制)", "price": 30, "heal": 0.35, "stamina": 30,
                      "desc": "战斗外回复 35% HP＋30 体力"},
    "it_gold_feast": {"name": "金鲤盛宴", "price": 60, "heal": 0.5, "mana": 0.2, "stamina": 60,
                     "desc": "战斗外回复 50% HP＋20% MP＋60 体力"},
    ...
    "i_oats_porridge": {"name": "燕麦粥", "price": 6, "heal": 0.2, "stamina": 20,
                        "desc": "回复 20% HP＋20 体力（橡木镇农家）"},
    "i_honey_pancake": {"name": "蜂蜜烤饼", "price": 8, "stamina": 25,
                        "desc": "回复 25 体力（橡木镇甜点）"},
    "i_apple_wine": {"name": "苹果酒", "price": 10, "mana": 0.1, "stamina": 15,
                     "desc": "回复 10% MP＋15 体力（橡木镇果园）"},
    "i_deer_burger": {"name": "鹿肉汉堡", "price": 25, "heal": 0.3, "stamina": 35,
                      "desc": "回复 30% HP＋35 体力（白鹿城名吃）"},
    "i_honey_tea": {"name": "蜂蜜茶", "price": 15, "mana": 0.2, "stamina": 20,
                    "desc": "回复 20% MP＋20 体力（白鹿城茶点）"},
    "i_deer_cheese": {"name": "鹿奶干酪", "price": 18, "stamina": 25,
                      "desc": "回复 25 体力（白鹿城牧场）"},
    "i_seafood_chowder": {"name": "海鲜浓汤", "price": 35, "heal": 0.35, "stamina": 40,
                          "desc": "回复 35% HP＋40 体力（铁港城码头）"},
    "i_salt_baked_fish": {"name": "盐焗烤鱼", "price": 28, "heal": 0.2, "mana": 0.1, "stamina": 30,
                          "desc": "回复 20% HP＋10% MP＋30 体力（铁港城渔获）"},
    "i_dock_rum": {"name": "码头朗姆", "price": 22, "mana": 0.2, "stamina": 20,
                   "desc": "回复 20% MP＋20 体力（铁港城水手）"},
    "i_moon_cake": {"name": "月光饼", "price": 30, "heal": 0.25, "mana": 0.25, "stamina": 30,
                    "desc": "回复 25% HP＋25% MP＋30 体力（月门城点心）"},
    "i_laurel_tea": {"name": "月桂茶", "price": 20, "mana": 0.3, "stamina": 25,
                     "desc": "回复 30% MP＋25 体力（月门城茶会）"},
    "i_silver_jelly": {"name": "银月果冻", "price": 16, "stamina": 20,
                       "desc": "回复 20 体力（月门城甜品）"},
    "i_sacred_bread": {"name": "圣餐面包", "price": 26, "heal": 0.3, "stamina": 30,
                       "desc": "回复 30% HP＋30 体力（圣堂赐福）"},
    "i_holy_water_drink": {"name": "圣水", "price": 12, "mana": 0.15, "stamina": 15,
                           "desc": "回复 15% MP＋15 体力（圣堂净水）"},
    "i_blessed_pastry": {"name": "祝福糕点", "price": 20, "heal": 0.2, "stamina": 25,
                         "desc": "回复 20% HP＋25 体力（圣堂烘焙）"},
    "i_pirate_stew": {"name": "海盗炖鱼", "price": 32, "heal": 0.3, "stamina": 35,
                      "desc": "回复 30% HP＋35 体力（无名港私房）"},
    "i_octopus_ball": {"name": "章鱼烧", "price": 24, "stamina": 30,
                       "desc": "回复 30 体力（无名港小吃）"},
    "i_fog_coffee": {"name": "雾港咖啡", "price": 18, "mana": 0.2, "stamina": 20,
                     "desc": "回复 20% MP＋20 体力（无名港提神）"},
    "i_ash_pancake": {"name": "灰烬烤饼", "price": 24, "heal": 0.25, "stamina": 30,
                      "desc": "回复 25% HP＋30 体力（灰烬城炭火烤）"},
    "i_lava_egg": {"name": "熔岩蛋", "price": 30, "heal": 0.2, "mana": 0.2, "stamina": 35,
                   "desc": "回复 20% HP＋20% MP＋35 体力（灰烬城特产）"},
    "i_ember_pepper": {"name": "烬火辣椒", "price": 10, "heal": 0.1, "stamina": 15,
                       "desc": "回复 10% HP＋15 体力（灰烬城辣味）"},
    "i_royal_roast": {"name": "皇家烤肉", "price": 55, "heal": 0.4, "stamina": 45,
                      "desc": "回复 40% HP＋45 体力（王都御膳）"},
    "i_gold_dessert": {"name": "金箔甜点", "price": 45, "mana": 0.3, "stamina": 30,
                       "desc": "回复 30% MP＋30 体力（王都宫廷）"},
    "i_royal_soup": {"name": "御膳汤", "price": 50, "heal": 0.3, "mana": 0.2, "stamina": 40,
                     "desc": "回复 30% HP＋20% MP＋40 体力（王都名厨）"},
    "i_elf_jam": {"name": "精灵果酱", "price": 35, "heal": 0.3, "stamina": 25,
                  "desc": "回复 30% HP＋25 体力（精灵森林）"},
    "i_nectar_wine": {"name": "花蜜酒", "price": 30, "mana": 0.3, "stamina": 20,
                      "desc": "回复 30% MP＋20 体力（精灵花房）"},
    "i_tree_honey": {"name": "树蜜糖", "price": 20, "heal": 0.2, "stamina": 15,
                     "desc": "回复 20% HP＋15 体力（世界树蜜）"},
    "i_dwarf_oven_bread": {"name": "铁炉面包", "price": 22, "heal": 0.25, "stamina": 30,
                           "desc": "回复 25% HP＋30 体力（矮人铁炉）"},
    "i_miner_stew": {"name": "矿工炖肉", "price": 28, "heal": 0.3, "stamina": 35,
                     "desc": "回复 30% HP＋35 体力（矮人矿场）"},
    "i_stone_ale": {"name": "石酿麦酒", "price": 18, "mana": 0.2, "stamina": 20,
                    "desc": "回复 20% MP＋20 体力（矮人酒窖）"},
    "i_snowwolf_steak": {"name": "雪狼肉排", "price": 38, "heal": 0.35, "stamina": 40,
                         "desc": "回复 35% HP＋40 体力（霜原猎手）"},
    "i_frost_berry": {"name": "冰霜浆果", "price": 20, "mana": 0.2, "stamina": 25,
                      "desc": "回复 20% MP＋25 体力（霜原冰果）"},
    "i_reindeer_jerky": {"name": "驯鹿干", "price": 26, "heal": 0.25, "stamina": 30,
                         "desc": "回复 25% HP＋30 体力（霜原风干）"},
    "i_dragon_pepper": {"name": "龙息辣椒", "price": 16, "heal": 0.15, "stamina": 20,
                        "desc": "回复 15% HP＋20 体力（龙脊山民）"},
    "i_dragon_egg_pancake": {"name": "龙蛋煎饼", "price": 60, "heal": 0.4, "mana": 0.2, "stamina": 45,
                             "desc": "回复 40% HP＋20% MP＋45 体力（龙脊盛宴）"},
    "i_wolf_jerky": {"name": "狼肉干", "price": 14, "heal": 0.25, "stamina": 30,
                     "desc": "回复 25% HP＋30 体力（野外干粮）"},
    "i_eagle_egg": {"name": "鹰蛋", "price": 12, "heal": 0.2, "stamina": 20,
                    "desc": "回复 20% HP＋20 体力（悬崖鹰巢）"},
    "i_snake_soup": {"name": "蛇羹", "price": 18, "heal": 0.2, "mana": 0.1, "stamina": 25,
                     "desc": "回复 20% HP＋10% MP＋25 体力（沼泽风味）"},
    "i_mushroom_soup": {"name": "蘑菇汤", "price": 12, "heal": 0.15, "stamina": 20,
                        "desc": "回复 15% HP＋20 体力（森林采菇）"},
    "i_wild_honey": {"name": "野蜂蜜", "price": 10, "mana": 0.15, "stamina": 15,
                     "desc": "回复 15% MP＋15 体力（树洞蜂巢）"},
    "i_roast_bird": {"name": "烤鸟肉", "price": 14, "heal": 0.2, "stamina": 25,
                     "desc": "回复 20% HP＋25 体力（篝火烤鸟）"},
    "i_fish_soup": {"name": "鱼汤", "price": 16, "heal": 0.2, "stamina": 25,
                    "desc": "回复 20% HP＋25 体力（河边鲜鱼）"},
    "i_herb_tea": {"name": "草药茶", "price": 8, "heal": 0.1, "mana": 0.1, "stamina": 15,
                   "desc": "回复 10% HP＋10% MP＋15 体力（清苦回甘）"},
