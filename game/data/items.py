...
CONSUMABLES = {
    ...
    "i_ale": {"name": "醇香麦酒", "food": True, "price": 10, "hot": 0.05, "hot_turns": 3, "hot_mana": 0.06, "heal": 0.15, "mana": 0.15, "stamina": 15,
              "desc": "回复 15% HP/MP + 15 体力；战斗中每回合回复 5% 生命、6% 魔力（3 回合）"},
    "i_stew": {"name": "炖菜", "food": True, "price": 20, "hot": 0.06, "hot_turns": 3, "hot_mana": 0.08, "heal": 0.4, "mana": 0.2, "stamina": 40,
               "desc": "回复 40% HP + 20% MP + 40 体力；战斗中每回合回复 6% 生命、8% 魔力（3 回合）"},
    "i_elf_fruit": {"name": "精灵圣果", "food": True, "price": 30, "hot": 0.08, "hot_turns": 3, "hot_mana": 0.12, "heal": 0.3, "mana": 0.3, "stamina": 30,
                    "desc": "回复 30% HP + 30% MP + 30 体力；战斗中每回合回复 8% 生命、12% 魔力（3 回合）"},
    "i_dwarf_liquor": {"name": "矮人烈酒", "food": True, "price": 40, "effect": "buff_atk_food", "stamina": 15,
                       "desc": "回复 15 体力；战斗中攻击+10%（3 回合）"},
    # ---- 3 药剂（战斗中瞬时 buff） ----
    ...
    "i_fury_potion": {"name": "狂怒药剂", "price": 200, "effect": "next_atk_up", "effect_data": {"pct": 0.5},
                      "desc": "下一次攻击 + 50%"},
    "i_holy_potion": {"name": "圣光药剂", "price": 100, "effect": "heal_up", "effect_data": {"pct": 0.2},
                      "desc": "3 回合治疗技能效果 + 20%"},
    "i_dragon_scale_potion": {"name": "龙鳞药剂", "price": 200, "effect": "magic_resist", "effect_data": {"pct": 0.15},
                              "desc": "3 回合受到魔法伤害－15%"},
    "i_battlecry_potion": {"name": "战吼药剂", "price": 300, "effect": "buff_atk_big",
                           "desc": "3 回合攻击 + 40%"},
    ...
    "it_slime_jelly": {"name": "史莱姆果冻", "food": True, "price": 20, "hot": 0.06, "hot_turns": 3, "heal": 0.2, "stamina": 20,
                      "desc": "回复 20% HP + 20 体力；战斗中每回合回复 6% 生命（3 回合）"},
    "it_cook_skewer": {"name": "烤肉串(自制)", "food": True, "price": 30, "hot": 0.08, "hot_turns": 3, "heal": 0.35, "stamina": 30,
                      "desc": "回复 35% HP + 30 体力；战斗中每回合回复 8% 生命（3 回合）"},
    "it_gold_feast": {"name": "金鲤盛宴", "food": True, "price": 60, "hot": 0.1, "hot_turns": 4, "hot_mana": 0.08, "heal": 0.5, "mana": 0.2, "stamina": 60,
                     "desc": "回复 50% HP + 20% MP + 60 体力；战斗中每回合回复 10% 生命、8% 魔力（4 回合）"},
    ...
    "i_treat_micro": {"name": "微效治疗药水", "price": 8, "heal": 0.15,
                      "desc": "回复 15% HP"},
    "i_treat_light": {"name": "轻效治疗药水", "price": 20, "heal": 0.25,
                      "desc": "回复 25% HP"},
    "i_treat_strong": {"name": "强效治疗药水", "price": 60, "heal": 0.5,
                       "desc": "回复 50% HP"},
    "i_treat_holy": {"name": "圣辉治疗药水", "price": 180, "heal": 0.8,
                     "desc": "回复 80% HP"},
    "i_treat_divine": {"name": "神愈药水", "price": 300, "heal": 1.0,
                       "desc": "完全回复 HP"},
    "i_herb_juice": {"name": "草药汁", "price": 12, "heal": 0.2,
                     "desc": "回复 20% HP（路边野草熬成）"},
    "i_bandage": {"name": "止血绷带", "price": 25, "heal": 0.3,
                  "desc": "回复 30% HP"},
    "i_holy_light_pot": {"name": "圣光药水", "price": 90, "heal": 0.5,
                         "desc": "回复 50% HP（圣堂祝福）"},
    "i_dragon_blood_pot": {"name": "龙血药水", "price": 200, "heal": 0.7,
                           "desc": "回复 70% HP（龙之血脉沸腾）"},
    "i_phoenix_tear": {"name": "凤凰之泪", "price": 350, "heal": 0.9,
                       "desc": "回复 90% HP（浴火重生之力）"},
    "i_life_spring": {"name": "生命之泉", "price": 500, "heal": 1.0,
                      "desc": "完全回复 HP（精灵圣地泉水）"},
    ...
    "i_lingxi_pot": {"name": "灵犀药剂", "price": 70, "mana": 0.4,
                     "desc": "回复 40% MP（心境通明）"},
    "i_full_potion_hi": {"name": "高级全效药水", "price": 120, "heal": 0.4, "mana": 0.4,
                         "desc": "回复 40% HP + 40% MP"},
    "i_full_potion_super": {"name": "超级全效药水", "price": 250, "heal": 0.5, "mana": 0.5,
                            "desc": "回复 50% HP + 50% MP"},
    "i_sage_pot": {"name": "贤者药剂", "price": 180, "heal": 0.3, "mana": 0.5,
                   "desc": "回复 30% HP + 50% MP"},
    "i_battle_mix": {"name": "战斗合剂", "price": 160, "heal": 0.4, "mana": 0.2,
                     "desc": "回复 40% HP + 20% MP"},
    "i_adventurer_mix": {"name": "冒险者合剂", "price": 100, "heal": 0.2, "mana": 0.4,
                         "desc": "回复 20% HP + 40% MP"},
    "i_holy_sage_pot": {"name": "圣贤药剂", "price": 420, "heal": 0.6, "mana": 0.6,
                        "desc": "回复 60% HP + 60% MP"},
    "i_expedition_mix": {"name": "远征合剂", "price": 200, "heal": 0.5, "mana": 0.3,
                         "desc": "回复 50% HP + 30% MP"},
    "i_apprentice_mix": {"name": "学徒合剂", "price": 30, "heal": 0.15, "mana": 0.15,
                         "desc": "回复 15% HP + 15% MP"},
    "i_life_elixir": {"name": "生命灵液", "price": 130, "heal": 0.6,
                      "desc": "回复 60% HP（精灵泉水提炼）"},
    "i_moon_holy_water": {"name": "月光圣水", "price": 160, "mana": 0.8,
                          "desc": "回复 80% MP（月下凝结）"},
    "i_salve_s": {"name": "治疗药膏", "price": 40, "heal": 150,
                  "desc": "回复 150 点 HP（固定值，旧式配方）"},
    "i_salve_m": {"name": "强效药膏", "price": 120, "heal": 300,
    ...
    "i_deer_burger": {"name": "鹿肉汉堡", "food": True, "price": 25, "effect": "buff_def_food", "heal": 0.3, "stamina": 35,
                      "desc": "回复 30% HP + 35 体力（白鹿城名吃）；战斗中防御+15%（3 回合）"},
    "i_honey_tea": {"name": "蜂蜜茶", "food": True, "price": 15, "hot_turns": 3, "hot_mana": 0.08, "mana": 0.2, "stamina": 20,
                    "desc": "回复 20% MP + 20 体力（白鹿城茶点）；战斗中每回合回复 8% 魔力（3 回合）"},
    "i_deer_cheese": {"name": "鹿奶干酪", "food": True, "price": 18, "food_effect": "thorns", "stamina": 25,
                      "desc": "回复 25 体力（白鹿城牧场）；战斗中吃下获得【反伤】：受击 10% 反弹 30% 伤害"},
    "i_seafood_chowder": {"name": "海鲜浓汤", "food": True, "price": 35, "food_effect": "precise", "heal": 0.35, "stamina": 40,
                          "desc": "回复 35% HP + 40 体力（铁港城码头）；战斗中吃下获得【精准】：本场伤害 + 10%"},
    "i_salt_baked_fish": {"name": "盐焗烤鱼", "food": True, "price": 28, "hot": 0.08, "hot_turns": 3, "hot_mana": 0.04, "heal": 0.2, "mana": 0.1, "stamina": 30,
                          "desc": "回复 20% HP + 10% MP + 30 体力（铁港城渔获）；战斗中每回合回复 8% 生命、4% 魔力（3 回合）"},
    "i_dock_rum": {"name": "码头朗姆", "food": True, "price": 22, "hot_turns": 3, "hot_mana": 0.08, "mana": 0.2, "stamina": 20,
                   "desc": "回复 20% MP + 20 体力（铁港城水手）；战斗中每回合回复 8% 魔力（3 回合）"},
    "i_moon_cake": {"name": "月光饼", "food": True, "price": 30, "food_effect": "meditate", "heal": 0.25, "mana": 0.25, "stamina": 30,
                    "desc": "回复 25% HP + 25% MP + 30 体力（月门城点心）；战斗中吃下获得【冥想】：每回合回复 1% 魔力"},
    "i_laurel_tea": {"name": "月桂茶", "food": True, "price": 20, "hot_turns": 3, "hot_mana": 0.12, "mana": 0.3, "stamina": 25,
                     "desc": "回复 30% MP + 25 体力（月门城茶会）；战斗中每回合回复 12% 魔力（3 回合）"},
    "i_silver_jelly": {"name": "银月果冻", "food": True, "price": 16, "hot": 0.06, "hot_turns": 3, "stamina": 20,
                       "desc": "回复 20 体力（月门城甜品）；战斗中每回合回复 6% 生命（3 回合）"},
    "i_sacred_bread": {"name": "圣餐面包", "food": True, "price": 26, "food_effect": "shield", "heal": 0.3, "stamina": 30,
                       "desc": "回复 30% HP + 30 体力（圣堂赐福）；战斗中吃下获得【护盾】：获得 10% 生命护盾（3 回合）"},
    "i_holy_water_drink": {"name": "圣堂净水", "food": True, "price": 12, "hot_turns": 3, "hot_mana": 0.06, "mana": 0.15, "stamina": 15,
                           # v104 R3 M08 P2-3：改名消除三名"圣水"歧义（材料 mat_sheng_shui / 药水 i_holy_water / 本品）
                           "desc": "回复 15% MP + 15 体力（圣堂净水）；战斗中每回合回复 6% 魔力（3 回合）"},
    "i_blessed_pastry": {"name": "祝福糕点", "food": True, "price": 20, "hot": 0.06, "hot_turns": 3, "heal": 0.2, "stamina": 25,
                         "desc": "回复 20% HP + 25 体力（圣堂烘焙）；战斗中每回合回复 6% 生命（3 回合）"},
    "i_pirate_stew": {"name": "海盗炖鱼", "food": True, "price": 32, "food_effect": "execute", "heal": 0.3, "stamina": 35,
                      "desc": "回复 30% HP + 35 体力（无名港私房）；战斗中吃下获得【处决】：对生命<30%的敌人 + 30%伤害"},
    "i_octopus_ball": {"name": "章鱼烧", "food": True, "price": 24, "hot": 0.06, "hot_turns": 3, "stamina": 30,
                       "desc": "回复 30 体力（无名港小吃）；战斗中每回合回复 6% 生命（3 回合）"},
    "i_fog_coffee": {"name": "雾港咖啡", "food": True, "price": 18, "effect": "buff_spd_food", "mana": 0.2, "stamina": 20,
                     "desc": "回复 20% MP + 20 体力（无名港提神）；战斗中速度+12%（3 回合）"},
    "i_ash_pancake": {"name": "灰烬烤饼", "food": True, "price": 24, "food_effect": "element_fire", "heal": 0.25, "stamina": 30,
                      "desc": "回复 25% HP + 30 体力（灰烬城炭火烤）；战斗中吃下获得【元素·火】：攻击附加 5% 火属性伤害"},
    "i_lava_egg": {"name": "熔岩蛋", "food": True, "price": 30, "hot": 0.08, "hot_turns": 3, "hot_mana": 0.08, "heal": 0.2, "mana": 0.2, "stamina": 35,
                   "desc": "回复 20% HP + 20% MP + 35 体力（灰烬城特产）；战斗中每回合回复 8% 生命、8% 魔力（3 回合）"},
    "i_ember_pepper": {"name": "烬火辣椒", "food": True, "price": 10, "food_effect": "bleed", "heal": 0.1, "stamina": 15,
                       "desc": "回复 10% HP + 15 体力（灰烬城辣味）；战斗中吃下获得【流血】：攻击 20% 使敌人流血（每回合 5% 生命，3 回合）"},
    "i_royal_roast": {"name": "皇家烤肉", "food": True, "price": 55, "food_effect": "charge", "heal": 0.4, "stamina": 45,
                      "desc": "回复 40% HP + 45 体力（王都御膳）；战斗中吃下获得【蓄力】：攻击 10% 造成 150% 伤害"},
    "i_gold_dessert": {"name": "金箔甜点", "food": True, "price": 45, "hot_turns": 4, "hot_mana": 0.12, "mana": 0.3, "stamina": 30,
                       "desc": "回复 30% MP + 30 体力（王都宫廷）；战斗中每回合回复 12% 魔力（4 回合）"},
    "i_royal_soup": {"name": "御膳汤", "food": True, "price": 50, "food_effect": "dawn_crown", "heal": 0.3, "mana": 0.2, "stamina": 40,
                     "desc": "回复 30% HP + 20% MP + 40 体力（王都名厨）；战斗中吃下获得【晨曦祝福】：每回合回复 2% 生命"},
    "i_elf_jam": {"name": "精灵果酱", "food": True, "price": 35, "effect": "food_spd_up_small", "heal": 0.3, "stamina": 25,
    ...
    "i_nectar_wine": {"name": "花蜜酒", "food": True, "price": 30, "effect": "buff_matk_food", "mana": 0.3, "stamina": 20,
                      "desc": "回复 30% MP + 20 体力（精灵花房）；战斗中魔攻+10%（3 回合）"},
    "i_tree_honey": {"name": "树蜜糖", "food": True, "price": 20, "food_effect": "regen", "heal": 0.2, "stamina": 15,
                     "desc": "回复 20% HP + 15 体力（世界树蜜）；战斗中吃下获得【回春】：每回合回复 1% 生命"},
    "i_dwarf_oven_bread": {"name": "铁炉面包", "food": True, "price": 22, "hot": 0.06, "hot_turns": 3, "heal": 0.25, "stamina": 30,
                           "desc": "回复 25% HP + 30 体力（矮人铁炉）；战斗中每回合回复 6% 生命（3 回合）"},
    "i_miner_stew": {"name": "矿工炖肉", "food": True, "price": 28, "hot": 0.08, "hot_turns": 3, "heal": 0.3, "stamina": 35,
                     "desc": "回复 30% HP + 35 体力（矮人矿场）；战斗中每回合回复 8% 生命（3 回合）"},
    "i_stone_ale": {"name": "石酿麦酒", "food": True, "price": 18, "hot_turns": 3, "hot_mana": 0.08, "mana": 0.2, "stamina": 20,
                    "desc": "回复 20% MP + 20 体力（矮人酒窖）；战斗中每回合回复 8% 魔力（3 回合）"},
    # v105R3 M16 P2-1：雪狼皮×1=35 成本，38 售价 ratio=0.92 超 90% 上限 → 40（0.875）
    "i_snowwolf_steak": {"name": "雪狼肉排", "food": True, "price": 40, "food_effect": "pierce", "heal": 0.35, "stamina": 40,
                         "desc": "回复 35% HP + 40 体力（霜原猎手）；战斗中吃下获得【贯穿】：攻击 20% 无视防御"},
    "i_frost_berry": {"name": "冰霜浆果", "food": True, "price": 20, "food_effect": "element_ice", "mana": 0.2, "stamina": 25,
                      "desc": "回复 20% MP + 25 体力（霜原冰果）；战斗中吃下获得【元素·冰】：攻击附加 5% 冰伤 + 减速"},
    "i_reindeer_jerky": {"name": "驯鹿干", "food": True, "price": 26, "hot": 0.08, "hot_turns": 3, "heal": 0.25, "stamina": 30,
                         "desc": "回复 25% HP + 30 体力（霜原风干）；战斗中每回合回复 8% 生命（3 回合）"},
    "i_dragon_pepper": {"name": "龙息辣椒", "food": True, "price": 16, "effect": "buff_crit_food", "heal": 0.15, "stamina": 20,
                        "desc": "回复 15% HP + 20 体力（龙脊山民）；战斗中暴击+8%（3 回合）"},
    "i_dragon_egg_pancake": {"name": "龙蛋煎饼", "food": True, "price": 90, "food_effect": "dragon_tongue", "heal": 0.4, "mana": 0.2, "stamina": 45,
                             "desc": "回复 40% HP + 20% MP + 45 体力（龙脊盛宴）；战斗中吃下获得【龙语印记】：攻击叠印记（每层 + 2%伤害，上限 5 层）"},
    "i_wolf_jerky": {"name": "狼肉干", "food": True, "price": 14, "food_effect": "counter", "heal": 0.25, "stamina": 30,
                     "desc": "回复 25% HP + 30 体力（野外干粮）；战斗中吃下获得【反击】：受击 20% 反击 60% 伤害"},
    "i_eagle_egg": {"name": "鹰蛋", "food": True, "price": 12, "food_effect": "combo", "heal": 0.2, "stamina": 20,
                    "desc": "回复 20% HP + 20 体力（悬崖鹰巢）；战斗中吃下获得【连击】：攻击 15% 追加 50% 伤害"},
    "i_snake_soup": {"name": "蛇羹", "food": True, "price": 18, "food_effect": "lifesteal", "heal": 0.2, "mana": 0.1, "stamina": 25,
                     "desc": "回复 20% HP + 10% MP + 25 体力（沼泽风味）；战斗中吃下获得【吸血】：攻击回复 8% 伤害为生命"},
    "i_mushroom_soup": {"name": "蘑菇汤", "food": True, "price": 12, "food_effect": "armor_break", "heal": 0.15, "stamina": 20,
                        "desc": "回复 15% HP + 20 体力（森林采菇）；战斗中吃下获得【破甲】：攻击 25% 降敌防 15%（2 回合）"},
    "i_wild_honey": {"name": "野蜂蜜", "food": True, "price": 10, "hot_turns": 3, "hot_mana": 0.06, "mana": 0.15, "stamina": 15,
                     "desc": "回复 15% MP + 15 体力（树洞蜂巢）；战斗中每回合回复 6% 魔力（3 回合）"},
    "i_roast_bird": {"name": "烤鸟肉", "food": True, "price": 14, "hot": 0.05, "hot_turns": 3, "heal": 0.2, "stamina": 25,
                     "desc": "回复 20% HP + 25 体力（篝火烤鸟）；战斗中每回合回复 5% 生命（3 回合）"},
    "i_fish_soup": {"name": "鱼汤", "food": True, "price": 16, "hot": 0.06, "hot_turns": 3, "heal": 0.2, "stamina": 25,
                    "desc": "回复 20% HP + 25 体力（河边鲜鱼）；战斗中每回合回复 6% 生命（3 回合）"},
    "i_herb_tea": {"name": "草药茶", "food": True, "price": 8, "hot": 0.03, "hot_turns": 3, "hot_mana": 0.04, "heal": 0.1, "mana": 0.1, "stamina": 15,
                   "desc": "回复 10% HP + 10% MP + 15 体力（清苦回甘）；战斗中每回合回复 3% 生命、4% 魔力（3 回合）"},
    # ---- C. 战斗药水扩展（buff 模板，6 种 p_buffs key）----
    "i_war_god_pot": {"name": "战神药剂", "price": 150, "effect": "buff_atk",
                      "desc": "3 回合攻击 + 30%"},
    "i_brute_pot": {"name": "蛮力药剂", "price": 80, "effect": "buff_atk_small",
                    "desc": "3 回合攻击 + 20%"},
    "i_armor_break_pot": {"name": "破甲药剂", "price": 120, "effect": "armor_break_pot", "effect_data": {"pct": 0.15, "turns": 2},
                          "desc": "敌人防御－15%（2 回合）"},
    "i_dragon_power_pot": {"name": "龙力药剂", "price": 280, "effect": "buff_atk_big",
                           "desc": "3 回合攻击 + 40%"},
    "i_rock_shield_pot": {"name": "岩盾药剂", "price": 90, "effect": "rock_shield", "effect_data": {"pct": 0.10},
                          "desc": "获得 10% 生命护盾（3 回合）"},
    "i_thorn_pot": {"name": "荆棘药剂", "price": 110, "effect": "thorns_pot", "effect_data": {"pct": 0.30},
                    "desc": "3 回合受击反弹 30% 伤害"},
    "i_holy_shield_pot": {"name": "圣盾药剂", "price": 180, "effect": "holy_shield", "effect_data": {"pct": 0.15},
                          "desc": "获得 15% 生命护盾（3 回合）"},
    "i_immovable_pot": {"name": "不动药剂", "price": 70, "effect": "cc_immune", "effect_data": {"turns": 3},
                        "desc": "3 回合免疫眩晕/冻结/减速"},
    "i_swift_pot": {"name": "迅捷药剂", "price": 90, "effect": "buff_spd",
                    "desc": "3 回合速度 + 40%"},
    "i_shadowstep_pot": {"name": "影步药剂", "price": 150, "effect": "dodge_pot", "effect_data": {"pct": 0.15},
                         "desc": "3 回合 15% 概率闪避攻击"},
    "i_pene_pot": {"name": "穿甲药剂", "price": 160, "effect": "pene_pot", "effect_data": {"pct": 0.15},
                   "desc": "3 回合物穿 + 15%（v106.2）"},
    "i_pene_magi_pot": {"name": "破法药剂", "price": 160, "effect": "pene_magi_pot", "effect_data": {"pct": 0.15},
                        "desc": "3 回合法穿 + 15%（v106.2）"},
    "i_lifesteal_pot": {"name": "嗜血药剂", "price": 170, "effect": "lifesteal_pot", "effect_data": {"pct": 0.15},
                        "desc": "3 回合吸血 + 15%（v106.3）"},
    "i_crit_dmg_pot": {"name": "狂暴药剂", "price": 160, "effect": "crit_dmg_pot", "effect_data": {"pct": 0.25},
                       "desc": "3 回合暴击伤害 + 25%（v106.3）"},
    "i_block_pot": {"name": "岩壁药剂", "price": 150, "effect": "block_pot", "effect_data": {"pct": 0.15},
                    "desc": "3 回合格挡 + 15%（v106.3）"},
    "i_windspirit_pot": {"name": "风灵药剂", "price": 60, "effect": "buff_spd_small",
                         "desc": "3 回合速度 + 20%"},
    "i_lethal_pot": {"name": "致命药剂", "price": 150, "effect": "buff_crit_big",
                     "desc": "3 回合暴击率 + 30%"},
    "i_sharpeye_pot": {"name": "锐目药剂", "price": 100, "effect": "buff_crit_small",
                       "desc": "3 回合暴击率 + 15%"},
    "i_death_pot": {"name": "死神药剂", "price": 250, "effect": "execute_pot", "effect_data": {"pct": 0.30, "hp_threshold": 0.30},
                    "desc": "3 回合对生命<30%敌人 + 30%伤害"},
    "i_arcane_pot": {"name": "奥术药剂", "price": 120, "effect": "buff_matk",
                     "desc": "3 回合魔攻 + 30%"},
    "i_mystic_pot": {"name": "秘法药剂", "price": 180, "effect": "buff_matk_strong",
                     "desc": "3 回合魔攻 + 80%"},
    "i_starfire_pot": {"name": "星火药剂", "price": 220, "effect": "buff_matk_strong",
                       "desc": "3 回合魔攻 + 80%"},
    ...
    "i_mana_potion": {"name": "魔法药水", "price": 10, "mana": 0.2,
                      "desc": "回复 20% MP"},
    "i_great_treatment": {"name": "高效治疗药水", "price": 30, "heal": 0.4,
                          "desc": "回复 40% HP"},
    ...
    "i_night_mushroom_soup": {"name": "夜雾菇浓汤", "food": True, "price": 300, "food_effect": "regen", "heal": 0.3, "stamina": 25,
                              "desc": "回复 30% HP + 25 体力（月光珍馐）；战斗中吃下获得【回春】：每回合回复 1% 生命（本场）"},
    "i_moon_tea": {"name": "月光草茶", "food": True, "price": 200, "food_effect": "meditate", "mana": 0.25, "stamina": 15,
                   "desc": "回复 25% MP + 15 体力（月下清茗）；战斗中喝下获得【冥想】：每回合回复 1% 魔力（本场）"},
    "i_aurora_honey": {"name": "极光花蜜", "food": True, "price": 380, "food_effect": "aurora_guard", "heal": 0.2, "stamina": 20,
                       "desc": "回复 20% HP + 20 体力（极光珍酿）；战斗中吃下获得【极光庇护】：受击伤害－15%（本场战斗）"},
    "i_dragon_blood_hotpot": {"name": "龙血火锅", "food": True, "price": 550, "food_effect": "charge", "heal": 0.4, "stamina": 40,
                              "desc": "回复 40% HP + 40 体力（猛火珍馐）；战斗中吃下获得【蓄力】：10% 追加 50% 伤害"},
    "i_thunder_skewer": {"name": "雷雨藤烤串", "food": True, "price": 600, "food_effect": "static", "heal": 0.15, "stamina": 20,
                         "desc": "回复 15% HP + 20 体力（酥麻串烧）；战斗中吃下获得【静电麻痹】：攻击 20% 令敌减速"},
    # ---- v102.3 生活技能差异化：稀有药水产物（炼金） ----
    "i_moon_dew_essence": {"name": "月露精华", "price": 450, "effect": "next_atk_up", "effect_data": {"pct": 0.5},
                           "desc": "战斗中使用，下一次攻击伤害 + 50%（月华凝露）"},
    "i_abyss_crystal_potion": {"name": "深渊药剂", "price": 440, "effect": "magic_resist", "effect_data": {"pct": 0.15},
...
# ================= v136 装备进化稀有素材（Boss 掉落，装备进化/怪异炼成消耗） =================
MATERIALS.update({
    # ---- 血誓之源：血誓战团 Boss 怨念物（血誓战剑进化原料）----
    "mat_xue_shi_zhi_yuan": {"price": 300, "name": "血誓之源", "type": "精华", "quality": "purple",
        "desc": "血誓战团长·血誓的心脏结晶，跳动着不灭的战誓(Boss 稀有素材，装备进化/怪异炼成消耗)"},
    # ---- 余烬核心：灰烬军团 Boss 怨念物（血誓战剑→余烬军团战剑 进化原料 / 怪异炼成通用消耗）----
    "mat_yu_jin_he_xin": {"price": 400, "name": "余烬核心", "type": "精华", "quality": "orange",
        "desc": "灰烬军团长的核心，灼热不灭，蕴含整支军团的战意(Boss 稀有素材，装备进化/怪异炼成消耗)"},
    # ---- 夜祷之心：夜祷祭司 Boss 怨念物（日冕权杖→夜祷权杖 进化原料）----
...
ITEMS.update({
    ...
    "i_hei_yu_jian": {"name": "黑羽箭", "price": 30, "effect": "next_atk_up", "effect_data": {"pct": 0.5}, "type": "消耗品",
                      "desc": "铁弓亲手削的黑羽箭，首回合额外伤害——下一次攻击伤害+50%(一次性战斗道具)"},
    ...
    "i_chang_ye_nuan_jiu": {"name": "长夜暖酒", "food": True, "price": 60, "heal": 0.4, "mana": 0.4,
                            ...
                            "desc": "霜角堡长夜节的热酒——战斗外回复 40% 生命/魔力；战斗中攻击+10%(3 回合，设计稿 +5% 取最近档)"},
    ...
    "i_yin_ling_li_er": {"name": "银铃鲤饵", "price": 26, "type": "消耗品",
    ...
    "i_xiang_cao_kao_shou_rou": {"name": "香草烤兽肉", "food": True, "price": 30, "heal": 0.3, "stamina": 25,
                                 "effect": "buff_atk_food", "type": "消耗品",
                                 "desc": "香草裹着兽肉烤得滋滋冒油——战斗外回复 30% 生命；战斗中攻击+10%(3 回合，设计稿 +6% 持续 2 场取最近档)"},
