...
CONSUMABLES = {
    ...
    "i_ale": {"name": "麦酒", "price": 10, "hot": 0.05, "hot_turns": 3, "hot_mana": 0.06, "heal": 0.15, "mana": 0.15, "stamina": 15,
    ...
    "i_elf_fruit": {"name": "精灵果", "price": 30, "hot": 0.08, "hot_turns": 3, "hot_mana": 0.12, "heal": 0.3, "mana": 0.3, "stamina": 30,
    ...
    "i_deer_burger": {"name": "鹿肉汉堡", "price": 25, "hot": 0.08, "hot_turns": 3, "heal": 0.3, "stamina": 35,
                      "desc": "回复 30% HP＋35 体力（白鹿城名吃）；战斗中每回合回复 8% 生命（3 回合）"},
    "i_honey_tea": {"name": "蜂蜜茶", "price": 15, "hot_turns": 3, "hot_mana": 0.08, "mana": 0.2, "stamina": 20,
                    "desc": "回复 20% MP＋20 体力（白鹿城茶点）；战斗中每回合回复 8% 魔力（3 回合）"},
    "i_deer_cheese": {"name": "鹿奶干酪", "price": 18, "hot": 0.06, "hot_turns": 3, "stamina": 25,
                      "desc": "回复 25 体力（白鹿城牧场）；战斗中每回合回复 6% 生命（3 回合）"},
    "i_seafood_chowder": {"name": "海鲜浓汤", "price": 35, "hot": 0.08, "hot_turns": 4, "heal": 0.35, "stamina": 40,
                          "desc": "回复 35% HP＋40 体力（铁港城码头）；战斗中每回合回复 8% 生命（4 回合）"},
    ...
    "i_moon_cake": {"name": "月光饼", "price": 30, "hot": 0.08, "hot_turns": 3, "hot_mana": 0.1, "heal": 0.25, "mana": 0.25, "stamina": 30,
                    "desc": "回复 25% HP＋25% MP＋30 体力（月门城点心）；战斗中每回合回复 8% 生命、10% 魔力（3 回合）"},
    ...
    "i_sacred_bread": {"name": "圣餐面包", "price": 26, "hot": 0.08, "hot_turns": 3, "heal": 0.3, "stamina": 30,
                       "desc": "回复 30% HP＋30 体力（圣堂赐福）；战斗中每回合回复 8% 生命（3 回合）"},
    ...
    "i_pirate_stew": {"name": "海盗炖鱼", "price": 32, "hot": 0.08, "hot_turns": 3, "heal": 0.3, "stamina": 35,
                      "desc": "回复 30% HP＋35 体力（无名港私房）；战斗中每回合回复 8% 生命（3 回合）"},
    "i_octopus_ball": {"name": "章鱼烧", "price": 24, "hot": 0.06, "hot_turns": 3, "stamina": 30,
                       "desc": "回复 30 体力（无名港小吃）；战斗中每回合回复 6% 生命（3 回合）"},
    "i_fog_coffee": {"name": "雾港咖啡", "price": 18, "hot_turns": 3, "hot_mana": 0.08, "mana": 0.2, "stamina": 20,
                     "desc": "回复 20% MP＋20 体力（无名港提神）；战斗中每回合回复 8% 魔力（3 回合）"},
    "i_ash_pancake": {"name": "灰烬烤饼", "price": 24, "hot": 0.06, "hot_turns": 3, "heal": 0.25, "stamina": 30,
                      "desc": "回复 25% HP＋30 体力（灰烬城炭火烤）；战斗中每回合回复 6% 生命（3 回合）"},
    ...
    "i_ember_pepper": {"name": "烬火辣椒", "price": 10, "hot": 0.05, "hot_turns": 3, "heal": 0.1, "stamina": 15,
                       "desc": "回复 10% HP＋15 体力（灰烬城辣味）；战斗中每回合回复 5% 生命（3 回合）"},
    "i_royal_roast": {"name": "皇家烤肉", "price": 55, "hot": 0.1, "hot_turns": 4, "heal": 0.4, "stamina": 45,
                      "desc": "回复 40% HP＋45 体力（王都御膳）；战斗中每回合回复 10% 生命（4 回合）"},
    ...
    "i_royal_soup": {"name": "御膳汤", "price": 50, "hot": 0.1, "hot_turns": 4, "hot_mana": 0.08, "heal": 0.3, "mana": 0.2, "stamina": 40,
                     "desc": "回复 30% HP＋20% MP＋40 体力（王都名厨）；战斗中每回合回复 10% 生命、8% 魔力（4 回合）"},
    "i_elf_jam": {"name": "精灵果酱", "price": 35, "hot": 0.08, "hot_turns": 4, "heal": 0.3, "stamina": 25,
                  "desc": "回复 30% HP＋25 体力（精灵森林）；战斗中每回合回复 8% 生命（4 回合）"},
    "i_nectar_wine": {"name": "花蜜酒", "price": 30, "hot_turns": 3, "hot_mana": 0.12, "mana": 0.3, "stamina": 20,
                      "desc": "回复 30% MP＋20 体力（精灵花房）；战斗中每回合回复 12% 魔力（3 回合）"},
    "i_tree_honey": {"name": "树蜜糖", "price": 20, "hot": 0.06, "hot_turns": 3, "heal": 0.2, "stamina": 15,
                     "desc": "回复 20% HP＋15 体力（世界树蜜）；战斗中每回合回复 6% 生命（3 回合）"},
    ...
    "i_snowwolf_steak": {"name": "雪狼肉排", "price": 38, "hot": 0.08, "hot_turns": 4, "heal": 0.35, "stamina": 40,
                         "desc": "回复 35% HP＋40 体力（霜原猎手）；战斗中每回合回复 8% 生命（4 回合）"},
    "i_frost_berry": {"name": "冰霜浆果", "price": 20, "hot_turns": 3, "hot_mana": 0.08, "mana": 0.2, "stamina": 25,
                      "desc": "回复 20% MP＋25 体力（霜原冰果）；战斗中每回合回复 8% 魔力（3 回合）"},
    "i_reindeer_jerky": {"name": "驯鹿干", "price": 26, "hot": 0.08, "hot_turns": 3, "heal": 0.25, "stamina": 30,
                         "desc": "回复 25% HP＋30 体力（霜原风干）；战斗中每回合回复 8% 生命（3 回合）"},
    "i_dragon_pepper": {"name": "龙息辣椒", "price": 16, "hot": 0.06, "hot_turns": 3, "heal": 0.15, "stamina": 20,
                        "desc": "回复 15% HP＋20 体力（龙脊山民）；战斗中每回合回复 6% 生命（3 回合）"},
    "i_dragon_egg_pancake": {"name": "龙蛋煎饼", "price": 60, "hot": 0.1, "hot_turns": 4, "hot_mana": 0.08, "heal": 0.4, "mana": 0.2, "stamina": 45,
                             "desc": "回复 40% HP＋20% MP＋45 体力（龙脊盛宴）；战斗中每回合回复 10% 生命、8% 魔力（4 回合）"},
    "i_wolf_jerky": {"name": "狼肉干", "price": 14, "hot": 0.05, "hot_turns": 3, "heal": 0.25, "stamina": 30,
                     "desc": "回复 25% HP＋30 体力（野外干粮）；战斗中每回合回复 5% 生命（3 回合）"},
    "i_eagle_egg": {"name": "鹰蛋", "price": 12, "hot": 0.05, "hot_turns": 3, "heal": 0.2, "stamina": 20,
                    "desc": "回复 20% HP＋20 体力（悬崖鹰巢）；战斗中每回合回复 5% 生命（3 回合）"},
    "i_snake_soup": {"name": "蛇羹", "price": 18, "hot": 0.06, "hot_turns": 3, "hot_mana": 0.04, "heal": 0.2, "mana": 0.1, "stamina": 25,
                     "desc": "回复 20% HP＋10% MP＋25 体力（沼泽风味）；战斗中每回合回复 6% 生命、4% 魔力（3 回合）"},
    "i_mushroom_soup": {"name": "蘑菇汤", "price": 12, "hot": 0.05, "hot_turns": 3, "heal": 0.15, "stamina": 20,
                        "desc": "回复 15% HP＋20 体力（森林采菇）；战斗中每回合回复 5% 生命（3 回合）"},
    ...
    "i_war_god_pot": {"name": "战神药剂", "price": 150, "effect": "buff_atk",
                      "desc": "本回合攻击＋35%"},
    "i_brute_pot": {"name": "蛮力药剂", "price": 80, "effect": "buff_atk",
                    "desc": "本回合攻击＋25%"},
    "i_armor_break_pot": {"name": "破甲药剂", "price": 120, "effect": "buff_atk",
                          "desc": "本回合攻击＋30%"},
    "i_dragon_power_pot": {"name": "龙力药剂", "price": 280, "effect": "buff_atk",
                           "desc": "本回合攻击＋45%"},
    "i_rock_shield_pot": {"name": "岩盾药剂", "price": 90, "effect": "buff_def",
                          "desc": "本回合防御＋30%"},
    "i_thorn_pot": {"name": "荆棘药剂", "price": 110, "effect": "buff_def",
                    "desc": "本回合防御＋35%"},
    "i_holy_shield_pot": {"name": "圣盾药剂", "price": 180, "effect": "buff_def",
                          "desc": "本回合防御＋40%"},
    "i_immovable_pot": {"name": "不动药剂", "price": 70, "effect": "buff_def",
                        "desc": "本回合防御＋25%"},
    "i_swift_pot": {"name": "迅捷药剂", "price": 90, "effect": "buff_spd",
                    "desc": "本回合速度＋30%"},
    "i_shadowstep_pot": {"name": "影步药剂", "price": 150, "effect": "buff_spd",
                         "desc": "本回合速度＋40%"},
    "i_windspirit_pot": {"name": "风灵药剂", "price": 60, "effect": "buff_spd",
                         "desc": "本回合速度＋25%"},
    "i_lethal_pot": {"name": "致命药剂", "price": 150, "effect": "buff_crit",
                     "desc": "本回合暴击率＋25%"},
    "i_sharpeye_pot": {"name": "锐目药剂", "price": 100, "effect": "buff_crit",
                       "desc": "本回合暴击率＋20%"},
    "i_death_pot": {"name": "死神药剂", "price": 250, "effect": "buff_crit",
                    "desc": "本回合暴击率＋30%"},
    "i_arcane_pot": {"name": "奥术药剂", "price": 120, "effect": "buff_matk",
                     "desc": "本回合魔攻＋30%"},
    "i_mystic_pot": {"name": "秘法药剂", "price": 180, "effect": "buff_matk",
                     "desc": "本回合魔攻＋35%"},
    "i_starfire_pot": {"name": "星辉药剂", "price": 220, "effect": "buff_matk",
                       "desc": "本回合魔攻＋40%"},
    "i_void_pot": {"name": "虚空药剂", "price": 300, "effect": "buff_matk",
                   "desc": "本回合魔攻＋50%"},
    "i_berserker_pot": {"name": "狂战士药剂", "price": 200, "effect": "buff_atk_def",
                        "desc": "本回合攻击＋35%、防御＋25%"},
    "i_warsaint_pot": {"name": "战圣药剂", "price": 350, "effect": "buff_atk_def",
                       "desc": "本回合攻击＋45%、防御＋30%"},
    # ---- D. 卷轴/护符/券扩展 ----
    ...
    # ---- F. 宠物蛋 + 坐骑缰绳（引用真实品种）----
    "i_egg_wolf": {"name": "森林狼崽蛋", "price": 300, "type": "宠物蛋", "pet_key": "pet_wolf",
                   "desc": "使用后孵化宠物：森林狼崽"},
    "i_egg_cat": {"name": "黑猫蛋", "price": 300, "type": "宠物蛋", "pet_key": "pet_cat",
                  "desc": "使用后孵化宠物：黑猫"},
    "i_egg_drake": {"name": "龙裔蛋", "price": 500, "type": "宠物蛋", "pet_key": "pet_drake",
                    "desc": "使用后孵化宠物：龙裔幼崽"},
    "i_egg_rabbit": {"name": "月光兔蛋", "price": 400, "type": "宠物蛋", "pet_key": "pet_rabbit",
                     "desc": "使用后孵化宠物：月光兔"},
    "i_rein_horse": {"name": "老马缰绳", "price": 500, "type": "坐骑", "mount_key": "mount_horse",
                     "desc": "使用后解锁坐骑：老马"},
    "i_rein_steed": {"name": "骏马缰绳", "price": 1500, "type": "坐骑", "mount_key": "mount_steed",
                     "desc": "使用后解锁坐骑：骏马"},
    "i_rein_wolf": {"name": "雪狼缰绳", "price": 3000, "type": "坐骑", "mount_key": "mount_wolf",
                    "desc": "使用后解锁坐骑：雪狼"},
    # ---- G. 收藏品（纪念/图鉴向，不能使用）----
