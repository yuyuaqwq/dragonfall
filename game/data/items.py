...
MATERIALS = {
    ...
    "mat_feng_mi": {"price": 30, "name": "蜂蜜", "type": "材料", "desc": "野蜂巢采得的金黄蜜浆，甜得能挂住勺子"},
    "mat_feng_gan_rou": {"price": 25, "name": "风干肉", "type": "材料", "desc": "猎户屋檐下风干的兽肉条，咸香耐存，路上最好的干粮"},
    ...
    "mat_yuan_huo_jing_gang": {"price": 300, "name": "渊火精钢", "type": "传说",
                               "desc": "深渊裂隙熔火中淬出的精钢，犬牙般的暗纹在高温下浮现——传说级锻造/附魔材料(S20 完成奖励，替代原传说锻造材料占位)"},
    ...
    "mat_fu_ya_xue_nang": {"price": 60, "name": "腐牙血囊", "type": "任务道具",
                           "desc": "嚎骨体内取出的血囊，可交铁弓换黑羽箭，或留作深渊系炼金配方材料(S18 掉落)"},
    # ---- 05 海洋之歌 ----
    ...
    "mat_shou_ye_zhe_hui_zhang": {"price": 150, "name": "守夜者徽章", "type": "收藏",
                                  "desc": "金羽纹样的火焰徽章，铁面赠予——三百年，父神之火把它烙在一个人身上；现在，它记得黎明(S50 纪念品·不可出售)"},
    # ---- 14 学徒之路 ----
    ...
    # ---- 17 北境东境散支线 ----
    "mat_song_mu_hu_fu": {"price": 60, "name": "松木护符", "type": "收藏",
                          "desc": "守林人苔衣亡妻留下的松木护符，串着旧绳结——「你走南闯北，比老头子更需要它。」(S60 奖励)"},
    ...
    "mat_tu_zhi_ye_xing_pi_feng": {"price": 100, "name": "图纸·夜行披风", "type": "图纸",
                                   "blueprint_for": "夜行披风",
    ...
    "mat_chuan_shuo_tu_zhi_rong_lu_zhi_xin": {"price": 300, "name": "传说锻造图纸·熔炉之心", "type": "图纸",
                                              "blueprint_for": "熔炉之心",
    ...
    "mat_yue_guang_lu": {"price": 60, "name": "月光露", "type": "草药",
                         "desc": "白鹿之森夜晚草叶上凝出的露水，盛着月色——月系炼金辅材(S50 材料)"},
...
CONSUMABLES = {
    ...
    "i_meat_skewer": {"name": "烤肉串", "price": 15, "hot": 0.06, "hot_turns": 3, "heal": 0.5, "stamina": 30,
                      "desc": "回复 50% HP + 30 体力；战斗中每回合回复 6% 生命（3 回合）"},
    "i_ale": {"name": "醇香麦酒", "price": 10, "hot": 0.05, "hot_turns": 3, "hot_mana": 0.06, "heal": 0.15, "mana": 0.15, "stamina": 15,
              "desc": "回复 15% HP/MP + 15 体力；战斗中每回合回复 5% 生命、6% 魔力（3 回合）"},
    "i_stew": {"name": "炖菜", "price": 20, "hot": 0.06, "hot_turns": 3, "hot_mana": 0.08, "heal": 0.4, "mana": 0.2, "stamina": 40,
               "desc": "回复 40% HP + 20% MP + 40 体力；战斗中每回合回复 6% 生命、8% 魔力（3 回合）"},
    "i_elf_fruit": {"name": "精灵圣果", "price": 30, "hot": 0.08, "hot_turns": 3, "hot_mana": 0.12, "heal": 0.3, "mana": 0.3, "stamina": 30,
                    "desc": "回复 30% HP + 30% MP + 30 体力；战斗中每回合回复 8% 生命、12% 魔力（3 回合）"},
    "i_dwarf_liquor": {"name": "矮人烈酒", "price": 40, "effect": "buff_atk_food", "stamina": 15,
    ...
    "i_spd_potion": {"name": "疾风药剂", "price": 100, "effect": "buff_spd",
                     "desc": "3 回合速度 + 40%"},
    "i_fury_potion": {"name": "狂怒药剂", "price": 200, "effect": "next_atk_up",
                      "desc": "下一次攻击 + 50%"},
    "i_holy_potion": {"name": "圣光药剂", "price": 100, "effect": "heal_up",
                      "desc": "3 回合治疗技能效果 + 20%"},
    "i_dragon_scale_potion": {"name": "龙鳞药剂", "price": 200, "effect": "magic_resist",
                              "desc": "3 回合受到魔法伤害－15%"},
    ...
    "it_slime_jelly": {"name": "史莱姆果冻", "price": 20, "hot": 0.06, "hot_turns": 3, "heal": 0.2, "stamina": 20,
                      "desc": "回复 20% HP + 20 体力；战斗中每回合回复 6% 生命（3 回合）"},
    "it_cook_skewer": {"name": "烤肉串(自制)", "price": 30, "hot": 0.08, "hot_turns": 3, "heal": 0.35, "stamina": 30,
                      "desc": "回复 35% HP + 30 体力；战斗中每回合回复 8% 生命（3 回合）"},
    "it_gold_feast": {"name": "金鲤盛宴", "price": 60, "hot": 0.1, "hot_turns": 4, "hot_mana": 0.08, "heal": 0.5, "mana": 0.2, "stamina": 60,
    ...
    "i_oats_porridge": {"name": "燕麦粥", "price": 6, "hot": 0.03, "hot_turns": 3, "heal": 0.2, "stamina": 20,
                        "desc": "回复 20% HP + 20 体力（橡木镇农家）；战斗中每回合回复 3% 生命（3 回合）"},
    "i_honey_pancake": {"name": "蜂蜜烤饼", "price": 8, "hot": 0.03, "hot_turns": 3, "stamina": 25,
                        "desc": "回复 25 体力（橡木镇甜点）；战斗中每回合回复 3% 生命（3 回合）"},
    "i_apple_wine": {"name": "苹果酒", "price": 10, "hot_turns": 3, "hot_mana": 0.04, "mana": 0.1, "stamina": 15,
                     "desc": "回复 10% MP + 15 体力（橡木镇果园）；战斗中每回合回复 4% 魔力（3 回合）"},
    "i_deer_burger": {"name": "鹿肉汉堡", "price": 25, "effect": "buff_def_food", "heal": 0.3, "stamina": 35,
                      "desc": "回复 30% HP + 35 体力（白鹿城名吃）；战斗中防御+15%（3 回合）"},
    "i_honey_tea": {"name": "蜂蜜茶", "price": 15, "hot_turns": 3, "hot_mana": 0.08, "mana": 0.2, "stamina": 20,
                    "desc": "回复 20% MP + 20 体力（白鹿城茶点）；战斗中每回合回复 8% 魔力（3 回合）"},
    "i_deer_cheese": {"name": "鹿奶干酪", "price": 18, "food_effect": "thorns", "stamina": 25,
                      "desc": "回复 25 体力（白鹿城牧场）；战斗中吃下获得【反伤】：受击 10% 反弹 30% 伤害"},
    "i_seafood_chowder": {"name": "海鲜浓汤", "price": 35, "food_effect": "precise", "heal": 0.35, "stamina": 40,
                          "desc": "回复 35% HP + 40 体力（铁港城码头）；战斗中吃下获得【精准】：本场伤害 + 10%"},
    "i_salt_baked_fish": {"name": "盐焗烤鱼", "price": 28, "hot": 0.08, "hot_turns": 3, "hot_mana": 0.04, "heal": 0.2, "mana": 0.1, "stamina": 30,
                          "desc": "回复 20% HP + 10% MP + 30 体力（铁港城渔获）；战斗中每回合回复 8% 生命、4% 魔力（3 回合）"},
    "i_dock_rum": {"name": "码头朗姆", "price": 22, "hot_turns": 3, "hot_mana": 0.08, "mana": 0.2, "stamina": 20,
                   "desc": "回复 20% MP + 20 体力（铁港城水手）；战斗中每回合回复 8% 魔力（3 回合）"},
    "i_moon_cake": {"name": "月光饼", "price": 30, "food_effect": "meditate", "heal": 0.25, "mana": 0.25, "stamina": 30,
                    "desc": "回复 25% HP + 25% MP + 30 体力（月门城点心）；战斗中吃下获得【冥想】：每回合回复 1% 魔力"},
    "i_laurel_tea": {"name": "月桂茶", "price": 20, "hot_turns": 3, "hot_mana": 0.12, "mana": 0.3, "stamina": 25,
                     "desc": "回复 30% MP + 25 体力（月门城茶会）；战斗中每回合回复 12% 魔力（3 回合）"},
    "i_silver_jelly": {"name": "银月果冻", "price": 16, "hot": 0.06, "hot_turns": 3, "stamina": 20,
    ...
    "i_pirate_stew": {"name": "海盗炖鱼", "price": 32, "food_effect": "execute", "heal": 0.3, "stamina": 35,
                      "desc": "回复 30% HP + 35 体力（无名港私房）；战斗中吃下获得【处决】：对生命<30%的敌人 + 30%伤害"},
    "i_octopus_ball": {"name": "章鱼烧", "price": 24, "hot": 0.06, "hot_turns": 3, "stamina": 30,
                       "desc": "回复 30 体力（无名港小吃）；战斗中每回合回复 6% 生命（3 回合）"},
    "i_fog_coffee": {"name": "雾港咖啡", "price": 18, "effect": "buff_spd_food", "mana": 0.2, "stamina": 20,
                     "desc": "回复 20% MP + 20 体力（无名港提神）；战斗中速度+12%（3 回合）"},
    "i_ash_pancake": {"name": "灰烬烤饼", "price": 24, "food_effect": "element_fire", "heal": 0.25, "stamina": 30,
                      "desc": "回复 25% HP + 30 体力（灰烬城炭火烤）；战斗中吃下获得【元素·火】：攻击附加 5% 火属性伤害"},
    "i_lava_egg": {"name": "熔岩蛋", "price": 30, "hot": 0.08, "hot_turns": 3, "hot_mana": 0.08, "heal": 0.2, "mana": 0.2, "stamina": 35,
                   "desc": "回复 20% HP + 20% MP + 35 体力（灰烬城特产）；战斗中每回合回复 8% 生命、8% 魔力（3 回合）"},
    "i_ember_pepper": {"name": "烬火辣椒", "price": 10, "food_effect": "bleed", "heal": 0.1, "stamina": 15,
                       "desc": "回复 10% HP + 15 体力（灰烬城辣味）；战斗中吃下获得【流血】：攻击 20% 使敌人流血（每回合 5% 生命，3 回合）"},
    "i_royal_roast": {"name": "皇家烤肉", "price": 55, "food_effect": "charge", "heal": 0.4, "stamina": 45,
                      "desc": "回复 40% HP + 45 体力（王都御膳）；战斗中吃下获得【蓄力】：攻击 10% 造成 150% 伤害"},
    "i_gold_dessert": {"name": "金箔甜点", "price": 45, "hot_turns": 4, "hot_mana": 0.12, "mana": 0.3, "stamina": 30,
    ...
    "i_dwarf_oven_bread": {"name": "铁炉面包", "price": 22, "hot": 0.06, "hot_turns": 3, "heal": 0.25, "stamina": 30,
                           "desc": "回复 25% HP + 30 体力（矮人铁炉）；战斗中每回合回复 6% 生命（3 回合）"},
    "i_miner_stew": {"name": "矿工炖肉", "price": 28, "hot": 0.08, "hot_turns": 3, "heal": 0.3, "stamina": 35,
    ...
    "i_reindeer_jerky": {"name": "驯鹿干", "price": 26, "hot": 0.08, "hot_turns": 3, "heal": 0.25, "stamina": 30,
    ...
    "i_eagle_egg": {"name": "鹰蛋", "price": 12, "food_effect": "combo", "heal": 0.2, "stamina": 20,
                    "desc": "回复 20% HP + 20 体力（悬崖鹰巢）；战斗中吃下获得【连击】：攻击 15% 追加 50% 伤害"},
    "i_snake_soup": {"name": "蛇羹", "price": 18, "food_effect": "lifesteal", "heal": 0.2, "mana": 0.1, "stamina": 25,
                     "desc": "回复 20% HP + 10% MP + 25 体力（沼泽风味）；战斗中吃下获得【吸血】：攻击回复 8% 伤害为生命"},
    "i_mushroom_soup": {"name": "蘑菇汤", "price": 12, "food_effect": "armor_break", "heal": 0.15, "stamina": 20,
                        "desc": "回复 15% HP + 20 体力（森林采菇）；战斗中吃下获得【破甲】：攻击 25% 降敌防 15%（2 回合）"},
    "i_wild_honey": {"name": "野蜂蜜", "price": 10, "hot_turns": 3, "hot_mana": 0.06, "mana": 0.15, "stamina": 15,
                     "desc": "回复 15% MP + 15 体力（树洞蜂巢）；战斗中每回合回复 6% 魔力（3 回合）"},
    "i_roast_bird": {"name": "烤鸟肉", "price": 14, "hot": 0.05, "hot_turns": 3, "heal": 0.2, "stamina": 25,
                     "desc": "回复 20% HP + 25 体力（篝火烤鸟）；战斗中每回合回复 5% 生命（3 回合）"},
    "i_fish_soup": {"name": "鱼汤", "price": 16, "hot": 0.06, "hot_turns": 3, "heal": 0.2, "stamina": 25,
                    "desc": "回复 20% HP + 25 体力（河边鲜鱼）；战斗中每回合回复 6% 生命（3 回合）"},
    "i_herb_tea": {"name": "草药茶", "price": 8, "hot": 0.03, "hot_turns": 3, "hot_mana": 0.04, "heal": 0.1, "mana": 0.1, "stamina": 15,
    ...
    "i_brute_pot": {"name": "蛮力药剂", "price": 80, "effect": "buff_atk_small",
                    "desc": "3 回合攻击 + 20%"},
    "i_armor_break_pot": {"name": "破甲药剂", "price": 120, "effect": "armor_break_pot",
                          "desc": "敌人防御－15%（2 回合）"},
    "i_dragon_power_pot": {"name": "龙力药剂", "price": 280, "effect": "buff_atk_big",
                           "desc": "3 回合攻击 + 40%"},
    "i_rock_shield_pot": {"name": "岩盾药剂", "price": 90, "effect": "rock_shield",
                          "desc": "获得 10% 生命护盾（3 回合）"},
    "i_thorn_pot": {"name": "荆棘药剂", "price": 110, "effect": "thorns_pot",
                    "desc": "3 回合受击反弹 30% 伤害"},
    "i_holy_shield_pot": {"name": "圣盾药剂", "price": 180, "effect": "holy_shield",
                          "desc": "获得 15% 生命护盾（3 回合）"},
    "i_immovable_pot": {"name": "不动药剂", "price": 70, "effect": "cc_immune",
                        "desc": "3 回合免疫眩晕/冻结/减速"},
    "i_swift_pot": {"name": "迅捷药剂", "price": 90, "effect": "buff_spd",
                    "desc": "3 回合速度 + 40%"},
    "i_shadowstep_pot": {"name": "影步药剂", "price": 150, "effect": "dodge_pot",
                         "desc": "3 回合 15% 概率闪避攻击"},
    "i_pene_pot": {"name": "穿甲药剂", "price": 160, "effect": "pene_pot",
                   "desc": "3 回合物穿 + 15%（v106.2）"},
    "i_pene_magi_pot": {"name": "破法药剂", "price": 160, "effect": "pene_magi_pot",
                        "desc": "3 回合法穿 + 15%（v106.2）"},
    "i_lifesteal_pot": {"name": "嗜血药剂", "price": 170, "effect": "lifesteal_pot",
                        "desc": "3 回合吸血 + 15%（v106.3）"},
    "i_crit_dmg_pot": {"name": "狂暴药剂", "price": 160, "effect": "crit_dmg_pot",
                       "desc": "3 回合暴击伤害 + 25%（v106.3）"},
    "i_block_pot": {"name": "岩壁药剂", "price": 150, "effect": "block_pot",
    ...
    "i_sharpeye_pot": {"name": "锐目药剂", "price": 100, "effect": "buff_crit_small",
                       "desc": "3 回合暴击率 + 15%"},
    "i_death_pot": {"name": "死神药剂", "price": 250, "effect": "execute_pot",
...
# ================= v124 支线扩容：11 件缺失物品补登记（2026-08-16，S51/S95/S108/S111-S114/S116/S119/H7/H8） =================
# 名称与 quests.py 注释严格一致（reward_item/collect/use 按名 resolve("materials") 引用，必须挂在 MATERIALS）
MATERIALS.update({
    # ---- S95 垂钓传说链尾：传说钓竿·银铃之竿（橙·传说·钓竿，装备待登记）----
    "mat_chuan_shuo_diao_gan_yin_ling_zhi_gan": {"price": 100, "name": "传说钓竿·银铃之竿", "type": "收藏",
        "desc": "浮标所赠、银铃河畔三百年老柳木所制的传说钓竿——橙·传说品质钓竿，装备属性待装备表落地登记(S95 链尾奖励·装备类占位)"},
    # ---- S51 北境生存：长夜徽记（饰品·装备类，先登记为收藏占位）----
    "mat_chang_ye_hui_ji": {"price": 100, "name": "长夜徽记", "type": "收藏",
        "desc": "霜角堡长夜节颁发的信物徽记——饰品，佩戴属性待装备表落地登记(S51 奖励·装备类占位)"},
...
ITEMS.update({
    ...
    "i_hei_yu_jian": {"name": "黑羽箭", "price": 30, "effect": "next_atk_up", "type": "消耗品",
                      "desc": "铁弓亲手削的黑羽箭，首回合额外伤害——下一次攻击伤害+50%(一次性战斗道具)"},
    "i_chang_ye_nuan_jiu": {"name": "长夜暖酒", "price": 60, "heal": 0.4, "mana": 0.4,
    ...
    "i_chun_feng_ling_hua_mi": {"name": "春风铃花蜜", "price": 25, "heal": 0.2, "mana": 0.1, "type": "消耗品",
    ...
    "i_chong_wu_kou_liang": {"name": "宠物口粮", "price": 30, "type": "消耗品",
    ...
    "i_yi_dai_shang_lu_kou_liang": {"name": "一袋商路口粮", "price": 30, "heal": 0.4, "type": "消耗品",
    ...
    "i_shang_hui_gu_fen_ping_zheng": {"name": "商会股份凭证", "price": 100, "type": "收藏品",
                                      "desc": "印有玩家姓名的烫金股份凭证——每周领取商路分红 50 金币(生活线长期收益，分红功能待实现)"},
    "i_yin_feng_shang_ling": {"name": "银风商铃", "price": 100, "type": "收藏品",
                              "desc": "银风商道的铃铛，叮当声是商路的信物——商路类委托报酬+5%(纪念品·饰品，效果待实现)"},
    # ---- 12 侦探与怪盗：猫眼石胸针 / 嘉奖令 / 博物馆荣誉徽章 ----
    "i_mao_yan_shi_xiong_zhen": {"name": "猫眼石胸针", "price": 120, "type": "收藏品",
                                 "desc": "猫眼石嵌银，造型为蜷睡的猫——影子猫之母的遗物(饰品·速度+2 待装备表落地，S49 义气线)"},
    ...
    # ---- 06 龙裔传承：古龙语·守望之息（技能书）/ 云鳞护符（链尾纪念品）----
    # 守望之息技能未在 skills.py 注册（Lv.96 龙语系最终技），故不挂 learn_skill，待技能落地后补
    "i_gu_long_yu_shou_wang_zhi_xi": {"name": "古龙语·守望之息", "price": 500, "type": "消耗品",
                                      "desc": "龙语系最终技能书——以龙语唤风，短暂强化全队(Lv.96 可用，技能待注册)"},
    "i_yun_lin_hu_fu": {"name": "云鳞护符", "price": 100, "type": "收藏品",
                        "desc": "以暮影之鳞与云海之晶打造的护符——守望者的信物(链尾完成纪念品)"},
    # ---- 14 学徒之路：小灰攒钱买的麦酒（Lv.30 彩蛋·消耗品）----
    "i_xiao_hui_mai_jiu": {"name": "小灰攒钱买的麦酒", "price": 20, "heal": 0.3, "mana": 0.3, "type": "消耗品",
    ...
    "i_yin_ling_li_er": {"name": "银铃鲤饵", "price": 30, "type": "消耗品",
                         "desc": "银铃鲤银鳞磨制的鱼饵——下一次垂钓传说档位概率×3，垂钓结算后消失(鱼饵系统接入待实现)"},
    # ---- v124 支线配方产物（S47 香草烤兽肉 / S49 金锅野猪肋排 / H6 白石圣灰药剂）----
    "i_xiang_cao_kao_shou_rou": {"name": "香草烤兽肉", "price": 30, "heal": 0.3, "stamina": 25,
                                 "effect": "buff_atk_food", "type": "消耗品",
                                 "desc": "香草裹着兽肉烤得滋滋冒油——战斗外回复 30% 生命；战斗中攻击+10%(3 回合，设计稿 +6% 持续 2 场取最近档)"},
    "i_jin_guo_ye_zhu_pai_pai": {"name": "金锅野猪肋排", "price": 36, "heal": 0.35, "stamina": 35,
                                 "effect": "buff_atk_food", "type": "消耗品",
