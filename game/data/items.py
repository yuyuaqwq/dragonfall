...
CONSUMABLES = {
    ...
    "i_bread": {"cast": 0.8, "name": "黑面包", "food": True, "price": 10, "hot": 0.03, "hot_turns": 3, "heal": 0.3, "stamina": 20,
                "desc": "回复 30% HP + 20 体力；战斗中每刻回复 3% 生命（3 刻）"},
    "i_meat_skewer": {"cast": 0.8, "name": "烤肉串", "food": True, "price": 15, "hot": 0.06, "hot_turns": 3, "heal": 0.5, "stamina": 30,
    ...
    "i_stew": {"cast": 0.8, "name": "炖菜", "food": True, "price": 20, "hot": 0.06, "hot_turns": 3, "hot_mana": 0.08, "heal": 0.4, "mana": 0.2, "stamina": 40,
    ...
    "i_str_potion": {"cast": 1.4, "name": "力量药剂", "price": 100, "effect": "buff_atk",
                     "desc": "3 刻攻击 + 30%"},
    "i_def_potion": {"cast": 1.4, "name": "铁壁药剂", "price": 350, "effect": "buff_def",
                     "desc": "抵挡 3 次受击防御 + 45%"},
    "i_spd_potion": {"cast": 1.4, "name": "疾风药剂", "price": 100, "effect": "buff_spd",
                     "desc": "3 刻速度 + 40%"},
    "i_fury_potion": {"cast": 2.0, "name": "狂怒药剂", "price": 200, "effect": "next_atk_up", "effect_data": {"pct": 0.5},
                      "desc": "下一次攻击 + 50%"},
    "i_holy_potion": {"cast": 1.4, "name": "圣光药剂", "price": 100, "effect": "heal_up", "effect_data": {"pct": 0.2},
                      "desc": "3 刻治疗技能效果 + 20%"},
    "i_dragon_scale_potion": {"cast": 2.0, "name": "龙鳞药剂", "price": 200, "effect": "magic_resist", "effect_data": {"pct": 0.15},
                              "desc": "3 刻受到魔法伤害－15%"},
    "i_battlecry_potion": {"cast": 2.0, "name": "战吼药剂", "price": 300, "effect": "buff_atk_big",
                           "desc": "3 刻攻击 + 40%"},
    ...
    "i_salt_baked_fish": {"cast": 0.8, "name": "盐焗烤鱼", "food": True, "price": 28, "hot": 0.08, "hot_turns": 3, "hot_mana": 0.04, "heal": 0.2, "mana": 0.1, "stamina": 30,
    ...
    "i_lava_egg": {"cast": 0.8, "name": "熔岩蛋", "food": True, "price": 30, "hot": 0.08, "hot_turns": 3, "hot_mana": 0.08, "heal": 0.2, "mana": 0.2, "stamina": 35,
    ...
    "i_wolf_jerky": {"cast": 0.8, "name": "狼肉干", "food": True, "price": 14, "food_effect": "counter", "heal": 0.25, "stamina": 30,
    ...
    "i_war_god_pot": {"cast": 2.0, "name": "战神药剂", "price": 150, "effect": "buff_atk",
                      "desc": "3 刻攻击 + 30%"},
    "i_brute_pot": {"cast": 2.0, "name": "蛮力药剂", "price": 80, "effect": "buff_atk_small",
                    "desc": "3 刻攻击 + 20%"},
    "i_armor_break_pot": {"cast": 1.4, "name": "破甲药剂", "price": 120, "effect": "armor_break_pot", "effect_data": {"pct": 0.15, "turns": 2},
                          "desc": "敌人防御－15%（2 刻）"},
    "i_dragon_power_pot": {"cast": 1.4, "name": "龙力药剂", "price": 280, "effect": "buff_atk_big",
                           "desc": "3 刻攻击 + 40%"},
    "i_rock_shield_pot": {"cast": 1.8, "name": "岩盾药剂", "price": 90, "effect": "rock_shield", "effect_data": {"pct": 0.10},
                          "desc": "获得 10% 生命护盾（3 刻）"},
    "i_thorn_pot": {"cast": 1.8, "name": "荆棘药剂", "price": 110, "effect": "thorns_pot", "effect_data": {"pct": 0.30},
                    "desc": "3 刻受击反弹 30% 伤害"},
    "i_holy_shield_pot": {"cast": 1.8, "name": "圣盾药剂", "price": 180, "effect": "holy_shield", "effect_data": {"pct": 0.15},
                          "desc": "获得 15% 生命护盾（3 刻）"},
    "i_immovable_pot": {"cast": 1.8, "name": "不动药剂", "price": 70, "effect": "cc_immune", "effect_data": {"turns": 3},
                        "desc": "3 刻免疫眩晕/冻结/减速"},
    "i_swift_pot": {"cast": 1.4, "name": "迅捷药剂", "price": 90, "effect": "buff_spd",
                    "desc": "3 刻速度 + 40%"},
    "i_shadowstep_pot": {"cast": 1.8, "name": "影步药剂", "price": 150, "effect": "dodge_pot", "effect_data": {"pct": 0.15},
                         "desc": "3 刻 15% 概率闪避攻击"},
    ...
    "i_crit_dmg_pot": {"cast": 1.8, "name": "狂暴药剂", "price": 160, "effect": "crit_dmg_pot", "effect_data": {"pct": 0.25},
                       "desc": "3 刻暴击伤害 + 25%（v106.3）"},
    "i_block_pot": {"cast": 1.0, "name": "岩壁药剂", "price": 150, "effect": "block_pot", "effect_data": {"pct": 0.15},
                    "desc": "3 刻格挡 + 15%（v106.3）"},
    "i_windspirit_pot": {"cast": 1.4, "name": "风灵药剂", "price": 60, "effect": "buff_spd_small",
                         "desc": "3 刻速度 + 20%"},
    "i_lethal_pot": {"cast": 1.4, "name": "致命药剂", "price": 150, "effect": "buff_crit_big",
                     "desc": "3 刻暴击率 + 30%"},
    "i_sharpeye_pot": {"cast": 1.4, "name": "锐目药剂", "price": 100, "effect": "buff_crit_small",
                       "desc": "3 刻暴击率 + 15%"},
    "i_death_pot": {"cast": 2.0, "name": "死神药剂", "price": 250, "effect": "execute_pot", "effect_data": {"pct": 0.30, "hp_threshold": 0.30},
                    "desc": "3 刻对生命<30%敌人 + 30%伤害"},
    "i_arcane_pot": {"cast": 1.4, "name": "奥术药剂", "price": 120, "effect": "buff_matk",
                     "desc": "3 刻魔攻 + 30%"},
    "i_mystic_pot": {"cast": 1.4, "name": "秘法药剂", "price": 180, "effect": "buff_matk_strong",
                     "desc": "3 刻魔攻 + 80%"},
    "i_starfire_pot": {"cast": 1.4, "name": "星火药剂", "price": 220, "effect": "buff_matk_strong",
                       "desc": "3 刻魔攻 + 80%"},
    "i_void_pot": {"cast": 2.0, "name": "虚空药剂", "price": 300, "effect": "buff_matk_crit",
                   "desc": "3 刻魔攻 + 80%、暴击率 + 15%"},
    "i_berserker_pot": {"cast": 2.0, "name": "狂战士药剂", "price": 200, "effect": "buff_atk_def",
                        "desc": "3 刻攻击 + 30%；抵挡 3 次受击防御 + 45%"},
    "i_warsaint_pot": {"cast": 2.0, "name": "战圣药剂", "price": 350, "effect": "buff_atk_big_def",
    ...
    "i_atk_potion": {"cast": 1.4, "name": "攻击药水", "price": 150, "effect": "buff_atk",
    ...
    "i_brutal_wine": {"cast": 2.5, "name": "蛮血烈酒", "price": 180, "type": "消耗品",
