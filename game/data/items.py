...
MATERIALS = {
    ...
    'mat_xiu_chao_xie_jia': {'price': 160, 'name': '锈潮蟹甲', 'type': '材料', 'desc': '锈潮船坞蟹王甲壳的碎片，铁锈与潮盐腌透了三百年，铁匠说淬火后比新钢还硬'},

    'mat_zhu_ying_zhu_lei': {'price': 200, 'name': '烛影烛泪', 'type': '材料', 'desc': '烛影墓窟主教蜡台凝结的泪滴，烛火不灭时采下，光系附魔的绝佳媒介'},

    'mat_lei_jing_kuang_he': {'price': 240, 'name': '雷晶矿核', 'type': '材料', 'desc': '雷鸣矿道雷晶矿脉的核心，指甲盖大小却沉甸甸，隐约有电弧在晶格间游走'},

    'mat_pan_wo_gui_jia': {'price': 420, 'name': '磐涡龟甲', 'type': '材料', 'desc': '旋涡竞技场石壳龟背甲残片，涡纹天然成阵，是盾匠梦寐以求的龟纹钢底料'},

    'mat_yong_tan_pu_can_ye': {'price': 480, 'name': '咏叹谱残页', 'type': '材料', 'desc': '黑潮歌剧院沉没乐谱的残页，音符在水汽里若隐若现，乐师说能听见海妖的咏叹'},
...
ITEMS.update({
    'i_jin_ling_xiang_lu': {'name': '烬灵香炉', 'price': 60, 'type': '消耗品', 'quality': 'green', 'battle_ok': True, 'effect': 'summon', 'effect_data': {'tid': 'ember_wisp', 'turns': 3, 'limit': 1, 'hp_ratio': 0.30, 'atk_ratio': 0.35, 'def_ratio': 0.30, 'bodyguard': 0.3}, 'desc': '青铜香炉袅袅生烟，召出「烬灵」并肩而战——自动攻击(35%攻击)并为你挡刀，持续 3 刻(每场限 1 只，战斗内使用)'},
    'i_sheng_hui_ti_shen_xiang': {'name': '圣徽替身像', 'price': 120, 'type': '消耗品', 'quality': 'blue', 'battle_ok': True, 'effect': 'summon', 'effect_data': {'tid': 'holy_totem', 'turns': 3, 'limit': 1, 'hp_ratio': 0.30, 'def_ratio': 0.30, 'taunt': True, 'heal_bonus': 0.15}, 'desc': '圣徽圣像嘲讽敌方 1 刻，其后 2 刻你受治疗+15%(每场限 1，战斗内使用)'},
    'i_jing_ji_kui_lei_zhong': {'name': '荆棘傀儡种', 'price': 80, 'type': '消耗品', 'quality': 'green', 'battle_ok': True, 'effect': 'summon', 'effect_data': {'tid': 'thorn_golem', 'turns': 3, 'limit': 1, 'hp_ratio': 0.30, 'def_ratio': 0.30, 'thorns': 0.2}, 'desc': '撒下荆棘傀儡种，召出傀儡 3 刻，受击反弹 20% 伤害(每场限 1，战斗内使用)'},
    'i_zhan_di_yi_zhe_mo_ou': {'name': '战地医者魔偶', 'price': 150, 'type': '消耗品', 'quality': 'blue', 'battle_ok': True, 'effect': 'summon', 'effect_data': {'tid': 'medic_golem', 'turns': 3, 'limit': 1, 'hp_ratio': 0.30, 'def_ratio': 0.30, 'heal_pct': 0.08}, 'desc': '召出医者魔偶 3 刻，每刻末回复 8% 最大生命(每场限 1，战斗内使用)'},
