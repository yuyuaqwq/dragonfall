...
EQUIP_ROSTER.update({
    ...
    'eq_sui_yue_quan': {'name': '碎岳拳', 'slot': 'weapon', 'weapon_type': 'fist', 'quality': 'blue', 'lv': 70, 'series': '碎岳', 'req': {'str': 68}, 'source': '图纸', 'special': '碎岳之势：攻击时 25% 概率破甲，降低目标防御 15%（2 回合）', 'desc': '传说能一拳碎开山岳的拳套，冰霜王座之下仍有地脉余温。碎岳之势：攻击时 25% 概率破甲，降低目标防御 15%（2 回合）。'},
    'eq_shuang_yu_chang_gong': {'name': '霜羽长弓', 'slot': 'weapon', 'weapon_type': 'bow', 'quality': 'blue', 'lv': 60, 'series': '霜羽', 'req': {'agi': 58}, 'source': '图纸', 'special': '霜羽之矢：攻击附加 5% 冰属性伤害 + 减速（敌速 -10%，持续 2 回合）', 'desc': '弓臂缀满霜羽的长弓，弦声响起时飘落细雪。霜羽之矢：攻击附加 5% 冰属性伤害 + 减速（敌速 -10%，持续 2 回合）。'},
    ...
    'eq_tie_lang_zhi_zhua': {'name': '铁狼之爪', 'slot': 'weapon', 'weapon_type': 'sword', 'quality': 'green', 'lv': 8, 'series': '铁狼', 'affix': 'armor_break', 'source': '商店', 'desc': '铁狼风格的利剑，刃口淬得发青，攻击 25% 降低目标防御 15%（2 回合）。'},
    'eq_ying_huo_fa_zhang': {'name': '萤火法杖', 'slot': 'weapon', 'weapon_type': 'staff', 'quality': 'green', 'lv': 10, 'series': '萤火', 'affix': 'meditate', 'source': '商店', 'desc': '萤火风格的法杖，杖顶凝着一点微光，每回合回复 1% 魔力。'},
    ...
    'eq_shui_ta_pi_jia': {'name': '水獭皮甲', 'slot': 'armor', 'quality': 'green', 'lv': 14, 'series': '水獭', 'affix': 'regen', 'source': '商店', 'desc': '水獭风格的皮甲，油亮的皮毛防水保暖，每回合回复 1% 生命。'},
    ...
    'eq_lv_ren_zhi_dun': {'name': '旅人之盾', 'slot': 'weapon', 'weapon_type': 'shield', 'quality': 'purple', 'lv': 10, 'series': '旅人', 'req': {'str': 12}, 'weapon_effect': 'novice_first_turn_guard', 'source': '图纸', 'desc': '旅人风格的盾牌，盾面厚实——守御特效：每场战斗首回合受击伤害－10%。'},
    ...
    'eq_cui_feng_zhi_gong': {'name': '翠风之弓', 'slot': 'weapon', 'weapon_type': 'bow', 'quality': 'purple', 'lv': 13, 'series': '翠风', 'req': {'agi': 15}, 'weapon_effect': 'novice_wind_spd', 'source': '图纸', 'desc': '翠风风格的长弓，弓臂缠着嫩绿藤蔓——翠风特效：攻击命中后，自身速度＋5%（持续 2 回合）。'},
    'eq_yuan_xing_dou_mao': {'name': '远行兜帽', 'slot': 'helm', 'quality': 'purple', 'lv': 14, 'series': '远行', 'req': {'agi': 12}, 'weapon_effect': 'novice_first_turn_dodge', 'source': '支线', 'desc': '远行风格的兜帽，帽檐压得很低——远行特效：每场战斗首回合闪避率＋5%。'},
    ...
    'eq_tie_gang_zhan_ren': {'name': '铁港战刃', 'slot': 'weapon', 'weapon_type': 'sword', 'quality': 'purple', 'lv': 24, 'series': '铁港', 'req': {'agi': 22}, 'source': '图纸', 'special': '咒刃雏形：施放技能后，下一次普攻伤害 +40%（每回合限 1 次）', 'desc': '刃背带锯齿的战刃，铁港锻造师按佣兵的用法改良过配重。咒刃雏形：施放技能后，下一次普攻伤害 +40%（每回合限 1 次）。'},
    ...
    'eq_shuang_yu_fa_zhang': {'name': '霜语法杖', 'slot': 'weapon', 'weapon_type': 'staff', 'quality': 'purple', 'lv': 28, 'series': '霜语', 'req': {'int': 26}, 'source': '图纸', 'special': '霜语减速：攻击附加 5% 冰属性伤害 + 减速（敌速 -20%，持续 2 回合）', 'desc': '杖顶凝着一枚不化的霜晶，握柄处常年结着薄薄的冰雾。霜语减速：攻击附加 5% 冰属性伤害 + 减速（敌速 -20%，持续 2 回合）。'},
    'eq_tie_gang_yuan_dun': {'name': '铁港圆盾', 'slot': 'weapon', 'weapon_type': 'shield', 'quality': 'purple', 'lv': 28, 'series': '铁港', 'req': {'str': 26}, 'source': '图纸', 'special': '锚壁：受击时 20% 概率使攻击者减速 20%（2 回合）', 'desc': '包着铁箍的圆盾，盾面中央铆着一枚船锚形的铁徽。锚壁：受击时 20% 概率使攻击者减速 20%（2 回合）。'},
    'eq_xue_chao_duan_ren': {'name': '血潮短刃', 'slot': 'weapon', 'weapon_type': 'dagger', 'quality': 'purple', 'lv': 30, 'series': '血潮', 'req': {'agi': 28}, 'source': '图纸', 'special': '血潮：攻击 20% 使目标流血（每回合 5% 生命，3 回合）', 'desc': '刃身泛着暗红纹路的短刃，据说曾浸过海兽的血。血潮：攻击 20% 使目标流血（每回合 5% 生命，3 回合）。'},
    ...
    'eq_zhu_huo_tou_kui': {'name': '铸火头盔', 'slot': 'helm', 'quality': 'purple', 'lv': 30, 'series': '铸火', 'req': {'str': 28}, 'source': '图纸', 'special': '铸火：受击时 15% 概率使攻击者灼烧（每回合 3% 生命，2 回合）', 'desc': '炉火淬出的铁盔，盔面残留着铸火时的暗红纹路。铸火：受击时 15% 概率使攻击者灼烧（每回合 3% 生命，2 回合）。'},
    ...
    'eq_han_yue_quan_tao': {'name': '撼岳拳套', 'slot': 'weapon', 'weapon_type': 'fist', 'quality': 'blue', 'lv': 90, 'series': '龙脊', 'req': {'str': 87}, 'source': '图纸', 'special': '铁山：受击时 20% 概率反击，造成 55% 伤害，并降低目标防御 10%（2 回合）', 'desc': '重逾山岳的拳套，一击之下如铁山倾颓。铁山：受击时 20% 概率反击，造成 55% 伤害，并降低目标防御 10%（2 回合）（触发：受击）。'},
    'eq_you_ying_duan_ren': {'name': '幽影短刃', 'slot': 'weapon', 'weapon_type': 'dagger', 'quality': 'blue', 'lv': 84, 'series': '苍穹', 'req': {'agi': 82}, 'source': '图纸', 'special': '幽影步：攻击命中时 20% 概率获得闪避 +10%（持续 2 回合）', 'desc': '淬入夜色阴影的短刃，出鞘无声。幽影步：攻击命中时 20% 概率获得闪避 +10%（触发：攻击命中，持续 2 回合）。'},
    'eq_cui_du_han_ren': {'name': '淬毒寒刃', 'slot': 'weapon', 'weapon_type': 'dagger', 'quality': 'blue', 'lv': 91, 'series': '苍穹', 'req': {'agi': 88}, 'source': '图纸', 'special': '淬毒：攻击时 20% 概率使目标中毒，每回合损失 5% 生命（持续 3 回合）', 'desc': '刃上淬着寒潭之毒，见血封喉。淬毒：攻击时 20% 概率使目标中毒，每回合损失 5% 生命（触发：攻击命中，持续 3 回合）。'},
    ...
    'eq_xing_chen_zhi_xue': {'name': '星尘之靴', 'slot': 'boots', 'quality': 'blue', 'lv': 86, 'series': '苍穹', 'req': {'agi': 82}, 'source': '图纸', 'special': '星驰：战斗开始时自身速度 +10%（持续 3 回合）', 'desc': '靴底缀着星尘碎光，奔跑时如踏星河。星驰：战斗开始时自身速度 +10%（触发：战斗开始，持续 3 回合）。'},
    ...
    'eq_shao_bing_duan_jian': {'name': '哨兵短剑', 'slot': 'weapon', 'weapon_type': 'sword', 'quality': 'blue', 'lv': 10, 'series': '哨兵', 'source': '商店', 'weapon_effect': 'starlight_bulwark', 'special': '星辉壁垒：战斗开始获得10%最大生命的护盾，每5回合刷新一次（触发：战斗开始/每5回合）', 'desc': '城塞哨兵世代相传的短剑，剑格镶着夜巡时借星光打磨的晶片。星辉壁垒：战斗开始获得10%最大生命的护盾，每5回合刷新一次（触发：战斗开始/每5回合）。'},
    ...
    'eq_duan_huo_tie_quan': {'name': '锻火铁拳', 'slot': 'weapon', 'weapon_type': 'fist', 'quality': 'blue', 'lv': 10, 'series': '锻火', 'source': '商店', 'weapon_effect': 'smith_blaze_wound', 'special': '裂伤：攻击命中后20%概率使目标3回合内每回合损失1.5%最大生命（精英/Boss衰减为1%）（触发：攻击命中后）', 'desc': '铁匠铺炉火里淬出来的拳套，指节还带着锻打的火纹。裂伤：攻击命中后20%概率使目标3回合内每回合损失1.5%最大生命（触发：攻击命中后）。'},
    ...
    'eq_sui_bing_chang_gong': {'name': '碎冰长弓', 'slot': 'weapon', 'weapon_type': 'bow', 'quality': 'purple', 'lv': 32, 'series': '碎冰', 'req': {'agi': 30}, 'source': '图纸', 'weapon_effect': 'frost_ring', 'special': '霜环：攻击命中后25%概率使目标减速2回合（速度-40%），目标已减速则冻结1回合（触发：攻击命中后）', 'desc': '北境冰湖下捞起的弓胎，弓弦一响，箭风都带着霜气。霜环：攻击命中后25%概率使目标减速2回合（速度-40%），已减速则冻结1回合（触发：攻击命中后）。'},
    ...
    'eq_sheng_hui_quan_zhang': {'name': '圣辉权杖', 'slot': 'weapon', 'weapon_type': 'mace', 'quality': 'purple', 'lv': 30, 'series': '圣辉', 'req': {'int': 28}, 'source': '宝藏', 'weapon_effect': 'holy_word_bind', 'special': '圣言禁锢：治疗技能后20%概率使敌人禁锢1回合（Boss免疫，退化为减速）（触发：治疗技能后）', 'desc': '圣堂执事巡礼时持握的权杖，杖首圣徽在祈祷时会亮起。圣言禁锢：治疗技能后20%概率使敌人禁锢1回合（Boss免疫退化为减速）（触发：治疗技能后）。'},
    'eq_ye_xiao_shuang_bi': {'name': '夜枭双匕', 'slot': 'weapon', 'weapon_type': 'dagger', 'quality': 'purple', 'lv': 34, 'series': '夜枭', 'req': {'agi': 32}, 'source': '图纸', 'weapon_effect': 'combo_end', 'special': '连击终点：本回合连段≥3时，本次攻击暴击伤害+40%（触发：被动判定）', 'desc': '盗贼公会暗房里磨出来的双匕，刃背刻着夜枭的尾羽纹。连击终点：本回合连段≥3时，本次攻击暴击伤害+40%（触发：被动判定）。'},
    ...
    'eq_xue_hen_shuang_ci': {'name': '血痕双刺', 'slot': 'weapon', 'weapon_type': 'dagger', 'quality': 'purple', 'lv': 52, 'series': '血痕', 'req': {'agi': 50}, 'source': '图纸', 'weapon_effect': 'blood_trace', 'special': '败血：攻击命中后25%概率使目标4回合内每回合损失2%当前生命（Boss衰减为1.5%），对败血目标+10%伤害（触发：攻击命中后）', 'desc': '双刺刃口淬过败血草的汁液，见血便留下一道暗红的痕。败血：命中25%使目标4回合每回合损2%当前生命（Boss 1.5%），对败血目标+10%伤害（触发：攻击命中后）。'},
    'eq_hui_jin_quan_tao': {'name': '灰烬拳套', 'slot': 'weapon', 'weapon_type': 'fist', 'quality': 'purple', 'lv': 50, 'series': '灰烬', 'req': {'str': 48}, 'source': '图纸', 'weapon_effect': 'ember_burn', 'special': '烬燃：技能命中后30%概率使目标3回合内每回合损失1.5%最大生命（Boss 1%），烬燃期间受火属性伤害+10%（触发：技能命中后）', 'desc': '烬山祭坛的余烬凝成的拳套，拳风扫过都带着焦土的气味。烬燃：技能命中30%使目标3回合每回合损1.5%最大生命（Boss 1%），烬燃期间受火伤+10%（触发：技能命中后）。'},
    'eq_ao_la_sheng_jian': {'name': '奥拉圣剑', 'slot': 'weapon', 'weapon_type': 'sword', 'quality': 'orange', 'lv': 55, 'series': '奥拉', 'req': {'str': 55}, 'source': '任务', 'legendary': 'aura_glory', 'weapon_effect': 'endless_radiance', 'special': '无尽辉光：暴击伤害+25%，暴击时获得5%最大生命的护盾（持续2回合，冷却3回合）（触发：常驻属性+攻击暴击后）', 'desc': '云中圣殿圣女奥拉亲手锻成的圣剑，剑身流转着永不熄灭的辉光。无尽辉光：暴伤+25%，暴击时获5%最大生命护盾（2回合，冷却3）（触发：常驻+暴击后）。'},
    'eq_yong_shuang_mi_zhang': {'name': '永霜秘杖', 'slot': 'weapon', 'weapon_type': 'staff', 'quality': 'orange', 'lv': 70, 'series': '永霜', 'req': {'int': 70}, 'source': '任务', 'legendary': 'everfrost_secret', 'weapon_effect': 'everfrost_domain', 'special': '永冻领域：冰系技能后30%概率使目标冻结1回合（Boss免疫，退化为减速2回合），冷却3回合（触发：冰系技能后）', 'desc': '永冻冰原极深处挖出的秘杖，杖头永远凝着一层不化的霜。永冻领域：冰系技能后30%使目标冻结1回合（Boss减速2回合），冷却3回合（触发：冰系技能后）。'},
    ...
    'eq_sheng_cai_zhong_chui': {'name': '圣裁重锤', 'slot': 'weapon', 'weapon_type': 'mace', 'quality': 'purple', 'lv': 70, 'series': '圣裁', 'req': {'int': 66}, 'source': '宝藏', 'weapon_effect': 'holy_judgment_field', 'special': '圣裁领域：攻击命中后30%概率使目标2回合内减速30%并受治疗-30%（触发：攻击命中后）', 'desc': '圣殿惩戒骑士的重锤，锤面刻着审判的天平纹。圣裁领域：命中30%使目标2回合减速30%+受治疗-30%（触发：攻击命中后）。'},
    ...
    'eq_tie_wei_zhan_kui': {'name': '铁卫战盔', 'slot': 'helm', 'quality': 'blue', 'lv': 10, 'series': '铁卫', 'source': '商店', 'weapon_effect': 'guard_regen', 'special': '铁卫意志：每回合开始回复2%已损失生命（触发：回合开始）', 'desc': '边境卫戍队的制式战盔，内衬缝着老兵手写的平安祷词。铁卫意志：每回合开始回复2%已损失生命（触发：回合开始）。'},
    'eq_shao_bing_xiong_jia': {'name': '哨兵胸甲', 'slot': 'armor', 'quality': 'blue', 'lv': 10, 'series': '哨兵', 'source': '商店', 'weapon_effect': 'sentinel_aegis', 'special': '哨兵壁垒：受击时15%概率获得护盾（吸收6+0.5×Lv点伤害，持续3回合），冷却1回合（触发：受击时）', 'desc': '哨塔守夜人的胸甲，胸口的擦痕记录着无数个不眠夜。哨兵壁垒：受击时15%概率获得护盾（吸收6+0.5×Lv点伤害，3回合），冷却1回合（触发：受击时）。'},
    ...
    'eq_ji_feng_qing_xue': {'name': '疾风轻靴', 'slot': 'boots', 'quality': 'blue', 'lv': 10, 'series': '疾风', 'source': '商店', 'weapon_effect': 'gale_step', 'special': '疾风步：战斗开始获得1层疾风（速度+15%，持续3回合）（触发：战斗开始）', 'desc': '信使穿过的轻靴，鞋底纹路像风掠过草尖。疾风步：战斗开始获得1层疾风（速度+15%，持续3回合）（触发：战斗开始）。'},
    ...
    'eq_chen_xi_hu_fu': {'name': '晨曦护符', 'slot': 'necklace', 'quality': 'blue', 'lv': 12, 'series': '晨曦', 'source': '宝藏', 'weapon_effect': 'dawn_regen', 'special': '晨曦微光：每回合开始回复2%最大生命（触发：回合开始）', 'desc': '晨曦圣堂圣水泡过的护符，贴身挂着总有一丝暖意。晨曦微光：每回合开始回复2%最大生命（触发：回合开始）。'},
    'eq_han_shuang_zhi_guan': {'name': '寒霜之冠', 'slot': 'helm', 'quality': 'purple', 'lv': 30, 'series': '寒霜', 'req': {'int': 28}, 'source': '副本Boss', 'weapon_effect': 'frost_crown', 'special': '寒霜凝视：受击时10%概率使敌人冻结1回合（每场最多2次）（触发：受击时）', 'desc': '冰湖女王沉睡时遗落的王冠，冠檐凝着不化的霜花。寒霜凝视：受击时10%概率使敌人冻结1回合（每场最多2次）（触发：受击时）。'},
    ...
    'eq_xun_jie_zhan_xue': {'name': '迅捷战靴', 'slot': 'boots', 'quality': 'blue', 'lv': 30, 'series': '迅捷', 'req': {'agi': 26}, 'source': '商店', 'weapon_effect': 'swift_boots', 'special': '迅捷如风：战斗开始获得1层疾风（速度+20%，持续3回合）（触发：战斗开始）', 'desc': '竞技场快腿斗士的靴子，鞋跟磨得只剩薄薄一层。迅捷如风：战斗开始获得1层疾风（速度+20%，持续3回合）（触发：战斗开始）。'},
    ...
    'eq_shen_yan_zhan_kui': {'name': '深岩战盔', 'slot': 'helm', 'quality': 'blue', 'lv': 50, 'series': '深岩', 'req': {'str': 45}, 'source': '商店', 'weapon_effect': 'deeprock_aegis', 'special': '深岩壁垒：受击时10%概率获得护盾（吸收8%最大生命的伤害），冷却2回合（触发：受击时）', 'desc': '矿洞深处挖出的战盔，盔面像一整块未凿的岩层。深岩壁垒：受击时10%概率获得护盾（吸收8%最大生命），冷却2回合（触发：受击时）。'},
    ...
    'eq_wang_zhe_zhan_xue': {'name': '亡者战靴', 'slot': 'boots', 'quality': 'purple', 'lv': 50, 'series': '亡者', 'req': {'agi': 45}, 'source': '副本Boss', 'weapon_effect': 'deadman_stride', 'special': '亡者疾行：战斗开始获得2层疾风（速度+15%，持续4回合）（触发：战斗开始）', 'desc': '亡灵大军的制式战靴，靴底却钉着生者的皮。亡者疾行：战斗开始获得2层疾风（速度+15%，持续4回合）（触发：战斗开始）。'},
    'eq_bu_mie_zhi_jie': {'name': '不灭之戒', 'slot': 'ring', 'quality': 'blue', 'lv': 50, 'series': '不灭', 'req': {'int': 45}, 'source': '宝藏', 'weapon_effect': 'undying_band', 'special': '不灭微光：每回合开始回复1.5%最大生命（触发：回合开始）', 'desc': '圣骑士遗物戒指，戒圈内壁刻着『余火不灭』。不灭微光：每回合开始回复1.5%最大生命（触发：回合开始）。'},
    'eq_si_wang_zhi_wu': {'name': '死亡之舞', 'slot': 'necklace', 'quality': 'orange', 'lv': 52, 'series': '死亡之舞', 'req': {'agi': 50}, 'source': '副本Boss', 'legendary': 'death_dance', 'weapon_effect': 'death_dance', 'special': '死亡之舞：受击伤害的35%转为缓伤，每回合开始结算已积累缓伤的10%（上限10回合），死亡时立即结算（触发：受击时/回合开始）', 'desc': '深渊舞者颈间的项链，坠子是一枚旋转不休的骨轮。死亡之舞：受击伤害35%转为缓伤，回合开始结算10%（上限10回合），死亡时立即结算（触发：受击时）。'},
    'eq_pan_shi_wang_guan': {'name': '磐石王冠', 'slot': 'helm', 'quality': 'purple', 'lv': 70, 'series': '磐石', 'req': {'str': 66}, 'source': '副本Boss', 'weapon_effect': 'bedrock_crown', 'special': '磐石守护：每场1次，生命低于25%时获得护盾（吸收20%最大生命的伤害，持续4回合）（触发：生命阈值）', 'desc': '山岳矮人王加冕时的王冠，戴上如背负整座山。磐石守护：每场1次，生命低于25%时获得20%最大生命护盾（持续4回合）（触发：生命阈值）。'},
    ...
    'eq_sheng_dian_zhan_xue': {'name': '圣殿战靴', 'slot': 'boots', 'quality': 'purple', 'lv': 70, 'series': '圣殿', 'req': {'agi': 66}, 'source': '副本Boss', 'weapon_effect': 'temple_stride', 'special': '圣殿疾行：战斗开始获得2层疾风（速度+20%，持续4回合）（触发：战斗开始）', 'desc': '圣殿骑士团阅兵靴，靴筒绣着金色圣徽。圣殿疾行：战斗开始获得2层疾风（速度+20%，持续4回合）（触发：战斗开始）。'},
    ...
    'eq_bu_mie_yi_zhi': {'name': '不灭意志', 'slot': 'necklace', 'quality': 'orange', 'lv': 72, 'series': '不灭', 'req': {'str': 70}, 'source': '副本Boss', 'legendary': 'undying_will', 'weapon_effect': 'undying_will', 'special': '不灭意志：每场1次，生命低于20%时触发，本回合免疫致死伤害并回复10%生命（触发：生命阈值）', 'desc': '传说某位英雄濒死时紧握的项链，链坠里封着一滴凝固的泪。不灭意志：每场1次，生命低于20%时触发，本回合免疫致死并回复10%生命（触发：生命阈值）。'},
    'eq_cang_qiong_zhi_guan': {'name': '苍穹之冠', 'slot': 'helm', 'quality': 'purple', 'lv': 90, 'series': '苍穹', 'req': {'int': 86}, 'source': '副本Boss', 'weapon_effect': 'firmament_crown', 'special': '苍穹庇护：每场2次，生命低于30%时获得护盾（吸收12%最大生命的伤害，持续3回合）（触发：生命阈值）', 'desc': '观星台塔顶供奉的王冠，冠檐嵌着会自行流转的星图。苍穹庇护：每场2次，生命低于30%时获得12%最大生命护盾3回合（触发：生命阈值）。'},
    'eq_long_ji_lin_jia': {'name': '龙脊鳞甲', 'slot': 'armor', 'quality': 'purple', 'lv': 92, 'series': '龙脊', 'req': {'str': 90}, 'source': '副本Boss', 'weapon_effect': 'dragon_spine_mail', 'special': '龙脊反噬：受击时15%概率反弹25%所受伤害，并使其重伤（受治疗-30%，持续2回合）（触发：受击时）', 'desc': '用龙脊背鳞一片片串成的鳞甲，每一片都带着龙血浸过的暗红。龙脊反噬：受击时15%概率反弹25%伤害并使其重伤（治疗-30%，2回合）（触发：受击时）。'},
    ...
    'eq_xu_kong_xing_zhe_zhi_xue': {'name': '虚空行者之靴', 'slot': 'boots', 'quality': 'purple', 'lv': 90, 'series': '虚空行者', 'req': {'agi': 86}, 'source': '副本Boss', 'weapon_effect': 'void_stride', 'special': '虚空疾行：战斗开始获得2层疾风（速度+25%，持续4回合）（触发：战斗开始）', 'desc': '虚空行者留下的靴子，靴面像一小片凝固的星空。虚空疾行：战斗开始获得2层疾风（速度+25%，持续4回合）（触发：战斗开始）。'},
    ...
    'eq_wu_zhong_zhi_ren': {'name': '无终之刃', 'slot': 'weapon', 'weapon_type': 'sword', 'quality': 'orange', 'lv': 95, 'series': '无终', 'req': {'str': 95}, 'source': 'legend', 'legendary': 'endless_blade', 'weapon_effect': 'endless_blade', 'special': '无尽锋芒：暴击后追加一次20%伤害的追击（每回合限1次）（触发：攻击暴击后）', 'desc': '传说这把剑没有终点——它会在你挥出的每一道剑光之后，再补上一道。无尽锋芒：暴击后追加一次20%伤害的追击（每回合限1次）（触发：攻击暴击后）。'},
    'eq_zhou_ren_zhi_shi': {'name': '咒刃之誓', 'slot': 'weapon', 'weapon_type': 'sword', 'quality': 'orange', 'lv': 88, 'series': '咒刃', 'req': {'str': 88}, 'source': 'legend', 'legendary': 'oath_blade', 'weapon_effect': 'oath_blade', 'special': '咒刃之誓：释放技能后，下一次攻击伤害+25%（每回合限1次）（触发：技能释放后）', 'desc': '立誓者的佩剑，剑身铭刻着血契符文——技能落下之处，必有剑光追随。咒刃之誓：释放技能后，下一次攻击伤害+25%（每回合限1次）（触发：技能释放后）。'},
    ...
    'eq_sui_yue_zhi_zhang': {'name': '岁月之杖', 'slot': 'weapon', 'weapon_type': 'staff', 'quality': 'orange', 'lv': 86, 'series': '岁月', 'req': {'int': 86}, 'source': 'legend', 'legendary': 'time_staff', 'weapon_effect': 'time_staff', 'special': '岁月流转：每回合结束攻击+1.5%、回复1.5%生命（上限10层=+15%）（触发：回合结束）', 'desc': '时之领领主的法杖，木纹里流动着百年光阴。岁月流转：每回合结束攻击+1.5%、回复1.5%生命（上限10层=+15%）（触发：回合结束）。'},
    ...
    'eq_jin_huo_bi_lei': {'name': '烬火壁垒', 'slot': 'weapon', 'weapon_type': 'shield', 'quality': 'orange', 'lv': 88, 'series': '烬火', 'req': {'str': 88}, 'source': 'legend', 'legendary': 'ember_bulwark', 'weapon_effect': 'ember_bulwark', 'special': '烬火燎原：受击时对攻击者造成自身5%最大生命的伤害，并叠加1层灼烧（每回合限1次）（触发：受击时）', 'desc': '烬山矮人用火神锻炉的余火铸成的巨盾，盾面永远滚烫。烬火燎原：受击对攻击者造成自身5%最大生命伤害并叠1层灼烧（每回合限1次）（触发：受击时）。'},
    ...
    'eq_yong_shuang_quan_zhang': {'name': '永霜权杖', 'slot': 'weapon', 'weapon_type': 'staff', 'quality': 'orange', 'lv': 94, 'series': '永霜', 'req': {'int': 95}, 'source': 'legend', 'legendary': 'everfrost_scepter', 'weapon_effect': 'everfrost_scepter', 'special': '永霜禁锢：技能命中后20%概率冻结目标1回合（Boss仅减速）（触发：技能命中后）', 'desc': '永冻冰原最深处那场暴雪的化身，握在手里时，连时间都被冻住。永霜禁锢：技能命中后20%概率冻结目标1回合（Boss仅减速）（触发：技能命中后）。'},
})
...
EQUIP_ROSTER.update({
    ...
    'eq_ma_er_ku_si_de_fa_guan': {'name': '马尔库斯的法冠', 'slot': 'helm', 'quality': 'orange', 'lv': 52, 'series': '圣光', 'req': {'int': 52}, 'legendary': 'marcus_crown', 'source': 'boss', 'desc': '审判长·马尔库斯的银制法冠，冠沿嵌着十二颗圣徽宝石。审判之眼：行动时 20% 概率洞悉弱点，本回合伤害 +15%。'},
    'eq_chen_xi_zhi_guan': {'name': '晨曦之冠', 'slot': 'helm', 'quality': 'orange', 'lv': 62, 'series': '月语', 'req': {'agi': 60}, 'legendary': 'dawn_crown', 'source': 'boss', 'desc': '远古精灵王·晨曦的月桂冠，枝叶间流转着晨光。每回合开始回复 2% 最大生命。'},
    ...
    'eq_mo_luo_zhi_guan': {'name': '摩罗之冠', 'slot': 'helm', 'quality': 'orange', 'lv': 98, 'series': '地底', 'req': {'str': 90}, 'legendary': 'moro_crown', 'source': 'boss', 'desc': '深渊领主·摩罗的荆棘王冠，冠刺间凝着暗红的深渊火。受击时 15% 概率使攻击者攻击 -10%（2 回合）。'},
    ...
    'eq_yao_sai_you_ling_zhi_kui': {'name': '要塞幽灵之盔', 'slot': 'helm', 'quality': 'purple', 'lv': 38, 'series': '迷雾', 'req': {'vit': 34}, 'source': 'boss', 'special': '幽灵低语：受击时 15% 概率使攻击者混乱（1 回合内攻击命中率 -10%）', 'desc': '要塞幽灵盘踞的锈蚀铁盔，盔内隐约传来旧日守军的低语。幽灵低语：受击时 15% 概率使攻击者混乱（1 回合内攻击命中率 -10%）。'},
    ...
    'eq_lan_ge_zhi_guan': {'name': '蓝歌之冠', 'slot': 'helm', 'quality': 'purple', 'lv': 60, 'series': '海神', 'req': {'int': 56}, 'source': 'boss', 'special': '海妖之歌：施法时 20% 概率使目标混乱（1 回合内攻击命中率 -10%）', 'desc': '海妖女王·蓝歌的珊瑚王冠，冠上嵌着会唱歌的珍珠。海妖之歌：施法时 20% 概率使目标混乱（1 回合内攻击命中率 -10%）。'},
    ...
    'eq_shi_lu_zhan_chui': {'name': '石炉战锤', 'slot': 'weapon', 'weapon_type': 'mace', 'quality': 'purple', 'lv': 84, 'series': '地底', 'req': {'str': 80}, 'weapon_effect': 'rong_lu_yu_wen', 'source': 'boss', 'special': '熔炉余温：攻击 20% 概率使目标灼烧（每回合 3% 生命，2 回合）', 'desc': '灰矮人领主·石炉亲手锻打的战锤，锤头仍残留着地底熔炉的余温。熔炉余温：攻击 20% 概率使目标灼烧（每回合 3% 生命，2 回合）。'},
    'eq_hei_yuan_zhi_yan': {'name': '黑渊之眼', 'slot': 'necklace', 'quality': 'purple', 'lv': 92, 'series': '地底', 'req': {'int': 88}, 'weapon_effect': 'star_destruction', 'source': 'boss', 'special': '深渊凝视：攻击 20% 概率使目标恐惧（1 回合内攻击 -8%）', 'desc': '地底古龙·黑渊的独目炼成的坠饰，瞳孔深处是无尽的黑渊。深渊凝视：攻击 20% 概率使目标恐惧（1 回合内攻击 -8%）。'},
    ...
    'eq_hong_ji_shan_hu_jie': {'name': '红棘珊瑚戒', 'slot': 'ring', 'quality': 'purple', 'lv': 42, 'series': '海神', 'req': {'agi': 38}, 'source': '精英专属', 'special': '珊瑚棘：攻击 15% 概率使目标流血（每回合 3% 生命，2 回合）', 'desc': '珊瑚礁主·红棘的红珊瑚磨成的戒指，戒面生着细密的棘刺。珊瑚棘：攻击 15% 概率使目标流血（每回合 3% 生命，2 回合）。'},
    ...
    'eq_shuang_ju_mo_zhan_chui': {'name': '霜巨魔战锤', 'slot': 'weapon', 'weapon_type': 'mace', 'quality': 'purple', 'lv': 72, 'series': '霜狼', 'req': {'str': 68}, 'weapon_effect': 'frost_ring', 'source': '精英专属', 'special': '霜冻：攻击 20% 概率使目标减速（2 回合内速度 -10%）', 'desc': '霜巨魔王的冰岩战锤，锤面覆着不化的白霜。霜冻：攻击 20% 概率使目标减速（2 回合内速度 -10%）。'},
    'eq_rong_yan_zhong_jian': {'name': '熔岩重剑', 'slot': 'weapon', 'weapon_type': 'sword', 'quality': 'purple', 'lv': 76, 'series': '灰烬守卫', 'req': {'str': 72}, 'weapon_effect': 'ember_burn', 'source': '精英专属', 'special': '熔火：攻击 20% 概率使目标灼烧（每回合 3% 生命，2 回合）', 'desc': '熔岩领主的地心火淬成的重剑，剑脊上流淌着暗红的岩浆纹。熔火：攻击 20% 概率使目标灼烧（每回合 3% 生命，2 回合）。'},
    'eq_shuang_ya_bing_ren': {'name': '霜牙冰刃', 'slot': 'weapon', 'weapon_type': 'dagger', 'quality': 'purple', 'lv': 84, 'series': '霜狼', 'req': {'agi': 78}, 'weapon_effect': 'frost_crown', 'source': '精英专属', 'special': '霜牙：攻击 20% 概率使目标冻结（1 回合内无法行动）', 'desc': '冰川龙·霜牙的断牙磨成的冰刃，刃口呵气成霜。霜牙：攻击 20% 概率使目标冻结（1 回合内无法行动）。'},
    'eq_hai_wang_gu_mian': {'name': '骸王骨面', 'slot': 'helm', 'quality': 'purple', 'lv': 92, 'series': '迷雾', 'req': {'vit': 84}, 'weapon_effect': 'guardian_will', 'source': '精英专属', 'special': '骸骨低语：受击时 10% 概率使攻击者恐惧（1 回合内攻击 -8%）', 'desc': '骨龙领主·骸王的颅骨磨成的骨面，眼眶里燃着两簇幽火。骸骨低语：受击时 10% 概率使攻击者恐惧（1 回合内攻击 -8%）。'},
