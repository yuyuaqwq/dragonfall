...
EQUIP_ROSTER = {
    ...
    'eq_lie_feng_pi_feng': {'name': '猎风披风', 'slot': 'armor', 'quality': 'blue', 'lv': 12, 'series': '猎风', 'req': {'agi': 10}, 'source': '锻造'},
    'eq_lie_feng_hu_tui': {'name': '猎风护腿', 'slot': 'legs', 'quality': 'blue', 'lv': 12, 'series': '猎风', 'req': {'agi': 10}, 'source': '锻造'},
    'eq_lie_feng_zhi_xue': {'name': '猎风之靴', 'slot': 'boots', 'quality': 'blue', 'lv': 14, 'series': '猎风', 'req': {'agi': 12}, 'source': '锻造'},
    'eq_chen_lu_jie_zhi': {'name': '晨露戒指', 'slot': 'ring', 'quality': 'blue', 'lv': 10, 'series': '晨露', 'req': {'vit': 8}, 'legendary': 'morning_dew', 'source': '锻造'},
    'eq_chen_lu_xiang_lian': {'name': '晨露项链', 'slot': 'necklace', 'quality': 'blue', 'lv': 12, 'series': '晨露', 'req': {'vit': 10}, 'source': '锻造'},
    'eq_lie_hu_dou_mao': {'name': '猎户兜帽', 'slot': 'helm', 'quality': 'blue', 'lv': 14, 'series': '猎户', 'req': {'agi': 12}, 'source': '锻造'},
    'eq_lie_hu_jia_ke': {'name': '猎户夹克', 'slot': 'armor', 'quality': 'blue', 'lv': 16, 'series': '猎户', 'req': {'agi': 14}, 'source': '锻造'},
    'eq_lie_hu_chang_xue': {'name': '猎户长靴', 'slot': 'boots', 'quality': 'blue', 'lv': 14, 'series': '猎户', 'req': {'agi': 12}, 'source': '锻造'},
    'eq_xiang_mu_fu_ji': {'name': '橡木符记', 'slot': 'necklace', 'quality': 'green', 'lv': 8, 'series': '橡木符记', 'req': {}, 'source': '锻造'},
    'eq_bai_lu_hu_fu': {'name': '白鹿护符', 'slot': 'ring', 'quality': 'green', 'lv': 10, 'series': '白鹿护符', 'req': {}, 'source': '锻造'},
    'eq_chun_cao_shou_huan': {'name': '春草手环', 'slot': 'ring', 'quality': 'green', 'lv': 12, 'series': '春草', 'req': {}, 'source': '锻造'},
    'eq_ye_ying_xiong_zhen': {'name': '夜莺胸针', 'slot': 'necklace', 'quality': 'blue', 'lv': 16, 'series': '夜莺', 'req': {'agi': 14}, 'source': '锻造'},
    'eq_chao_xi_zhi_huan': {'name': '潮汐之环', 'slot': 'ring', 'quality': 'blue', 'lv': 22, 'series': '潮汐', 'req': {'int': 18}, 'source': '锻造'},
    'eq_chao_xi_diao_zhui': {'name': '潮汐吊坠', 'slot': 'necklace', 'quality': 'blue', 'lv': 24, 'series': '潮汐', 'req': {'int': 20}, 'source': '锻造'},
    'eq_mao_lian_hu_wan': {'name': '锚链护腕', 'slot': 'ring', 'quality': 'blue', 'lv': 22, 'series': '锚链', 'req': {'str': 18}, 'source': '锻造'},
    ...
    'eq_hai_dao_yan_zhao': {'name': '海盗眼罩', 'slot': 'helm', 'quality': 'blue', 'lv': 26, 'series': '海盗', 'req': {'agi': 22}, 'source': '锻造'},
    'eq_hang_hai_dou_peng': {'name': '航海斗篷', 'slot': 'armor', 'quality': 'blue', 'lv': 28, 'series': '航海', 'req': {'agi': 24}, 'source': '锻造'},
    'eq_shen_yuan_zhi_mao': {'name': '深渊之锚', 'slot': 'ring', 'quality': 'purple', 'lv': 32, 'series': '深渊之锚', 'req': {'str': 28}, 'legendary': 'abyss_anchor', 'source': '图纸'},
    'eq_deng_ta_zhi_guang': {'name': '灯塔之光', 'slot': 'necklace', 'quality': 'blue', 'lv': 26, 'series': '灯塔', 'req': {'vit': 22}, 'legendary': 'lighthouse_ward', 'source': '锻造'},
    'eq_shui_shou_jie_jie_zhi': {'name': '水手结戒指', 'slot': 'ring', 'quality': 'green', 'lv': 18, 'series': '水手结', 'req': {}, 'source': '锻造'},
    'eq_chao_xi_zhi_xue': {'name': '潮汐之靴', 'slot': 'boots', 'quality': 'blue', 'lv': 24, 'series': '潮汐', 'req': {'int': 20}, 'source': '锻造'},
    'eq_tie_gang_hui_zhang': {'name': '铁港徽章', 'slot': 'necklace', 'quality': 'purple', 'lv': 34, 'series': '铁港徽章', 'req': {'str': 30}, 'source': '图纸'},
    'eq_chen_xi_zhi_jie': {'name': '晨曦之戒', 'slot': 'ring', 'quality': 'blue', 'lv': 20, 'series': '晨曦', 'req': {'vit': 16}, 'source': '锻造'},
    ...
    'eq_fei_cui_zhi_xin': {'name': '翡翠之心', 'slot': 'necklace', 'quality': 'blue', 'lv': 40, 'series': '翡翠之心', 'req': {'vit': 34}, 'legendary': 'jade_wealth', 'source': '锻造'},
    'eq_fei_cui_hu_fu': {'name': '翡翠护符', 'slot': 'ring', 'quality': 'blue', 'lv': 38, 'series': '翡翠护符', 'req': {'vit': 32}, 'source': '锻造'},
    'eq_ji_feng_hu_shou': {'name': '疾风护手', 'slot': 'armor', 'quality': 'blue', 'lv': 36, 'series': '疾风', 'req': {'agi': 32}, 'source': '锻造'},
    'eq_ji_feng_zhi_xue': {'name': '疾风之靴', 'slot': 'boots', 'quality': 'blue', 'lv': 36, 'series': '疾风', 'req': {'agi': 32}, 'source': '锻造'},
    'eq_yue_yu_zhi_jie': {'name': '月语之戒', 'slot': 'ring', 'quality': 'purple', 'lv': 50, 'series': '月语戒', 'req': {'agi': 46}, 'legendary': 'moon_bow', 'source': '图纸'},
    'eq_jing_ling_pi_feng': {'name': '精灵披风', 'slot': 'armor', 'quality': 'blue', 'lv': 42, 'series': '精灵', 'req': {'agi': 38}, 'source': '锻造'},
    ...
    'eq_han_shuang_zhi_jie': {'name': '寒霜之戒', 'slot': 'ring', 'quality': 'blue', 'lv': 55, 'series': '寒霜', 'req': {'int': 50}, 'legendary': 'element_ice', 'source': '锻造'},
    'eq_bei_feng_hu_fu': {'name': '北风护符', 'slot': 'necklace', 'quality': 'blue', 'lv': 58, 'series': '北风', 'req': {'agi': 52}, 'legendary': 'swift', 'source': '锻造'},
    ...
    'eq_lie_shou_dou_peng': {'name': '猎手斗篷', 'slot': 'armor', 'quality': 'blue', 'lv': 56, 'series': '猎影', 'req': {'agi': 50}, 'source': '锻造'},
    'eq_lie_shou_zhi_xue': {'name': '猎手之靴', 'slot': 'boots', 'quality': 'blue', 'lv': 54, 'series': '猎影', 'req': {'agi': 48}, 'source': '锻造'},
    'eq_tie_bi_hu_fu': {'name': '铁壁护符', 'slot': 'ring', 'quality': 'blue', 'lv': 52, 'series': '铁壁', 'req': {'str': 46}, 'legendary': 'dmg_reduce', 'source': '锻造'},
    ...
    'eq_mi_yin_shou_zhuo': {'name': '秘银手镯', 'slot': 'ring', 'quality': 'blue', 'lv': 75, 'series': '秘银', 'req': {'str': 70}, 'source': '锻造'},
...
EQUIP_ROSTER.update({
    ...
    'eq_xing_hui_zhi_guan': {'name': '星辉之冠', 'slot': 'helm', 'quality': 'orange', 'lv': 92, 'series': '星辉', 'req': {'int': 90}, 'legendary': 'xing_hui_zhi_guan', 'desc': '每刻开始回复3%最大法力；施法暴击时叠加星辉，每层伤害+2%（上限5层）（触发：刻开始/施法暴击，数值：3%/2%×5）', 'source': 'boss'},
    ...
    'eq_ben_lei_da_jian': {'name': '奔雷大剑', 'slot': 'weapon', 'weapon_type': 'sword', 'quality': 'purple', 'lv': 92, 'series': '奔雷', 'req': {'str': 92}, 'source': '副本Boss', 'weapon_effect': 'trinity_rhythm', 'special': '三相律动：技能后下一次普攻+30%伤害并附带15%攻击力的雷属性伤害（触发：技能后/状态机）', 'desc': '雷暴夜被闪电劈中的大剑，剑脊至今留着焦痕与雷纹。三相律动：技能后下一次普攻+30%伤害并附带15%攻击力的雷属性伤害（触发：技能后）。'},
    ...
    'eq_yan_mie_fa_dian_fa_zhang': {'name': '湮灭法典法杖', 'slot': 'weapon', 'weapon_type': 'staff', 'quality': 'purple', 'lv': 85, 'series': '湮灭法典', 'req': {'int': 82}, 'source': '副本Boss', 'weapon_effect': 'annihilation_echo', 'special': '湮灭回响：技能命中后35%概率溅射30%攻击力的奥术伤害（触发：技能命中后）', 'desc': '被封印的禁忌法典化作的法杖，翻开时仿佛能听见低语。湮灭回响：技能命中后35%概率溅射30%攻击力的奥术伤害（触发：技能命中后）。'},
    ...
    'eq_mu_guang_zhi_ci': {'name': '暮光之刺', 'slot': 'weapon', 'weapon_type': 'dagger', 'quality': 'purple', 'lv': 92, 'series': '暮光', 'req': {'agi': 90}, 'source': '副本Boss', 'weapon_effect': 'twilight_execute', 'special': '暮光处决：对生命<40%的目标+25%伤害（触发：被动判定，与处决取高不叠乘）', 'desc': '暮色里铸成的短刺，刃身暗得几乎吞掉所有光。暮光处决：对生命<40%目标+25%伤害（触发：被动判定）。'},
    ...
    'eq_han_shuang_zhi_guan': {'name': '寒霜之冠', 'slot': 'helm', 'quality': 'purple', 'lv': 60, 'series': '寒霜', 'req': {'int': 56}, 'source': '副本Boss', 'weapon_effect': 'frost_crown', 'special': '寒霜凝视：受击时10%概率使敌人冻结1 刻（每场最多2次）（触发：受击时）', 'desc': '冰湖女王沉睡时遗落的王冠，冠檐凝着不化的霜花。寒霜凝视：受击时10%概率使敌人冻结1 刻（每场最多2次）（触发：受击时）。'},
    ...
    'eq_lan_dun_zhi_jie': {'name': '兰顿之戒', 'slot': 'ring', 'quality': 'purple', 'lv': 60, 'series': '兰顿', 'req': {'agi': 56}, 'source': '副本Boss', 'weapon_effect': 'randuin_weary', 'special': '兰顿倦意：敌人每次行动后，其速度-6%（最多叠加3层）（触发：敌人行动后）', 'desc': '传奇将军兰顿的戒指，据说戴上它的人，连敌人都变慢了。兰顿倦意：敌人每次行动后，其速度-6%（最多3层）（触发：敌人行动后）。'},
    ...
    'eq_shen_yuan_xiong_jia': {'name': '深渊胸甲', 'slot': 'armor', 'quality': 'purple', 'lv': 85, 'series': '深渊', 'req': {'str': 82}, 'source': '副本Boss', 'weapon_effect': 'abyss_barrier', 'special': '深渊屏障：战斗开始获得深渊屏障，最大生命+8%（持续整场）（触发：战斗开始）', 'desc': '深渊裂隙边缘捞起的胸甲，甲面幽暗得仿佛吞光。深渊屏障：战斗开始获得最大生命+8%（持续整场）（触发：战斗开始）。'},
    ...
    'eq_si_wang_zhi_wu': {'name': '死亡之舞', 'slot': 'necklace', 'quality': 'orange', 'lv': 92, 'series': '死亡之舞', 'req': {'agi': 88}, 'source': '副本Boss', 'legendary': 'death_dance', 'weapon_effect': 'death_dance', 'special': '死亡之舞：受击伤害的35%转为缓伤，每刻开始结算已积累缓伤的10%（上限10 刻），死亡时立即结算（触发：受击时/刻开始）', 'desc': '深渊舞者颈间的项链，坠子是一枚旋转不休的骨轮。死亡之舞：受击伤害35%转为缓伤，刻开始结算10%（上限10 刻），死亡时立即结算（触发：受击时）。'},
    ...
    'eq_sheng_hui_xiong_jia': {'name': '圣辉胸甲', 'slot': 'armor', 'quality': 'purple', 'lv': 90, 'series': '圣辉', 'req': {'int': 86}, 'source': '副本Boss', 'weapon_effect': 'holy_radiance_mail', 'special': '圣辉涌动：治疗时回复量+20%（触发：治疗结算时）', 'desc': '圣辉大教堂唱诗班首席的胸甲，甲面嵌着会发光的圣水晶。圣辉涌动：治疗时回复量+20%（触发：治疗结算时）。'},
    ...
    'eq_bu_mie_yi_zhi': {'name': '不灭意志', 'slot': 'necklace', 'quality': 'orange', 'lv': 90, 'series': '不灭', 'req': {'str': 88}, 'source': '副本Boss', 'legendary': 'undying_will', 'weapon_effect': 'undying_will', 'special': '不灭意志：每场1次，生命低于20%时触发，本刻免疫致死伤害并回复10%生命（触发：生命阈值）', 'desc': '传说某位英雄濒死时紧握的项链，链坠里封着一滴凝固的泪。不灭意志：每场1次，生命低于20%时触发，本刻免疫致死并回复10%生命（触发：生命阈值）。'},
    ...
    'eq_shi_xiang_gui_zhi_xin': {'name': '石像鬼之心', 'slot': 'necklace', 'quality': 'orange', 'lv': 52, 'series': '石像鬼', 'req': {'str': 50}, 'source': '副本Boss', 'legendary': 'gargoyle_heart', 'weapon_effect': 'gargoyle_heart', 'special': '石像鬼之心：每场1次，生命低于30%时获得护盾（吸收25%最大生命的伤害）并回复15%生命（触发：生命阈值）', 'desc': '守护千年古堡的石像鬼胸口的宝石，仍搏动着石之心跳。石像鬼之心：每场1次，生命低于30%时获得25%最大生命护盾并回复15%生命（触发：生命阈值）。'},
...
EQUIP_ROSTER.update({
    ...
    'eq_yao_sai_you_ling_zhi_kui': {'name': '要塞幽灵之盔', 'slot': 'helm', 'quality': 'purple', 'lv': 24, 'series': '迷雾', 'req': {'vit': 22}, 'source': 'boss', 'special': '幽灵低语：受击时 15% 概率使攻击者混乱（1 刻内攻击命中率 -10%）', 'desc': '要塞幽灵盘踞的锈蚀铁盔，盔内隐约传来旧日守军的低语。幽灵低语：受击时 15% 概率使攻击者混乱（1 刻内攻击命中率 -10%）。'},
