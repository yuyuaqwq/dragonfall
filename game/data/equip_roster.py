...
EQUIP_ROSTER.update({
    ...
    'eq_shi_lu_zhan_chui': {'name': '石炉战锤', 'slot': 'weapon', 'weapon_type': 'mace', 'quality': 'purple', 'lv': 84, 'series': '地底', 'req': {'str': 80}, 'weapon_effect': 'gargoyle_heart', 'source': 'boss', 'special': '熔炉余温：攻击 20% 概率使目标灼烧（每回合 3% 生命，2 回合）', 'desc': '灰矮人领主·石炉亲手锻打的战锤，锤头仍残留着地底熔炉的余温。熔炉余温：攻击 20% 概率使目标灼烧（每回合 3% 生命，2 回合）。'},
