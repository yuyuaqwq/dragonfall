...
PET_POOL = [
    ...
    {"key": "pet_panther", "name": "影豹", "icon": "🐆", "quality": "blue", "focus": "敏捷",
     "skill_name": "狩猎之眼", "skill_interval": 3, "skill_type": "crit_up", "skill_value": 0.10,
     "source": "密林精英怪概率掉落影豹蛋",
     "desc": "潜伏在密林阴影中的猎手，每 3 回合为主人加持 10% 暴击(2 回合)",
    ...
    {"key": "pet_armadillo", "name": "岩甲兽", "icon": "🦔", "quality": "purple", "focus": "防守",
     ...
     "desc": "披着岩石甲壳的重装兽，每 4 回合冲撞造成 35% 攻击伤害并破防 35%(2 回合)",
     "lines": ["哼哧哼哧！", "（滚成球冲出去）", "岩石的力量！"]},
    {"key": "pet_thunderbird", "name": "雷羽鸟", "icon": "🦅", "quality": "purple", "focus": "元素",
     "skill_name": "雷鸣鼓舞", "skill_interval": 4, "skill_type": "buff_atk", "skill_value": 0.15,
     "source": "高地 Boss 概率掉落/雷雨天气事件",
     "desc": "羽翼缠绕雷霆的战鸟，每 4 回合为主人加持 15% 攻击(2 回合)",
