...
GATHER_MAP_POOLS = {
    ...
    "mermaid_bay": [("mat_hai_yao_lin", 25), ("mat_jiao_ren_lin", 20), ("mat_hai_yao_zhi_yu", 15), ("mat_zhen_zhu_bei", 20)],
    ...
    "storm_sea": [("mat_feng_bao_zhi_ling_chen", 25), ("mat_feng_bao_bei", 20), ("mat_feng_bao_he_xin", 20), ("mat_lei_man_pi", 15)],
    ...
    "whale_domain": [("mat_long_jing_zhi", 25), ("mat_tao_sheng_jing_jiao", 20), ("mat_hai_ju_ren_lin", 20), ("mat_jing_xu_cao", 20)],
