# -*- coding: utf-8 -*-
"""奥兰迪亚·余烬纪年数据层 - gems.py（v136 幸运宝石系统）
幸运宝石=怪猎护石式随机属性+伊甸属性绑定；10 阶各具名（碎裂→神话），合成3同级→1上级。
纯数据零逻辑（掉落概率等由 core 层消费）。
"""
# 阶 → 名称/数值/合成关系（v136 定稿；10 阶独立命名，避免与符文『碎裂/普通』命名撞车）
GEM_TIERS = {
    1: {"name": "碎裂", "mult": 0.01},    # 碎裂的幸运宝石
    2: {"name": "黯淡", "mult": 0.015},   # 黯淡的幸运宝石
    3: {"name": "普通", "mult": 0.02},    # 普通的幸运宝石
    4: {"name": "明亮", "mult": 0.025},   # 明亮的幸运宝石
    5: {"name": "无瑕", "mult": 0.03},    # 无瑕的幸运宝石
    6: {"name": "闪耀", "mult": 0.035},   # 闪耀的幸运宝石
    7: {"name": "完美", "mult": 0.04},    # 完美的幸运宝石
    8: {"name": "璀璨", "mult": 0.045},   # 璀璨的幸运宝石
    9: {"name": "传说", "mult": 0.05},    # 传说的幸运宝石
    10: {"name": "神话", "mult": 0.06},   # 神话的幸运宝石
}
GEM_TIER_NAMES = {1: "碎裂的幸运宝石", 2: "黯淡的幸运宝石", 3: "普通的幸运宝石", 4: "明亮的幸运宝石", 5: "无瑕的幸运宝石", 6: "闪耀的幸运宝石", 7: "完美的幸运宝石", 8: "璀璨的幸运宝石", 9: "传说的幸运宝石", 10: "神话的幸运宝石"}
GEM_BASE_NAME = "幸运宝石"
GEM_ITEM_TYPE = "幸运宝石"
