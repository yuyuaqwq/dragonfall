...
WEAPON_EFFECT_DATA = {
    "starlight_bulwark": {"family": "proc_shield", "shield_hp_pct": 0.10, "refresh_turns": 5, "shield_key": "we_starlight", "log": "✨ 星辉壁垒：战斗开始获得 10% 最大生命护盾！"},
    ...
    "eclipse_crown": {"family": "proc_shield", "shield_hp_pct": 0.15, "spd_pct": 0.10, "next_atk_pct": 0.15, "shield_key": "we_eclipse", "log": "🌒 蚀月之蚀：获得 15% 最大生命护盾！"},
    ...
    "hunter_open": {"family": "proc_extra_dmg", "count": 3, "atk_pct": 0.12, "stack_key": "hunter_cnt"},
    ...
    "frost_ring": {"family": "proc_control", "chance": 0.25, "slow_turns": 2, "slow_pct": 0.40, "freeze_turns": 1, "boss_slow": 2},
    ...
    "wind_split": {"family": "proc_extra_dmg", "chance": 0.25, "atk_pct": 0.50},
    "holy_judgment_field": {"family": "proc_control", "chance": 0.30, "slow_turns": 2, "slow_pct": 0.30, "heal_down": 2, "log": "⚖️ 圣裁领域：目标受治疗 -30%（2 刻）！"},
    ...
    "phantom_barrage": {"family": "proc_extra_dmg", "chance": 0.20, "atk_pct": 0.30, "pene_pct": 0.50, "guarantee": 5, "stack_key": "phantom_cnt", "log": "🌪️ 幻影连射！无视 50% 防御造成 {dmg} 点伤害！"},
    "siren_fang": {"family": "proc_extra_dmg", "count": 3, "atk_pct": 0.40, "stack_key": "siren_cnt"},
    "soul_eater": {"family": "proc_extra_dmg", "cur_hp_pct": 0.02, "log": "💜 破败之吻：额外 {bonus} 点伤害，回复 {healed} 点生命！"},
    "star_pierce": {"family": "proc_extra_dmg", "count": 4, "atk_pct": 0.20, "lost_hp_pct": 0.03, "cap_pct": 0.05, "stack_key": "star_cnt"},
    "combo_end": {"family": "proc_passive_mult", "event": ["hit", "passive"], "combo_need": 3, "crit_dmg": 0.40, "mark_key": "we_combo_end"},
    "novice_lifesteal": {"family": "proc_extra_dmg", "heal_pct": 0.05},
    ...
    "afterglow_splash": {"family": "proc_extra_dmg", "chance": 0.30, "atk_pct": 0.15},
    "spellblade_echo": {"family": "proc_extra_dmg", "atk_pct": 0.25},
    "annihilation_echo": {"family": "proc_extra_dmg", "chance": 0.35, "atk_pct": 0.30},
    "ember_burn": {"family": "proc_dot", "chance": 0.30, "dot_pct": 0.015, "dot_pct_boss": 0.01, "turns": 3, "dot_key": "ember"},
    "everfrost_domain": {"family": "proc_control", "chance": 0.30, "freeze_turns": 1, "boss_slow": 2, "cd": 3, "cd_key": "we_everfrost_cd"},
    "everfrost_scepter": {"family": "proc_control", "chance": 0.20, "freeze_turns": 1, "boss_slow": 2},
    ...
    "endless_blade": {"family": "proc_extra_dmg", "atk_pct": 0.20, "used_key": "we_blade_used"},
    ...
    "frost_crown": {"family": "proc_control", "chance": 0.10, "max_per_battle": 2, "freeze_turns": 1, "boss_slow": 2, "used_key": "we_frost_crown_cnt"},
    ...
    "deeprock_aegis": {"family": "proc_shield", "chance": 0.10, "shield_pct": 0.08, "cd": 2, "shield_key": "we_deeprock", "cd_key": "we_deeprock_cd", "log": "🪨 深岩壁垒：获得护盾！（吸收 8% 最大生命）"},
    ...
    "echo_bless": {"family": "proc_shield", "overflow_pct": 0.30, "cap_hp_pct": 0.10, "shield_key": "we_echo_bless", "log": "🌿 回响祝福：治疗溢出转化为 {shield} 点护盾！"},
    "atonement_shield": {"family": "proc_shield", "cap_hp_pct": 0.15, "shield_key": "we_atonement", "active_key": "we_atonement_active", "log": "⚖️ 赎罪之盾：治疗溢出转化为 {shield} 点护盾！"},
    "holy_word_bind": {"family": "proc_control", "chance": 0.20, "freeze_turns": 1, "boss_slow": 2},
    ...
    "randuin_weary": {"family": "proc_control", "max_stack": 3, "spd_down_pct": 0.06, "log": "🛡️ 兰顿倦意：敌人速度 -{int(_sp * 100 * n)}%（{n}/{_ms} 层）！"},
    "ice_vein": {"family": "proc_control", "max_stack": 3, "spd_down_pct": 0.08, "log": "❄️ 冰脉寒流：敌人速度 -{int(_sp * 100 * n)}%（{n}/{_ms} 层）！"},
    "time_freeze": {"family": "proc_control", "threshold": 0.30, "per_battle": 1, "used_key": "we_time_freeze_used", "log": "⏳ 时光凝滞！敌人被定身，跳过一次行动！"},
