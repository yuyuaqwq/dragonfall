...
EQUIP_ADD = {
    ...
    # 碎岳拳：冰霜王座 Boss 图纸（特效参考 破甲 词条，25%/15%/2 刻）
    "eq_sui_yue_quan": {
        "name": "碎岳拳",
        "slot": "weapon",
        "weapon_type": "fist",
        ...
        "req": {"str": 68},
        "source": "图纸",
        "special": "碎岳之势：攻击时 25% 概率破甲，降低目标防御 15%（2 刻）",
        "desc": "传说能一拳碎开山岳的拳套，冰霜王座之下仍有地脉余温。碎岳之势：攻击时 25% 概率破甲，降低目标防御 15%（2 刻）。",
    },
    ...
    "eq_shuang_yu_chang_gong": {
        ...
        "req": {"agi": 58},
        "source": "图纸",
        "special": "霜羽之矢：攻击附加 5% 冰属性伤害 + 减速（敌速 -10%，持续 2 刻）",
        "desc": "弓臂缀满霜羽的长弓，弦声响起时飘落细雪。霜羽之矢：攻击附加 5% 冰属性伤害 + 减速（敌速 -10%，持续 2 刻）。",
    },
