...
挂载方式（游戏启动时）：
    ...
    config.load_game_rules(game.data.battle_rules)
"""
...
EFFECT_RULES: dict = {
    ...
    #   ⚠️ 推条值 −30% 无消费端：推条注入（battle_bar_procs bar_gain）直读技能
...
# ============================================================
# 挂敌身条注入声明表 BAR_INJECT_FIELDS（v181 破绽接线）
# ============================================================
...
PASSIVE_PROC: dict = {
    ...
    # 推条/衰减/触发 = services/battle_bar_procs（BAR_INJECT_FIELDS 命中注入 +
