...
KEYS = {
    ...
    "inst_deer_fort": ("i_key_deer_fort", "鹿角军旗", "鹿角要塞地图探索掉落"),
    ...
    "inst_sunken_ship": ("i_key_sunken", "沉船湾船票", "铁港码头精英·海盗精锐掉落"),
    "inst_siren_nest": ("i_key_siren", "海妖鳞片信物", "海妖湾精英·海妖守卫掉落"),
    "inst_sea_god_temple": ("i_key_sea_god", "海神殿祷文", "无名港灯塔任务奖励"),
    "inst_deep_dragon_palace": ("i_key_dragon_palace", "龙宫宝珠", "龙鲸海域精英·龙鲸掉落"),
