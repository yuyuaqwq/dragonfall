...
MECH_RULES = [
    ...
    (r'召唤藤蔓守卫（见 §8）', {"summon": "藤蔓守卫"}, None),
    (r'召唤古树守卫（见 §8）', {"summon": "古树守卫"}, None),
    (r'召唤 1 只骷髅（挡刀，上限 3）', {"summon": "骷髅", "count": 1}, None),
    ...
    (r'顶点：信念满 (\d+) 时 ×([\d.]+)，召唤亡魂大军', {"cond": {"type": "faith_full", "stacks": None, "mult": None}, "summon": "骷髅", "count": 3}, None),
    # ---- 刺客 ----
