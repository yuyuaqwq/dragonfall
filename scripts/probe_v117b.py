...
unused = ["古王剑碎片", "马尔库斯的法冠残片", "圣光圣徽", "魔像核心", "克罗的罗盘碎片", "灰矮人徽记",
          "石炉之锤", "地底龙鳞", "深渊珍珠", "赫尔加的祭器碎片", "烬核", "要塞残片", "奥拉圣印碎片",
          "蓝歌之冠残片", "澜歌之泪残片", "潮汐之泪", "试炼徽记", "幽灵船票", "月辉碎片", "永冻之核",
          "古王碎片", "黎明之光碎片", "龙语传承", "龙魂碎片", "黑渊之眼残片", "云怒之核碎片", "风暴之核", "龙宫珠"]
