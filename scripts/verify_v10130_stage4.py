...
from game.data import (MATERIALS, ITEMS, COOKING_RECIPES, ALCHEMY_RECIPES,
...
src = open(r'C:\Users\yuyu\qqbot\data\plugins\dragonfall\game\battle.py', encoding='utf-8').read()
src2 = open(r'C:\Users\yuyu\qqbot\data\plugins\dragonfall\game\core\item_templates.py', encoding='utf-8').read()
...
for r in COOKING_RECIPES.values():
    consumed.update(m for m in r["cost"] if m.startswith("mat_"))
for rk, r in __import__('game.data', fromlist=['CRAFT_RECIPES']).CRAFT_RECIPES.items():
