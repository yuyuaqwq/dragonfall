...
def test_wind_mark_stack():
    ...
    b = new_battle(p, m)
    from battle2.actors import ActCtx as _Ctx
...
def test_reflect_ext_action():
    ...
    from battle2.landing import heal_actor as _ha
    m2["hp"] = 100
    _ha(b2, m2, 100, [])
...
def test_next_atk_and_retort_marks():
    ...
    # 技能命中 → 挂下次强化 buff
    from battle2 import actions as AC
...
def test_trinity_thunder():
    ...
    EP.apply_to_actor(p2)
    b2 = new_battle(p2, m2)
    from battle2 import actions as AC2
