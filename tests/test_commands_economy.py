...
async def main():
    ...
    check("橡木镇可买老马", "买了老马" in out or "买了一匹老马" in out, out[:150])
    ...
    # = 4.636 ≥ 3.0 → _hostile_phase 推进时 3 刻 buff 已到期清除（与战吼同款绝对时刻语义）。
    ...
    logs, _ended = b.actor_turn("use_item", "buff:atk_up", pl)
