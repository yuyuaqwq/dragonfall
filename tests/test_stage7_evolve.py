...
def test_data():
    ...
    # v139：职业融合新增 28 个分支技能（破势斩/狂暴精通/顿足盾击/元素聚焦/深度冥想/破晓长歌/
    #   圣辉涤净/链舞/蚀骨/碎颅势/守御姿态/磐岩释能/磐核爆发/龙威咆哮/龙焰初击/内燃/时间凝滞/
    #   时之守护/时间共鸣/时间过载/星轨锁定/星光庇护/骨噬/灵魂标记/噬影/暗影分身/绞杀·缚影步）→ 210
    check("分支总技能 210（v139）", total == 210, str(total))
