...
def main():
    ...
    # ===== 10. 隐藏装备/套装 =====
    print("  · 隐藏装备")
    check("EQUIP_ROSTER 682 件（v136 Phase6 +180；v140 +243；v141.3 +龙鳞庇护之坠；v168 +8 新手本 Boss 主题装；v169 +12 断档补装；v171 +6 新手流派白装；v172 路B +24 重锻专属）", len(C.EQUIP_ROSTER) == 682, str(len(C.EQUIP_ROSTER)))
