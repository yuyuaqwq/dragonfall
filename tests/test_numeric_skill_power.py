...
LOCK = {
    "cls_zhan_shi":     (("挥砍", 1, 1.0, 3, 12), ("旋风斩", 14, 1.1, 10, 12)),
    "cls_fa_shi":       (("火球术", 1, 1.0, 10, 12), ("雷击", 14, 1.2, 20, 12)),
    ...
    "cls_shadow_blade": (("暗影之舞", 40, 0.0, 0, 0), ("暗影之舞", 40, 0.0, 0, 0)),
    "cls_wu_sheng":     (("气力调和", 40, 0.0, 0, 0), ("气力调和", 40, 0.0, 0, 0)),
}
