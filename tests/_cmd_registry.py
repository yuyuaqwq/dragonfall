...
#   → 包内真源 `framework/games/orlandia/content`（实现/登记目录）+
#     `content/data/commands.json`（声明真源，195 条）。删壳后此处仍有落点。
...
SPEC_LABEL = "framework/games/orlandia/content/data/commands.json"
